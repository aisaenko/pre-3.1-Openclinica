...
public class Page {
    ...
    public final static Page MANAGE_PRIVILEGES = new Page(path + "managestudy/managePrivileges.jsp", "Manage Study Servlet");
    public final static Page UPDATE_PRIVILEGES = new Page(path + "managestudy/updatePrivileges.jsp", "Update Study Servlet");
    ...
    public final static Page CONFIRM_UNLOCKING_CRF_VERSION = new Page("/WEB-INF/jsp/managestudy/confirmUnlockingCRFVersion.jsp", "confirm unlocking crf version");
    /**
