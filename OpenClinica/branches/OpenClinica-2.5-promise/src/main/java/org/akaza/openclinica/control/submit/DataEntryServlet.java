...
public abstract class DataEntryServlet extends SecureController {
                ...
                if (diwb.isInGroup()) {
                    ...
                    for (int j = 0; j < dgbs.size(); j++) {
                        ...
                        for (DisplayItemBean displayItem : items) {
                            ...
                            if (responseTypeId == 8 || responseTypeId == 9) {
								...
								String inputName = "";
								// note that we have to use getFormInputOrdinal() here, tbh 06/2009
		                        ...
		                        if (robBean.getValue().startsWith("func: getexternalvalue") || robBean.getValue().startsWith("func: getExternalValue")) {
								    ...
								    logger.info("*** just set " + fp.getString(inputName) + 
										" for line 815 " + displayItem.getItem().getName() + 
										" with input name " + inputName);
									// System.out.println("found in fp line 816: " + fp.getString(displayItem.getItem().getName()));
									// System.out.println("scoreitemdata LINE 817: " + scoreItemdata.toString());
								} else {
                    ...
                    if (responseTypeId == 8 || responseTypeId == 9) {
                        ...
                        if (robBean.getValue().startsWith("func: getexternalvalue") || robBean.getValue().startsWith("func: getExternalValue")) {
                            ...
                            // System.out.println("scoreitemdata: " + scoreItemdata.toString());
                        } else {
    ...
    protected List<DisplayItemGroupBean> loadFormValueForItemGroup(DisplayItemGroupBean digb, List<DisplayItemGroupBean> dbGroups,
        ...
        for (int i = 0; i < repeatMax; i++) {
            ...
            if (!StringUtil.isBlank(fp.getString(igb.getOid() + "_" + i + ".newRow"))) {
                // the ordinal is the number got from [ ] and submitted by
                // repetition javascript
                if (i == 0) {
