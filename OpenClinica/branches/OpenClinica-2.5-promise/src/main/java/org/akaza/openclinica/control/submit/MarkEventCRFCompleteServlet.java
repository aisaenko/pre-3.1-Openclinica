...
public class MarkEventCRFCompleteServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        // (FormDiscrepancyNotes)session.getAttribute(AddNewSubjectServlet.FORM_DISCREPANCY_NOTES_NAME);
        getEventCRFBean();
         ...
         * null) ||
         * discNotes.getNotes(TableOfContentsServlet.INPUT_INTERVIEWER).isEmpty()){
         * throw new InconsistentStateException(errorPage, "You may not mark
         * this Event CRF complete, because interviewer name is blank."); } }
         *
         * if (ecb.getDateInterviewed() == null) { if ((discNotes == null) ||
         * (discNotes.getNotes(TableOfContentsServlet.INPUT_INTERVIEW_DATE).isEmpty()) ) {
         * throw new InconsistentStateException(errorPage, "You may not mark
