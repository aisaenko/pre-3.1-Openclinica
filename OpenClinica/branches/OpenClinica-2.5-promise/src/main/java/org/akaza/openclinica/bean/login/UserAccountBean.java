...
public class UserAccountBean extends AuditableEntityBean {
    ...
    /*
     * since we extend entity bean, we already have the following: user_id,
     * user_name, owner_id, date_created, date_updated, update_id
     */
    ...
    public void addUserType(UserType u) {
        ...
        /*
         * currently set tech admin superior to sys admin, i.e anything a
         * sysadmin can do, a tech admin can do too.
         */
