            ...
            for (StudyEventDataBean studyEventDataBean : studyEventDataBeans) {
               ...
               // ArrayList<StudyEventBean> studyEventBeans = studyEventDAO.findAllByDefinitionAndSubject(studyEventDefinitionBean, studySubjectBean);
                ...
                for (FormDataBean formDataBean : formDataBeans) {
                    ...
                    //StudyEventBean studyEventBean = (StudyEventBean) studyEventDAO.findByStudySubjectIdAndDefinitionIdAndOrdinal(studyEventDefinitionBean.getId(), studySubjectBean.getId(),Integer.parseInt(sampleOrdinal));
                ...
                for (FormDataBean formDataBean : formDataBeans) {
                    ...
                    if (permittedEventCRFIds.contains(new Integer(eventCRFBean.getId()))) {
                        ...
                        for (ImportItemGroupDataBean itemGroupDataBean : itemGroupDataBeans) {
                            ...
                            //JN: this max Ordinal can cause problems as it assumes the latest values, and when there is an entry with nongroup towards the end. Refer: MANTIS 6113
                    ...
                    //JN: Commenting out the following code, since we shouldn't re-initialize at this point, as validationErrors would get overwritten and the older errors will be overriden. Moving it after the form.
