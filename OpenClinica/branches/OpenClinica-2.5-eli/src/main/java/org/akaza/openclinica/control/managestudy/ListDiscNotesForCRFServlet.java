...
public class ListDiscNotesForCRFServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
       ...
       /* List<DiscrepancyNoteBean> allDiscNotes = discNoteUtil.getThreadedDNotesForStudy(sbean,
        ...
        List<DiscrepancyNoteThread> allThreadedDiscNotes = discNoteUtil.getDNotesForStudyAsThreads(sbean,
        ...
        if(! (allThreadedDiscNotes == null || allThreadedDiscNotes.isEmpty())) {
            for (int i = 0; i < subjects.size(); i++) {
                ...
                discNoteUtil.injectDiscNotesIntoDisplayStudyEvents(displayEvents,
                  resolutionStatusIds,sm.getDataSource(), discNoteType, allThreadedDiscNotes);
