...
public class RuleSetServiceStub implements RuleSetServiceInterface {
	 ...
	 protected final Logger logger = LoggerFactory.getLogger(getClass().getName());
	    ...
	    public RuleSetServiceStub(DataSource dataSource) {
	    ...
	    public HashMap<String, ArrayList<String>> runRulesInDataEntry(List<RuleSetBean> ruleSets, Boolean dryRun, StudyBean currentStudy, UserAccountBean ub,
	            HashMap<String, String> variableAndValue,EventCRFBean ecb) {
