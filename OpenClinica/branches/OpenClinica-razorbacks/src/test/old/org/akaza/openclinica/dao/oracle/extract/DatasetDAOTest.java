...
public class DatasetDAOTest extends DAOTestBase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        digester.setInputStream(new FileInputStream(SQL_DIR + "oracle_dataset_dao.xml"));
        try {
            digester.run();
    ...
    public void testCreate() throws Exception {
        ...
        db.setStudyId(1);
        db.setSQLStatement("select * from test_view_three" + " where " + "item_id = 6");
        db.setNumRuns(0);
        // db.setRunTime(0);
        db.setOwnerId(1);
    ...
    // DatasetBean ecb2 = (DatasetBean)dsdao.update(ecb);
    ...
    public void testExtract() throws Exception {
        ...
        DatasetBean ecb = (DatasetBean) dsdao.findByPK(pkey);
        // String exb = dsdao.generateDataset(ecb,1, new StudyBean(), new
        // StudyBean());
