...
<h1><fmt:message key="reset_password" bundle="${resword}"/></h1>
...
<table border="0" cellpadding="0">
 ...
 <td><input type="button" name="exit" value="<fmt:message key="exit" bundle="${resword}"/>" class="button_medium" onclick="javascript:window.location.href='Logout'"></td>
 </tr> 
 </table>
</form>
