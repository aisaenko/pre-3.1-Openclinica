...
<div style="width:90%;float:left;"><fmt:message key="click_the_up_down_arrow_icons" bundle="${restext}"/></div>
...
<br>
<input type="button" onclick="confirmExit('ListEventDefinition');"  name="exit" value="<fmt:message key="exit" bundle="${resword}"/>   " class="button_medium"/>
<br>
