...
CREATE TABLE extract_data_table (
    ...
    date_start date,
    date_end date,
    secondary_label character varying(255)
);
...
--
-- Name: study_subject_insert_update; Type: TRIGGER; Schema: public; Owner: clinica
--
...
--
-- Name: study_event_insert_update; Type: TRIGGER; Schema: public; Owner: clinica
--
