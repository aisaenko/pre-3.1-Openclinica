 ...
 function myCancel() {
    ...
    if ( cancelButton != null) {
      if(confirm('<fmt:message key="sure_to_cancel" bundle="${resword}"/>')) {
        window.location.href="ListStudySubject";
       return true;
      } else {
        return false;
       }
...
<br/>
<fmt:message key="date_time" bundle="${resword}"/>: <fmt:formatDate value="${date}" type="both" dateStyle="short" timeStyle="long"/>
<br/>
<fmt:message key="sure_to_sign_subject2" bundle="${resword}"/>
<br/>
<fmt:message key="role" bundle="${resword}"/>: <c:out value="${userRole.name}"/></b>
<br><br>
   ...
   <div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr><td>
                        <div class="formfieldM_BG"><input type="text" name="j_user" class="formfieldM"></div>
                    </td><td>&nbsp;</td>
                </tr>
            </table>
        </td></tr>
        ...
        <td>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr><td>
                        <div class="formfieldM_BG"><input type="password" name="j_pass"  class="formfieldM"></div>
                    </td><td>&nbsp;</td>
                </tr>
            </table>
        </td></tr>
		...
		<!-- end Table Actions row (pagination, search, tools) -->
			...
			<!-- Table Contents -->
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="table_header_column"><fmt:message key="secondary_identifier" bundle="${resword}"/></td>
						...
						<tr>
							...
							<td class="table_cell_top"><fmt:formatDate value="${subject.dateOfBirth}" dateStyle="short"/></td>
						</tr>
						</c:when>
						...
						<tr>
					     ...
					     <td class="table_cell_top"><fmt:formatDate value="${studySub.enrollmentDate}" dateStyle="short"/>&nbsp;</td>
				        </tr>
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="330">
               ...
               <tr>
				...
				<tr>
					...
					<td class="table_cell_top"><fmt:formatDate value="${studySub.createdDate}" dateStyle="short"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="table_cell"><fmt:formatDate value="${studySub.updatedDate}" dateStyle="short"/>&nbsp;</td>
				</tr>
				<tr>
		...
		<!-- end Table Actions row (pagination, search, tools) -->
			...
			<!-- Table Contents -->
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td class="table_header_column_top"><fmt:message key="date_record_created" bundle="${resword}"/></td>
							<td class="table_cell_top"><fmt:formatDate value="${subject.createdDate}" dateStyle="short"/></td>
						</tr>
						<tr>
							<td class="table_header_column"><fmt:message key="created_by" bundle="${resword}"/></td>
						...
						<tr>
							<td class="table_header_column"><fmt:message key="date_record_last_updated" bundle="${resword}"/></td>
							<td class="table_cell"><fmt:formatDate value="${subject.updatedDate}" dateStyle="short"/>&nbsp;</td>
						</tr>
						<tr>
							<td class="table_header_column"><fmt:message key="updated_by" bundle="${resword}"/></td>
