			...
			<!-- Table Contents -->
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td class="table_cell"><fmt:formatDate value="${studyEvent.dateStarted}" dateStyle="short"/> &nbsp;</td>
						</tr>
						<tr>
							<td class="table_header_column"><fmt:message key="end_date_time" bundle="${resword}"/></td>
							<td class="table_cell"><fmt:formatDate value="${studyEvent.dateEnded}" dateStyle="short"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="table_cell"><c:out value="${studyEvent.updater.name}"/> (<fmt:formatDate value="${studyEvent.updatedDate}" dateStyle="short"/>)</td>
						</tr>
