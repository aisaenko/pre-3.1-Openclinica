...
<input type="hidden" name="enterData" value="<c:out value="${enterData}" />">
   ...
   <c:if test="${discrepancyNote.crfName !=''}">
    ...
    <td><c:out value="${discrepancyNote.crfName}"/>&nbsp;</td>
       ...
       <tr valign="top">
            <td><fmt:message key="discrepancy_note_id" bundle="${resword}"/></td>
            <td>
        ...
        <tr valign="top">
            <td colspan="2"><a href="ViewDiscrepancyNote?id=<c:out value="${discrepancyNote.entityId}"/>&name=<c:out value="${discrepancyNote.entityType}"/>&field=<c:out value="${discrepancyNote.field}"/>&column=<c:out value="${discrepancyNote.column}"/>&enterData=<c:out value="${enterData}"/>&monitor=<c:out value="${monitor}"/>&blank=<c:out value="${blank}"/>">
