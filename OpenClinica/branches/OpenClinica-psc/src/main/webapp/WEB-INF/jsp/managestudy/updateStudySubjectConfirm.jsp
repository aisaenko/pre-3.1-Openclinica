...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr valign="bottom"><td class="table_header_column"><fmt:message key="secondary_label" bundle="${resword}"/>:</td><td class="table_cell"><c:out value="${studySub.secondaryLabel}"/>&nbsp;
  </td></tr>
