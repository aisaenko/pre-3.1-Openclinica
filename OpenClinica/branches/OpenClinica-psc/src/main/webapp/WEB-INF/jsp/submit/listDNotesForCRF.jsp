...
<c:choose>
   <c:when test="${userRole.manageStudy}">
    <a class="tabtext" href="ListDiscNotesSubjectServlet?module=manage" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
   </c:when>
   <c:otherwise>
    <a class="tabtext" href="ListDiscNotesSubjectServlet?module=submit" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
   </c:otherwise>
  </c:choose>
