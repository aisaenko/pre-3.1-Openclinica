...
<jsp:useBean scope="request" id="currRow" class="org.akaza.openclinica.bean.admin.ListCRFRow" />
...
<tr valign="top" bgcolor="#F5F5F5">
  ...
  <td rowspan="<c:out value="${count}"/>" class="table_cell"><fmt:formatDate value="${currRow.bean.updatedDate}" dateStyle="short"/>&nbsp;</td>
...
<c:forEach var ="version" items="${currRow.bean.versions}">
  ...
  <tr valign="top">
    ...
    <td class="table_cell"><fmt:formatDate value="${version.createdDate}" dateStyle="short"/></td>
    ...
    <td class="table_cell">
      <table border="0" cellpadding="0" cellspacing="0">
        ...
        <a href="ViewTableOfContent?crfVersionId=<c:out value="${version.id}"/>"
			...
			name="bt_View1" src="images/bt_View.gif" border="0" alt="<fmt:message key="view" bundle="${resword}"/>" title="<fmt:message key="view" bundle="${resword}"/>" align="left" hspace="6"></a>
		-->
            <a href="ViewSectionDataEntry?module=<c:out value="${module}"/>&crfId=<c:out value="${currRow.bean.id}"/>&crfVersionId=<c:out value="${version.id}"/>&tabId=1"
               onMouseDown="javascript:setImage('bt_View1','images/bt_View_d.gif');"
               onMouseUp="javascript:setImage('bt_View1','images/bt_View.gif');"><img
              name="bt_View1" src="images/bt_View.gif" border="0" alt="<fmt:message key="view" bundle="${resword}"/>" title="<fmt:message key="view" bundle="${resword}"/>" align="left" hspace="6"></a>
