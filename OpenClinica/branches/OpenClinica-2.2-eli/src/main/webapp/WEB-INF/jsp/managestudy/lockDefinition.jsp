...
<tr id="sidebar_Instructions_open" style="display: all">
        ...
        <fmt:message key="all_subject_event_data_associated_with_this_SED"  bundle="${resword}"/> <fmt:message key="no_new_data_will_be_entered_for this_SED"  bundle="${resword}"/>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"> 
  ...
  <tr valign="top">
   ...
   <td class="table_cell">
    <fmt:formatDate value="${event.dateEnded}" dateStyle="short"/>&nbsp;
   </td>
   <td class="table_cell">
