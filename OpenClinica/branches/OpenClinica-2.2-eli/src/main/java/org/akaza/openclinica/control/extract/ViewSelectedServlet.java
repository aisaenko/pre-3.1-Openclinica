...
public class ViewSelectedServlet extends SecureController {
  ...
  /*
   * setup study groups, tbh, added july 2007
   * FIXME in general a repeated set of code -- need to create a superclass
  ...
  public void processRequest() throws Exception {
    ...
    if (db == null || db.getItemIds().size() == 0) {
      ...
      setUpStudyGroups();//FIXME can it be that we have no selected items and 
