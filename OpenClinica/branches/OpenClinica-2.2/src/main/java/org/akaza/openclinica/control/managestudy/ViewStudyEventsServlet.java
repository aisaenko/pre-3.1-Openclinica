...
public class ViewStudyEventsServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    try {
      defaultStartDate = local_df.parse(defaultStartDateString);
    ...
    //for print version
    String queryUrl = INPUT_STARTDATE + "=" + local_df.format(startDate) + "&"+
                       INPUT_ENDDATE + "=" + local_df.format(endDate) + "&"+
  ...
  private ArrayList genTables(FormProcessor fp, ArrayList definitions, 
    ...
    for (int i = 0; i < definitions.size(); i++) {
      ...
      String[] columns = { resword.getString("study_subject_ID"), resword.getString("event_date_started"),
    		  resword.getString("subject_event_status"), resword.getString("actions") };
