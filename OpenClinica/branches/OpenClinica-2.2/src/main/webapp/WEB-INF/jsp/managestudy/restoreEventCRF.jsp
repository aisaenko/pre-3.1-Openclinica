...
<tr id="sidebar_Instructions_open" style="display: all">
		...
		<div class="sidebar_tab_content">		
         ...
         <fmt:message key="confirm_restore_of_this_CRF_to_event"  bundle="${resword}"/> <c:out value="${event.studyEventDefinition.name}"/> (<fmt:message key="date_started" bundle="${resword}"/>:<fmt:formatDate value="${event.dateStarted}" dateStyle="short"/>). <fmt:message key="all_data_associated_with_the_CRF_in_this_event"  bundle="${resword}"/>
...
<p><fmt:message key="confirm_restore_of_this_CRF_to_event"  bundle="${resword}"/> <c:out value="${event.studyEventDefinition.name}"/> (<fmt:message key="date_started" bundle="${resword}"/>:<fmt:formatDate value="${event.dateStarted}" dateStyle="short"/>). <fmt:message key="all_data_associated_with_the_CRF_in_this_event"  bundle="${resword}"/></p>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"> 
  ...
  <tr valign="top"><td class="table_header_column_top"><fmt:message key="date_started" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${event.dateStarted}" dateStyle="short"/></td></tr>
  <tr valign="top"><td class="table_header_column_top"><fmt:message key="date_ended" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${event.dateEnded}" dateStyle="short"/></td></tr>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"> 
	...
	<tr>
		...
		<td class="table_cell"><fmt:formatDate value="${displayEventCRF.eventCRF.dateInterviewed}" dateStyle="short"/>&nbsp;</td>
