...
<h1><span class="title_extract"><c:out value="${study.name}" />: <fmt:message key="extract_datasets" bundle="${resworkflow}"/> <a href="javascript:openDocWindow('help/3_0_extractData_Help.html')"><img src="images/bt_Help_Extract.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></h1>
