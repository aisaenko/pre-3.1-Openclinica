    ...
    */
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            //Internationalized Role descriptions are taken from terms.properties now. (package org.akaza.openclinica.i18n)
            //If you change descriptions in facilityinfo.properties, be sure to include the appropiate
    ...
    public static String getSupportURL() {
        String name = params.getProperty("supportURL").trim();
        return (name == null ? "" : name);
    }
...
/* This Method has been newly inserted (09/01/2008)
 */
