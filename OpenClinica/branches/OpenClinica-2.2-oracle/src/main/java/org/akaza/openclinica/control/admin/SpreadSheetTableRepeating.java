 ...
 *         modified by jxu
 * @version CVS: $Id: SpreadSheetTableRepeating.java 10619 2008-01-22 09:46:31Z ahamid $
 */
                            ...
                            try {
                                ...
                                if (dbName.equals("oracle")) {
                                    sqlGroupLabel = "INSERT INTO ITEM_GROUP_METADATA (" +
                                            ...
                                            "(SELECT MAX(ITEM_GROUP_ID) FROM ITEM_GROUP WHERE NAME='" + itemGroup.getName()
                                            + "' AND crf_id = " + crfId + " ),'" +
                                            igMeta.getHeader() + "', '" +
                                            igMeta.getSubheader() + "', '" +
                                            //above removed?
...
//                  String groupSubheader = getValue(cell);
                        ...
                        if (dbName.equals("oracle")) {
                            gsql = "INSERT INTO ITEM_GROUP ( " +
                                    ...
                                    + fgb.getStatus().getId() + "," + "sysdate," + ub.getId() + ")";
                        } else {
                            gsql = "INSERT INTO ITEM_GROUP ( " +
                                    "name, crf_id, status_id, date_created ,owner_id)" +
                                    "VALUES ('" + fgb.getName() + "', " + fgb.getCrfId() + ","
                    ...
                    if (dbName.equals("oracle")) {
                        if (crfId == 0) {
                            sql = "INSERT INTO CRF_VERSION (NAME, DESCRIPTION, CRF_ID, STATUS_ID,DATE_CREATED,"
                                    ...
                                    + stripQuotes(versionDesc) + "'," + "(SELECT CRF_ID FROM CRF C WHERE C.NAME='"
