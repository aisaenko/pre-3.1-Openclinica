...
public class SQLFactory {
    ...
    public static String JUNIT_XML_DIR = "D:\\OpenClinica-2.2\\src\\main\\" + File.separator
        ...
        while (DAONamesIt.hasNext()) {
            ...
            try {
                ...
                try {
                    ...
                    //logger.warning("DAO NAME:"+DAOName);
