...
public class RemoveStudySubjectServlet extends SecureController {
  ...
  public void mayProceed() throws InsufficientPermissionException {
    ...
    throw new InsufficientPermissionException(Page.LIST_DEFINITION_SERVLET, resexception.getString("not_study_director"),
        "1");
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), respage.getString("remove_subject_from_study"),
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
    		 respage.getString("remove_subject_from_study"), emailBody);
