...
public class EventDefinitionCRFBean extends AuditableEntityBean implements Comparable {
    ...
    private String crfSectionMessage;
    ...
    public String getCrfSectionMessage() {
        return crfSectionMessage;
    }

    public void setCrfSectionMessage(String crfSectionMessage) {
        this.crfSectionMessage = crfSectionMessage;
    }
}