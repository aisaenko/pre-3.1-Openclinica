        ...
        if (!errors.isEmpty()) {
            ...
            for (int i = 0; i < edcs.size(); i++) {
                ...
                if (!edcBean.getStatus().equals(Status.DELETED) && !edcBean.getStatus().equals(Status.AUTO_DELETED)) {
                    ...
                    String crfSectionMessage = fp.getString("crfSectionMessage" + i);
                    String msgWithUrl = org.akaza.openclinica.bean.core.Utils.enableUrlInText(crfSectionMessage);
                    edcBean.setCrfSectionMessage(msgWithUrl);
