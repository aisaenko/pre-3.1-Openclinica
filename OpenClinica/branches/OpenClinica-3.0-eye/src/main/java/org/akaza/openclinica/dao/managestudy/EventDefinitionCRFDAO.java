...
public class EventDefinitionCRFDAO extends AuditableEntityDAO {
    ...
    public void setTypesExpected() {
        ...
        this.setTypeExpected(22, TypeNames.STRING);//crf_section_message
    }
    ...
    public Object getEntityFromHashMap(HashMap hm) {
        ...
        eb.setCrfSectionMessage((String)hm.get("crf_section_message"));
        return eb;
    }
    ...
    public EntityBean create(EntityBean eb) {
        ...
        if (sb.getCrfSectionMessage() != null) {
            variables.put(new Integer(19), new String(sb.getCrfSectionMessage()));
        } else {
            nullVars.put(new Integer(19), new Integer(Types.VARCHAR));
