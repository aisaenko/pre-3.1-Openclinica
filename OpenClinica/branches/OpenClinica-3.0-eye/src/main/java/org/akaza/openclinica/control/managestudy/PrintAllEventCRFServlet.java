...
//        StudyEventDefinitionBean sed = (StudyEventDefinitionBean) sedao.findByPK(defId);
        ...
        ArrayList eventDefinitionCRFs = (ArrayList) edao.findAllByStudy(currentStudy);
        ...
        for (Iterator it = eventDefinitionDefaultVersions.keySet().iterator(); it.hasNext();) {
            ...
            for (Iterator crfIt = crfVersions.iterator(); crfIt.hasNext();) {
                ...
                EventDefinitionCRFBean edcBean = edao.findByStudyEventDefinitionIdAndCRFId(sedBean.getId(), crfBean.getId());
                ...
                if (itemGroupBeans.size() > 0) {
                    ...
                    printCrfBean.setCrfSectionMessage(edcBean.getCrfSectionMessage());
        ...
        forwardPage(Page.VIEW_ALL_DEFAULT_CRF_VERSIONS_PRINT);
    }
