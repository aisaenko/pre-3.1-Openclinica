...
<tr valign="top">
    <td class="table_cell">
    <fmt:message key="enter_crf_header_message" bundle="${resword}"/>
    </td>
</tr>
<tr valign="top">
    <td class="table_cell">
        <div class="formfieldXL_BG_chm"><input type="text" size="85%" name="crfSectionMessage<c:out value="${count}"/>" value="<c:out value="${edc.crfSectionMessage}"/>"></div>
    </td>
</tr>
   &nbsp;
