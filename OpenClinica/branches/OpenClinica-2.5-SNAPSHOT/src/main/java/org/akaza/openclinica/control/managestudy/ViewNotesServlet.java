    ...
    protected void processRequest() throws Exception {
        ...
        String[] columns =
            { resword.getString("study_subject_ID"), resword.getString("date_created"), resword.getString("date_updated"), resword.getString("event_date"),
                ...
                resword.getString("description"), resword.getString("detailed_notes"), ofnotes, resword.getString("resolution_status"),
                resword.getString("type"), resword.getString("entity_type"), resword.getString("created_by"), resword.getString("actions") };
