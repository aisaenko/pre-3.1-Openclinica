...
public class OdmClinicalDataBean {
    ...
    /*
    private List<StudyEventDataBean> studyEventData;
    private List<FormDataBean> formData;
    private List<ImportItemGroupDataBean> itemGroupData;
    private List<ImportItemDataBean> itemData;
    */
    public OdmClinicalDataBean() {
        subjectData = new ArrayList<SubjectDataBean>();
        /*
    ...
    public void setSubjectData(List<SubjectDataBean> subject) {
...
/*
    ...
    public List<StudyEventDataBean> getStudyEventData() {
    ...
    public void setItemGroupData(List<ImportItemGroupDataBean> itemGroupData) {
        this.itemGroupData = itemGroupData;
    }

    public List<ImportItemGroupDataBean> getItemGroupData() {
    ...
    public List<ImportItemDataBean> getItemData() {
