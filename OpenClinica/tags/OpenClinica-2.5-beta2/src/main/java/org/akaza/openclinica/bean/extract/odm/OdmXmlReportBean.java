...
public abstract class OdmXmlReportBean {
    ...
    public void addRootStartLine() {
        xmlOutput.append("<ODM xmlns=\"" + odmbean.getXmlns() + "\" " + "xmlns:xsi=\"" + odmbean.getXsi() + "\" xsi:schemaLocation=\""
            + odmbean.getSchemaLocation() + "\" ODMVersion=\"" + StringEscapeUtils.escapeXml(odmbean.getODMVersion()) + "\" FileOID=\""
            + StringEscapeUtils.escapeXml(odmbean.getFileOID()) + "\" FileType=\"" + odmbean.getFileType() + "\" Description=\""
            + StringEscapeUtils.escapeXml(odmbean.getDescription()) + "\" CreationDateTime=\"" + odmbean.getCreationDateTime() + "\" >");
        xmlOutput.append("\n");
    }
