    ...
    public ExtractBean getDatasetData(ExtractBean eb) {
        ...
        while (it.hasNext()) {
            ...
            if (studySubjectId.intValue() > 0) {
                ...
                String subjectSecondaryLabel = (String) row.get("secondary_label");
                ...
                eb.addStudySubjectData(studySubjectId, studySubjectLabel, dateOfBirth, gender, subjectStatusId, dobCollected, secondaryID,
                ...
                logger.info("*** found item group name before we call add item data on 707: " + itemGroupName);
        ...
        logger.info("count for item data at end: " + eb.getItemNames().size());
        logger.info("count for group names at end: " + eb.getGroupNames().size());
