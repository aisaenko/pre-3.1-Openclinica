...
public class ImportCRFDataService {
                    ...
                    for (CRFVersionBean crfVersionBean : crfVersionBeans) {
                        ...
                        for (StudyEventBean studyEventBean : studyEventBeans) {
                            ...
                            if (eventCrfBeans.isEmpty()) {
                                logger.info("   found no event crfs from Study Event id " + studyEventBean.getId() + ", location "
                                ...
                                if (studyEventBean.getSubjectEventStatus().equals(SubjectEventStatus.SCHEDULED)) {
                                    ...
                                    logger.info("   created and added new event crf");
                                }
                            }
    ...
    public List<DisplayItemBeanWrapper> lookupValidationErrors(javax.servlet.http.HttpServletRequest request, ODMContainer odmContainer, UserAccountBean ub,
        ...
        for (SubjectDataBean subjectDataBean : subjectDataBeans) {
            logger.info("iterating through subject data beans: found " + subjectDataBean.getSubjectOID());
            ArrayList<StudyEventDataBean> studyEventDataBeans = subjectDataBean.getStudyEventData();
            ...
            for (StudyEventDataBean studyEventDataBean : studyEventDataBeans) {
                ...
                ArrayList<FormDataBean> formDataBeans = studyEventDataBean.getFormData();
                logger.info("iterating through study event data beans: found " + studyEventDataBean.getStudyEventOID());
                ...
                for (FormDataBean formDataBean : formDataBeans) {
                    ...
                    logger.info("iterating through form beans: found " + crfVersion.getOid());
                    ...
                    for (ImportItemGroupDataBean itemGroupDataBean : itemGroupDataBeans) {
                        ...
                        logger.info("iterating through group beans: " + itemGroupDataBean.getItemGroupOID());
                        totalItemDataBeanCount += itemDataBeans.size();
                        for (ImportItemDataBean importItemDataBean : itemDataBeans) {
                            logger.info("   iterating through item data beans: " + importItemDataBean.getItemOID());
                            ...
                            if (!itemBeans.isEmpty()) {
                                ...
                                logger.info("   found " + itemBean.getName());
                                // throw a
                                // null
                                // pointer?
                                // hopefully
                                ...
                                logger.info("      found metadata item beans: " + metadataBeans.size());
                    ...
                    logger.info("-- hard validation checks: --");
                    ...
                    logger.info("creation of wrapper: original count of display item beans " + displayItemBeans.size() + ", count of item data beans "
    ...
    private void attachValidator(DisplayItemBean displayItemBean, ImportHelper importHelper, DiscrepancyValidator v, HashMap<String, String> hardv,
            javax.servlet.http.HttpServletRequest request, String eventCRFRepeatKey) throws OpenClinicaException {
        ...
        if (rt.equals(org.akaza.openclinica.bean.core.ResponseType.TEXT) || rt.equals(org.akaza.openclinica.bean.core.ResponseType.TEXTAREA)) {
            ...
            logger.info("        found the value for radio/single: " + theValue);
            if (theValue == null && displayItemBean.getData().getValue() != null) {
                // fail it here
                logger.info("-- theValue was NULL, the real value was " + displayItemBean.getData().getValue());
            ...
            request.setAttribute(itemOid, theValue);
            logger.info("        found the value for checkbx/multi: " + theValue);
            if (theValue == null && displayItemBean.getData().getValue() != null) {
    ...
    private String matchValueWithManyOptions(DisplayItemBean displayItemBean, String value, List options) {
        ...
        if (!options.isEmpty()) {
            for (Object responseOption : options) {
                ResponseOptionBean responseOptionBean = (ResponseOptionBean) responseOption;
                logger.info("testing response option bean get value: " + responseOptionBean.getValue());
            ...
            logger.info("checking on this string: " + regex + " versus this value " + simValue);
                                    ...
                                    if (itemGroupDataBeans != null) {
                                        for (ImportItemGroupDataBean itemGroupDataBean : itemGroupDataBeans) {
                                            ...
                                            if (itemGroupBeans != null) {
                                                logger.info("number of item group beans: " + itemGroupBeans.size());
                                                logger.info("item group oid: " + itemGroupOID);
