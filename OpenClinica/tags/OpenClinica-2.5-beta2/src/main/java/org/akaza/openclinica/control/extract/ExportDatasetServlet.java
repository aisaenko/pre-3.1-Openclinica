...
public class ExportDatasetServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
        ...
        if (StringUtil.isBlank(action)) {
            ...
            // YW 08-2008 << populating data when action is not blank
            ...
            if ("sas".equalsIgnoreCase(action)) {
                ...
                mdc.collectFileData();
                if (odmVersion != null && odmVersion.equals("1.3")) {
                ...
                ClinicalDataCollector cdc = new ClinicalDataCollector(sm.getDataSource(), db);
