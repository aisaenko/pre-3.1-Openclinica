...
<tr>
    ...
    <c:choose>
        <c:when test="${! boolResStatus}">
            ...
            <!--align="left" -->
            <a onmouseup="javascript:setImage('icon_signed','images/icon_Signed.gif');" onmousedown="javascript:setImage('icon_signed','images/icon_Signed.gif');" href="SignStudySubject?id=${currRow.bean.studySubject.id}">
                <img hspace="2" width="24 " height="15" border="0" title="Sign" alt="Sign" src="images/icon_Signed.gif"/>
            </a>
        ...
        <c:otherwise>
            ...
            <a onmouseup="javascript:setImage('icon_signed','images/icon_Signed.gif');" onmousedown="javascript:setImage('icon_signed','images/icon_Signed.gif');" href="SignStudySubject?id=${currRow.bean.studySubject.id}">
                <img hspace="4" width="24 " height="15" border="0" title="Sign" alt="Sign" src="images/icon_Signed.gif"/>
            </a>
