...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <c:forEach items="${status.current.value}" varStatus="status1">
    ...
    <td class="table_cell"><a class="closed" href="#"  id="a${count}" onClick="showOrHideSubjects(${count},'<fmt:message key="rule_show_subjects" bundle="${resword}" />','<fmt:message key="rule_hide_subjects" bundle="${resword}" />')"><fmt:message key="rule_show_subjects" bundle="${resword}" /></a></td>
    </tr>
