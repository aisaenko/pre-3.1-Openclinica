...
<table border="0" cellpadding="0" cellspacing="0" width="650" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">				
	...
	<tr>
	 ...
	 <td class="table_header_column"><fmt:formatDate value="${subject.dateOfBirth}" pattern="${dateFormatPattern}"/></td>
	 <td class="table_header_column"><c:out value="${subject.uniqueIdentifier}"/></td>
	 <td class="table_header_column"><fmt:formatDate value="${studySubject.createdDate}" pattern="${dateFormatPattern}"/></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="550" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">				
	...
	<tr>
	 ...
	 <td class="table_header_column"><fmt:formatDate value="${studySubjectAudit.auditDate}" pattern="${dateTimeFormatPattern}"/>&nbsp;</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="550" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">
	...
	<c:forEach var="event" items="${eventList}">
		<tr>
		 ...
		 <td class="table_header_column"><fmt:formatDate value="${event.dateStarted}" pattern="${dateFormatPattern}"/>&nbsp;</td>
		</tr>
	</c:forEach> 
</table>
<br>
