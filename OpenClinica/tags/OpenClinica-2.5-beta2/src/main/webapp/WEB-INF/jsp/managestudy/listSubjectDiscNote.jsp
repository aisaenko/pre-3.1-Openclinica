...
<div><a id="sumBoxParent" href="javascript:void(0)" onclick="showSummaryBox(document.getElementById('sumBox'),'<fmt:message key="show_summary_statistics" bundle="${resword}"/>','<fmt:message key="hide_summary_statistics" bundle="${resword}"/>')"><fmt:message key="show_summary_statistics" bundle="${resword}"/></a> </div>
