...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr valign="top"><td class="table_header_column"><fmt:message key="date_started" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${displayEvent.studyEvent.dateStarted}" dateStyle="short"/></td></tr>
  <tr valign="top"><td class="table_header_column"><fmt:message key="date_ended" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${displayEvent.studyEvent.dateEnded}" dateStyle="short"/></td></tr>
...
<br>
 ...
 <c:forEach var="dec" items="${displayEvent.displayEventCRFs}">
	<tr>
		...
		<td class="table_cell"><fmt:formatDate value="${dec.eventCRF.dateInterviewed}" dateStyle="short"/></td>
