...
public class GenerateExtractFileService {
     ...
     * @param eb TODO
     * @param currentStudyId TODO
     * @param parentStudyId TODO
     */
    ...
    public HashMap<String, Integer> createODMFile(String odmVersion, long sysTimeBegin, String generalFileDir, DatasetBean datasetBean, StudyBean currentStudy,
            String generalFileDirCopy, ExtractBean eb, Integer currentStudyId, Integer parentStudyId) {
        ...
        while (it.hasNext()) {
            ...
            while (fromIndex < newRows.size()) {
                int toIndex = fromIndex + 99 < newRows.size() ? fromIndex + 99 : newRows.size() - 1;
    ...
    public ExtractBean generateExtractBean(DatasetBean dsetBean, StudyBean currentStudy, StudyBean parentStudy) {
        ExtractBean eb = new ExtractBean(ds, userBean.getActiveStudyRole());
