 ...
 */
package org.akaza.openclinica.dao.oracle.extract;

/**
 * <P>
 * FilterDAOOracleTest.java, by Tom Hickerson
 * <P>
 * Using an oracle connection and Oracle SQL, we are testing the FilterDAO for
 * its functionality.
 *
 * @author thickerson
 *
...
public class FilterDAOOracleTest extends DAOTestBase {
    ...
    public void testFindByPK() throws Exception {
        ...
        System.out.println("Found by primary key " + pkey + " desc: " + ecb.getDescription());
    ...
    public void testGenSQLStatement() throws Exception {
        ...
        String originalStatement =
            "select distinct item_id, item_name, value from test_view_three " + "where " + "(crf_version_id in (2) " + "and "
                + "study_event_id in (1,2,3,4,5,6,7,8,40)) " + "and " + "(date_created >= '01-JAN-90') " + "and " + "(date_created <= '30-NOV-04')";
        String newQuery = fdao.genSQLStatement(originalStatement, "and", al);
        System.out.println(newQuery);
        String newnewQuery = fdao.genSQLStatement(originalStatement, "or", al);
