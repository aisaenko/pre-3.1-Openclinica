...
<h1><span class="title_Admin"><fmt:message key="create_a_new_study_continue" bundle="${resword}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0">
 <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#StudyPhase" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#StudyPhase'); return false;"><fmt:message key="study_phase" bundle="${resword}"/></a>:</td><td>
  ...
  <td><A HREF="#" onClick="cal1.select(document.forms[0].protocolDateVerification,'anchor3','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].protocolDateVerification,'anchor3','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor3" ID="anchor3"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a>* (<fmt:message key="date_format" bundle="${resformat}"/>) </td></tr>
