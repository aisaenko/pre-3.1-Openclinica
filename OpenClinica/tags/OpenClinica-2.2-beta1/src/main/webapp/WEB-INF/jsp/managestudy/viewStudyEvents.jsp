...
<h1><c:choose>
 ...
 <fmt:message key="view_all_events_in" bundle="${resword}"/> <c:out value="${study.name}"/> <a href="javascript:openDocWindow('help/4_5_viewEvents_Help.html')">
 <c:choose>
   <c:when test="${userRole.manageStudy}">
   ...
   <c:otherwise>
    <img src="images/bt_Help_Submit.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>">
   </c:otherwise> 
  </c:choose> 
</a>
...
<tr valign="top">
 ...
 <td><div class="formfieldS_BG">
  ...
  <td><A HREF="#" onClick="cal1.select(document.control.startDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.control.startDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor1" ID="anchor1"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a> (<fmt:message key="date_format" bundle="${resformat}"/>)</td>
  ...
  <td><div class="formfieldS_BG">
   ...
   <td><A HREF="#" onClick="cal1.select(document.control.endDate,'anchor2','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.control.endDate,'anchor2','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor2" ID="anchor2"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a> (<fmt:message key="date_format" bundle="${resformat}"/>)</td>
  </tr>  
  <tr> 
...
<c:forEach var="eventView" items="${allEvents}">    
  ...
  <fmt:message key="event_name" bundle="${resword}"/>: <c:out value="${eventView.definition.name}"/></span><br> 
	...
	<c:choose>
     ...
     <c:otherwise>
       <fmt:formatDate value="${eventView.firstScheduledStartDate}" dateStyle="short"/>
     </c:otherwise>
   ...
   <c:otherwise>
    <fmt:formatDate value="${eventView.lastCompletionDate}" dateStyle="short"/>
   </c:otherwise>
