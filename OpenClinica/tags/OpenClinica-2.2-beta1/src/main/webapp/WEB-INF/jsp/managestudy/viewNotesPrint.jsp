...
<body onload="javascript:alert('<fmt:message key="press_control_p" bundle="${restext}"/>')">
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <table border="0" cellpadding="0" cellspacing="0"> 		
	<tr valign="top">						
	<td class="table_header_row_left"><fmt:message key="resolution_status" bundle="${resword}"/></td>
	<td class="table_header_row"><fmt:message key="type" bundle="${resword}"/></td>
	<td class="table_header_row"><fmt:message key="subject" bundle="${resword}"/></td>	
   ...
   <tr valign="top">
    ...
    <td class="table_cell">
     <c:if test="${note.eventStart != null}">
       <fmt:formatDate value="${note.eventStart}" dateStyle="short"/>
     </c:if>&nbsp;
    </td>
	...
	<td class="table_cell"><fmt:formatDate value="${note.createdDate}" dateStyle="short"/></td>
