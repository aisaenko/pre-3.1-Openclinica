...
<table border="0" cellpadding="0" cellspacing="0" width="650" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">				
	...
	<tr>
	 ...
	 <td class="table_header_column"><fmt:formatDate value="${studySubject.createdDate}" pattern="MM/dd/yyyy"/></td>
...
<br/>
<a href="javascript:openDocWindow('ViewStudySubjectAuditLog?id=<c:out value="${studySubject.id}"/>')">Complete Audit Logs for <c:out value="${studySubject.name}"/></a>
<%-- end for each --%>
<br/><br/>
</c:forEach>
