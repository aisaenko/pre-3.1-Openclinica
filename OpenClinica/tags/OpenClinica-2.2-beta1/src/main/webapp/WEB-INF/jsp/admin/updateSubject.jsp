...
<h1><span class="title_Admin"><fmt:message key="update_subject_details" bundle="${resword}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr valign="top">
		<td class="formlabel"><fmt:message key="date_of_birth" bundle="${resword}"/>:</td>
		  ...
		  <%-- 
		  <input type="text" name="dateOfBirth" size="15" value="<fmt:formatDate value="${subjectToUpdate.dateOfBirth}"  dateStyle="short"/>" class="formfieldXL">
		  --%>
	...
	<tr valign="top">
		<td class="formlabel"><fmt:message key="date_of_birth2" bundle="${resword}"/></td>
	  	<td>
