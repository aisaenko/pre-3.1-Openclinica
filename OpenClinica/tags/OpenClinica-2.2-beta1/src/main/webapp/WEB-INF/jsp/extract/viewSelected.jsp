...
<form action="EditSelected" method="post" name="cl">
 ...
 <input type="submit" name="submit" value="<fmt:message key="select_all_items_in_study" bundle="${resword}"/>" class="button_xlong" onClick='return confirm("<fmt:message key="select_all_items_in_study" bundle="${resword}"/>")' /> 
 
 <fmt:message key="there_a_total_of" bundle="${resword}">
	<fmt:param value="${numberOfStudyItems}"/> 
 </fmt:message> 
 <br/>
</form>
