			 ...
			 <c:if test="${userRole.submitData}">
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_center">
						 ...
						 <div class="homebox_title"><a href="javascript:openDocWindow('help/2_0_submitData_Help.html')"><img width="24" height="15" src="images/bt_Help_Home_gray.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a> <a href="ListStudySubjectsSubmit"><fmt:message key="submit_data" bundle="${resworkflow}"/></a></div><br>
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
	                    ...
	                    <div class="homebox_bullets"><a href="ListCRF"><fmt:message key="manage_CRFs" bundle="${resworkflow}"/></a></div><br>
	                    
	                    <div class="homebox_bullets"><a href="ViewStudyEvents"><fmt:message key="view_study_events" bundle="${resworkflow}"/></a></div><br>
	                    
	                    <div class="homebox_bullets"><a href="ViewNotes"><fmt:message key="manage_discrepancies" bundle="${resworkflow}"/></a></div><br>
              ...
              <a href="javascript:openDocWindow('help/5_0_administerSystem_Help.html')"><img width="24" height="15" src="images/bt_Help_Home_gray.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a> <a href="AdminSystem"><fmt:message key="business_admin" bundle="${resworkflow}"/></a></div><br>
	                    ...
	                    <div class="homebox_bullets"><a href="ListCRF"><fmt:message key="administer_CRFs" bundle="${resworkflow}"/></a></div><br>
						</div>
