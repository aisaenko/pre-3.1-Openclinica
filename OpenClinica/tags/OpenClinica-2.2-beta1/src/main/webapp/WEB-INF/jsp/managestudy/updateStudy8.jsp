...
<h1><span class="title_Admin"><fmt:message key="update_study_details_continue" bundle="${resword}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top"><td class="formlabel"><fmt:message key="interviewer_name_default_as_blank" bundle="${resword}"/></td><td>
   ...
   <c:otherwise>
    ...
    <input type="radio" checked name="interviewerNameDefault" value="re-populated"><fmt:message key="pre_populated_from_SE" bundle="${resword}"/>   
   </c:otherwise>
  </c:choose>
  </td>
  </tr>
