...
<c:out value="${study.name}" />: <fmt:message key="enroll_subject" bundle="${resword}"/> <a href="javascript:openDocWindow('help/2_2_enrollSubject_Help.html#step1')"><img src="images/bt_Help_Submit.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a>
</span></h1>
<br>
...
<table border="0" cellpadding="5"> 
	...
	<tr valign="top">
	  	<td class="formlabel"><fmt:message key="secondary_identifier2" bundle="${resword}"/></td>
		<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top"><div class="formfieldXL_BG">
	  	...
	  	<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td><A HREF="#" onClick="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor1" ID="anchor1"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a>(<fmt:message key="date_format" bundle="${resformat}"/>) *
				...
				<tr>
					<c:choose>
						<c:when test="${gWarning=='emptytrue'}">
							<td>The gender in the database is empty.  To overwrite the database with the current gender, please continue.  If you have any questions, please contact the administrator.</td>
						</c:when>
						<c:when test="${gWarning=='true'}">
							<td>The gender you entered does not match what is in the database.  To accept the gender in the database, please continue.  If you need to change the gender, please contact the administrator.</td>
						</c:when>
					</c:choose>
				</tr>
			</table>
	  	...
	  	<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>(<fmt:message key="date_format" bundle="${resword}"/>) *<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
