							   ...
							   <c:choose>
							    ...
							    <c:when test="${crfStatus =='locked'}">
						 	    ...
						 	    <c:when test="${crfStatus =='invalid' }">
									...
									<img src="images/bt_Restore.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="RestoreEventCRF?action=confirm&id=<c:out value="${eventCrfId}"/>&studySubId=<c:out value="${subjectId}"/>"><fmt:message key="restore" bundle="${resword}"/></a></td></tr>
								   </c:if>
