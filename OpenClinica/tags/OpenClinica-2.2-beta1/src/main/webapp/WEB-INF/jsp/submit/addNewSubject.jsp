...
<c:out value="${study.name}" />: <fmt:message key="add_subject" bundle="${resword}"/> <a href="javascript:openDocWindow('help/2_2_enrollSubject_Help.html#step1')"><img src="images/bt_Help_Submit.gif" border="0" alt="<fmt:message key="help" bundle="${restext}"/>" title="<fmt:message key="help" bundle="${restext}"/>"></a>
</span></h1>
<!--
...
<table border="0" cellpadding="5"> 
	...
	<tr valign="top">
		<td class="formlabel"><fmt:message key="date_of_enrollment_for_study" bundle="${resword}"/>' <c:out value="${study.name}" /> ' :</td>
	  	<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top"><div class="formfieldM_BG">
						<input onfocus="this.select()" type="text" name="enrollmentDate" size="15" value="<c:out value="${enrollmentDate}" />" class="formfieldM" />
					</td>
					<td>
					<A HREF="#" 
					onClick="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>')"; return false;" 
					TITLE="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'"); return false;"
		...
		<td class="formlabel"><fmt:message key="date_of_birth" bundle="${resword}"/>:</td>
	  	<td valign="top">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top"><div class="formfieldM_BG">
						<input onfocus="this.select()" type="text" name="dob" size="15" value="<c:out value="${dob}" />" class="formfieldM" />
					</td>
					<td>(<fmt:message key="date_format" bundle="${resformat}"/>) * <c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?name=subject&field=dob&column=date_of_birth','spanAlert-dob'); return false;">
