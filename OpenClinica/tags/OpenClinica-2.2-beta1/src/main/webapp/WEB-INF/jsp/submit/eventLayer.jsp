		        ...
		        <c:when test="${currEvent.repeatingNum>1}">
		           <!-- start of the repeating events-->
		              <td class="table_header_row_left" colspan="2">
						...
						<br>
						Event: <c:out value="${currEvent.studyEventDefinition.name}"/>	
						...
						<a href="CreateNewStudyEvent?studySubjectId=<c:out value="${subjectId}"/>&studyEventDefinition=<c:out value="${eventDefId}"/>">Add Another Occurrence</a>
						&nbsp &nbsp &nbsp 
        <!-- skip forward/back links: variables represent Table ID for this event, number of occurrences of repeating event, and number to skip to -->
		          ...
		          <!-- scroll back arrow: variables represent Table ID for this event, and number of occurrences of repeating event -->
					...
					<td id="Event_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>_1" valign="top" width="180">
					  <table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr valign="top">
						<td class="table_header_row" colspan="2" nowrap>
						<b>
						Occurrence: #1 of <c:out value="${currEvent.repeatingNum}"/>
						<br>
						<fmt:formatDate value="${currEvent.dateStarted}" pattern="MM/dd/yyyy"/>
						<br>
						Status: <c:out value="${currEvent.subjectEventStatus.name}"/>
						</b>
						</td>
						</tr>		                
						...
						<tr id="Menu_on_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>_1" style="display: none">
							<td colspan="2">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">							    		
								 ...
								 <c:choose>
								  <c:when test="${eventSysStatus == 'available'}">	
								   <c:choose>							   
								    <c:when test="${currEvent.subjectEventStatus.name =='completed'}">
								      <tr valign="top"><td class="table_cell">
								      <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>">View</a></td></tr>
									  ...
									  &nbsp;&nbsp; <a href="UpdateStudyEvent?event_id=<c:out value="${currEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>">Edit</a></td></tr>
									  ...
									  <a href="RemoveStudyEvent?action=confirm&id=<c:out value="${currEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Remove</a></td></tr>
							 	     </c:if>
								    </c:when>
								    ...
								    <c:when test="${currEvent.subjectEventStatus.name =='locked' }">
								      ...
								      <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
								        ...
								        <img src="images/bt_Remove.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="RemoveStudyEvent?action=confirm&id=<c:out value="${currEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Remove</a></td></tr>
								    ...
								    <c:otherwise>		
								      <tr valign="top"><td class="table_cell">
								      <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>">View/Enter Data</a></td></tr>
								    					      
								     <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
									  <tr valign="top"><td class="table_cell"><a href="UpdateStudyEvent?event_id=<c:out value="${currEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>"><img src="images/bt_Edit.gif" border="0" align="left"></a>
									  &nbsp;&nbsp; <a href="UpdateStudyEvent?event_id=<c:out value="${currEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>&module=<c:out value="${module}"/>">Edit</a></td></tr>
							 	  ...
							 	  <c:when test="${currEvent.subjectEventStatus.name == 'removed'}">
							 	   <tr valign="top"><td class="table_cell">
								      <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>">View</a>
								      </td></tr>
								   <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
							 	   <tr valign="top"><td class="table_cell"><a href="RestoreStudyEvent?action=confirm&id=<c:out value="${currEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>"><img src="images/bt_Restore.gif" border="0" align="left"></a>&nbsp;&nbsp; 
									  <a href="RestoreStudyEvent?action=confirm&id=<c:out value="${currEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Restore</a>
									  </td></tr>
								   </c:if>	  
							 	  </c:when>
	             ...
	             <!-- start to get the other events in currEvent.repeatEvents array-->                
					  ...
					  <table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<td class="table_header_row" colspan="2" nowrap>
						<b>
						Occurrence: #<c:out value="${reNum}"/> of <c:out value="${currEvent.repeatingNum}"/>
						<br>
						<fmt:formatDate value="${reEvent.dateStarted}" pattern="MM/dd/yyyy"/>
						<br>	
						Status: <c:out value="${reEvent.subjectEventStatus.name}"/>
						</b>
						</td>
						</tr>
		                 ...
		                 <tr id="Menu_on_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>_<c:out value="${reNum}"/>" style="display: none">
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">						    		
							 ...
							 <c:choose>
							  <c:when test="${eventSysStatus == 'available'}">	
							   <c:choose>							   
							    <c:when test="${reEvent.subjectEventStatus.name =='completed'}">
							      <tr valign="top"><td class="table_cell">
							      <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>">View</a></td></tr>
							    
							      <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
								  <tr valign="top"><td class="table_cell_left"><a href="UpdateStudyEvent?event_id=<c:out value="${reEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>"><img src="images/bt_Edit.gif" border="0" align="left"></a>
								  &nbsp;&nbsp; <a href="UpdateStudyEvent?event_id=<c:out value="${reEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>">Edit</a></td></tr>
								  ...
								  <a href="RemoveStudyEvent?action=confirm&id=<c:out value="${reEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Remove</a></td></tr>
						 	     </c:if>
							    </c:when>
							    <c:when test="${reEvent.subjectEventStatus.name =='locked' }">
							      <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
							        <tr valign="top"><td class="table_cell">
								    <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${currEvent.id}"/>">View</a></td></tr>
							        ...
							        <img src="images/bt_Remove.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="RemoveStudyEvent?action=confirm&id=<c:out value="${reEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Remove</a></td></tr>
						 	      </c:if>
						 	    </c:when>
							    <c:otherwise>		
							      <tr valign="top"><td class="table_cell">
							      <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>">View/Enter Data</a></td></tr>
							     ...
							     <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
								  ...
								  &nbsp;&nbsp; <a href="UpdateStudyEvent?event_id=<c:out value="${reEvent.id}"/>&ss_id=<c:out value="${subjectId}"/>&module=<c:out value="${module}"/>">Edit</a></td></tr>
						 	  ...
						 	  <c:when test="${reEvent.subjectEventStatus.name == 'removed'}">
						 	   <tr valign="top"><td class="table_cell_left">
							      <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${reEvent.id}"/>">View</a>
							      </td></tr>
							   <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
						 	   <tr valign="top"><td class="table_cell_left"><a href="RestoreStudyEvent?action=confirm&id=<c:out value="${reEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>"><img src="images/bt_Restore.gif" border="0" align="left"></a>&nbsp;&nbsp; 
								  <a href="RestoreStudyEvent?action=confirm&id=<c:out value="${reEvent.id}"/>&studySubId=<c:out value="${subjectId}"/>">Restore</a>
								  </td></tr>
							   </c:if>	  
						 	  </c:when>
            ...
            <!-- scroll next arrow: variables represent Table ID for this event, and number of occurrences of repeating event -->
					...
					<tr id="Menu_off_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>" style="">
							<td class="table_cell_left" colspan="<c:out value="${currEvent.repeatingNum}"/>"><i>Click for more options</i></td>
					</tr>
            ...
            <a href="javascript:leftnavExpand('Menu_on_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>'); javascript:leftnavExpand('Menu_off_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>');"
							...
							<td class="table_header_row" colspan="2" nowrap>
							<b>
							Occurrence: #<c:out value="1"/> of <c:out value="${currEvent.repeatingNum}"/>
							<br>
							<fmt:formatDate value="${currEvent.dateStarted}" pattern="MM/dd/yyyy"/>
							<br>	
							Status: <c:out value="${currEvent.subjectEventStatus.name}"/> 
							...
							<c:if test="${eventStatus !='not scheduled'}">
							 ...
							 <c:choose>
							  ...
							  <%-- above lines are for debugging only --%>
						 	  ...
						 	  <c:when test="${eventSysStatus == 'removed'}">
						 	   <tr valign="top"><td class="table_cell_left">
							      <a href="EnterDataForStudyEvent?eventId=<c:out value="${eventId}"/>"><img src="images/bt_View.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="EnterDataForStudyEvent?eventId=<c:out value="${eventId}"/>">View</a>
							      </td></tr>
							   <c:if test="${userRole.role.name=='director' || userBean.sysAdmin}">
						 	   <tr valign="top"><td class="table_cell_left"><a href="RestoreStudyEvent?action=confirm&id=<c:out value="${eventId}"/>&studySubId=<c:out value="${subjectId}"/>"><img src="images/bt_Restore.gif" border="0" align="left"></a>&nbsp;&nbsp; 
								  <a href="RestoreStudyEvent?action=confirm&id=<c:out value="${eventId}"/>&studySubId=<c:out value="${subjectId}"/>">Restore</a>
								  </td></tr>
							   </c:if>	  
						 	  </c:when>
	   ...
	   <a href="javascript:leftnavExpand('Menu_on_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>'); 
         ...
         <%--if(! detectIEWindows(navigator.userAgent)){
          javascript:leftnavExpand('Menu_off_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>');"
              ...
              javascript:leftnavExpand('Menu_off_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>');"
              onmouseover="moveObject('Event_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>', event); setImage('ExpandIcon_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>','images/icon_expand.gif');"
							onmouseout="layersShowOrHide('hidden','Event_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>'); setImage('ExpandIcon_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>','images/icon_blank.gif');"
							onClick="layersShowOrHide('visible','Lock_all'); LockObject('Lock_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>', event);">
