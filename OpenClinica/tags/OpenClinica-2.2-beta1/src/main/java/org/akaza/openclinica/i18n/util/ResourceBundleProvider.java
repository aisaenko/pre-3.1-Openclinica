...
public class ResourceBundleProvider {
	 ...
	 */
	static HashMap<Thread,Locale> localeMap = new HashMap<Thread,Locale>();
	/**
	...
	public static void updateLocale(Locale l){
		System.out.println("* found locale "+
				l.getDisplayCountry()+" "+
	 ...
	 * @param name requested bundle name.
	 * @return
	 */
	 ...
	 * 
	 * @param key 
	 * @return If found, the value associated with the key in the Admin ResourceBundle
	 * 		    else, the key.
	 */
	 ...
	 * 
	 * @param key 
	 * @return If found, the value associated with the key in the Term ResourceBundle
	 * 		    else, the key.
	 */
