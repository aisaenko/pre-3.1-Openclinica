  ...
  public void processRequest() throws Exception {
    ...
    if (studyId==0) {
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        ...
        //YW << Meanwhile update current active study if restored study is current active study
        ...
        //  when an active site's parent study has been restored, this active site will be restored as well if it was auto-removed
