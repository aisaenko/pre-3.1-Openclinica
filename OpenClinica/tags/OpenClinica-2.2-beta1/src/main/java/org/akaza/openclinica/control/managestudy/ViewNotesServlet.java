...
public class ViewNotesServlet extends SecureController {
  ...
  protected void processRequest() throws Exception {
    ...
    String[] columns = { resword.getString("resolution_status"), resword.getString("type"),
    		resword.getString("study_subject_ID"), resword.getString("event"), 
    		resword.getString("event_date"), resword.getString("CRF"),
    		resword.getString("entity_type"), resword.getString("entity_name"), 
    		resword.getString("entity_value"), resword.getString("description"), 
    		resword.getString("date_created"), resword.getString("created_by"),
    		resword.getString("detailed_notes"),ofnotes, resword.getString("actions") };
