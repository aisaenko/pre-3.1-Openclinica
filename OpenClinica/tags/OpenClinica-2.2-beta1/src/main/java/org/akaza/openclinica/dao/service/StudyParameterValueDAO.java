...
public class StudyParameterValueDAO extends AuditableEntityDAO {
  ...
  public ArrayList findAllParameters () {
    ...
    while (it.hasNext()) {
      StudyParameter eb = 
        (StudyParameter) this.getParameterEntityFromHashMap((HashMap) it.next());
      al.add(eb);
    }
    return al;
  }
  ...
  public ArrayList findAllParameterValuesByStudy (StudyBean study) {
    ...
    Iterator it = alist.iterator();
    while (it.hasNext()) {
      StudyParameterValueBean eb = 
        (StudyParameterValueBean) this.getEntityFromHashMap((HashMap) it.next());
      al.add(eb);
    }
    return al;
  }
