    ...
    protected List<DisplayItemGroupBean> validateDisplayItemGroupBean(
      ...
      for (int i=0; i<formGroups.size(); i++) {   
        ...
        for(DisplayItemBean displayItem : items){
          //String inputName = displayGroup.getItemGroupBean().getName() + 
          //	"_" + displayGroup.getOrdinal() + getInputName(displayItem); 
          String inputName =getGroupItemInputName( displayGroup,
