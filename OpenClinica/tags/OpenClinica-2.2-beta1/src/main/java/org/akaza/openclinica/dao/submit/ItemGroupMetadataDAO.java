...
public class ItemGroupMetadataDAO extends EntityDAO {
  ...
  public EntityBean findByPK(int id) throws OpenClinicaException {
    return new ItemGroupMetadataBean();  //To change body of implemented methods use File | Settings | File Templates.;
  }
  ...
  public EntityBean create(EntityBean eb) throws OpenClinicaException {
    ...
    variables.put(1, igMetaBean.getItemGroupId());
    variables.put(2,igMetaBean.getHeader());
    variables.put(3, igMetaBean.getSubheader());
    variables.put(4, igMetaBean.getLayout());
    variables.put(5, igMetaBean.getRepeatNum());
    variables.put(6, igMetaBean.getRepeatMax());
    variables.put(7, igMetaBean.getRepeatArray());
    variables.put(8, igMetaBean.getRowStartNumber());
    variables.put(9, igMetaBean.getCrfVersionId());
    variables.put(10, igMetaBean.getItemId());
    variables.put(11, igMetaBean.getOrdinal());
    variables.put(12, igMetaBean.getBorders());
  ...
  public List<ItemGroupMetadataBean> findMetaByGroupAndSection(int itemGroupId, int sectionId) {
    ...
    List listofMaps = this.select(digester.getQuery("findMetaByGroupAndSection"),
      variables);
  ...
  public Collection findAllByPermission(Object objCurrentUser, int intActionType, String strOrderByColumn, boolean blnAscendingSort, String strSearchPhrase) throws OpenClinicaException {
