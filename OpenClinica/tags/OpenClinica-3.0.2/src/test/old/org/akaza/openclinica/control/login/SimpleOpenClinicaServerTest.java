...
/**
 * <P>
 * SimpleOpenClinicaServerTest.java, the initial class for using HttpUnit.
 * <P>
 * Currently only holds the address for the internal server and has timing
 * records, but can also hold methods for login, etc.
 *
 * @author thickerson
 *
 *
