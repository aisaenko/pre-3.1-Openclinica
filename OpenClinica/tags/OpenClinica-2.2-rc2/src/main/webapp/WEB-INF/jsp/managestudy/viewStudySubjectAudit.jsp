...
<table border="0" cellpadding="0" cellspacing="0" width="550" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">				
	...
	<tr>
	 ...
	 <td class="table_header_column"><fmt:formatDate value="${studySubjectAudit.auditDate}" pattern="MM/dd/yy hh:mm:ss a"/>&nbsp;</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="550" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">
	...
	<c:forEach var="event" items="${events}">
		<tr>
		 ...
		 <c:otherwise>
		 	<td class="table_header_column"><fmt:formatDate value="${event.dateStarted}" pattern="MM/dd/yy hh:mm:ss a"/>&nbsp;</td>
		 </c:otherwise>
		 </c:choose>
		</tr>
	</c:forEach> 
				...
				<c:forEach var="eventCRFAudit" items="${eventCRFAudits}">
					<c:if test="${eventCRFAudit.eventCRFId==eventCRF.id}">
						<tr>
						 ...
						 <td class="table_header_column"><fmt:formatDate value="${eventCRFAudit.auditDate}" pattern="MM/dd/yy hh:mm:ss a"/>&nbsp;</td>
