...
<h1><span class="title_Admin"><fmt:message key="confirm_restore_of_subject" bundle="${restext}"/></span></h1>
...
<table border="0" cellpadding="0"> 
  ...
  <fmt:formatDate value="${subjectToRestore.dateOfBirth}" dateStyle="short"/>
  </td>
  <tr valign="top"><td class="table_header_column"><fmt:message key="date_created" bundle="${resword}"/>:</td><td class="table_cell">  
  <fmt:formatDate value="${subjectToRestore.createdDate}" dateStyle="short"/>
  </td>
  </tr> 
</table>
</div>
