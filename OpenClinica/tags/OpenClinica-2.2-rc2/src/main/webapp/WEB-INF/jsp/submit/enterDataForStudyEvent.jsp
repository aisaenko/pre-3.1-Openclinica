				 ...
				 <c:choose>
					...
					<td class="table_cell">
		             <a href="ViewSectionDataEntry?eventDefinitionCRFId=<c:out value="${dedc.edc.id}"/>&crfVersionId=<c:out value="${dedc.edc.defaultVersionId}"/>&tabId=1"
		              ...
		              name="bt_View1" align="left" src="images/bt_View.gif" border="0" alt="View Default" title="View Default" hspace="2"></a>&nbsp;
		             ...
		             <a href="javascript:openDocWindow('PrintCRF?id=<c:out value="${dedc.edc.defaultVersionId}"/>')"
		              ...
		              name="bt_Print1" align="left" src="images/bt_Print.gif" border="0" alt="Print Default" title="Print Default"  hspace="2"></a>&nbsp;
					  </td>
					 </tr>
					</table>
		        </form> 
