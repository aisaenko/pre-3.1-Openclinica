			...
			<tr valign="top">
			  ...
			  <td class="table_cell" width="180"><c:out value="${dedc.edc.crf.name}" /></td>
				...
				<c:otherwise>
		         ...
		         <td><a href="ViewSectionDataEntry?eventDefinitionCRFId=<c:out value="${dedc.edc.id}"/>&crfVersionId=<c:out value="${dedc.edc.defaultVersionId}"/>&tabId=1"
			     onMouseDown="javascript:setImage('bt_View1','images/bt_View_d.gif');"
			     onMouseUp="javascript:setImage('bt_View1','images/bt_View.gif');"><img 
		         name="bt_View1" src="images/bt_View.gif" border="0" alt="View Default" title="View Default" align="left" hspace="6"></a></td>
		         ...
		         name="bt_Print1" src="images/bt_Print.gif" border="0" alt="Print Default" title="Print Default" align="left" hspace="6"></a></td>
