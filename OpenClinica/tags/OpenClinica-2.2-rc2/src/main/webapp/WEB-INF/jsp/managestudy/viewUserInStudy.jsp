...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr><td class="table_header_column"><fmt:message key="date_created" bundle="${resword}"/>:</td><td class="table_cell"><c:out value="${user.createdDate}"/></td></tr>
  ...
  <tr><td class="table_header_column"><fmt:message key="date_updated" bundle="${resword}"/>:</td><td class="table_cell"><c:out value="${user.updatedDate}"/>&nbsp;</td></tr>
