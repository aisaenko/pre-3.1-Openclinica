...
public class StudyBean extends AuditableEntityBean {
	...
	//YW << The original reason to add this is being able to list on userbox.jsp the study name to which a site belong.
	//      This property doesn't exist in the database table <Study>, so it might not has value if it hasn't been assigned 
	...
	private String sponsor = ResourceBundleProvider.getAdminBundle().getString("n_a");
  ...
  public void setResultsReference(boolean resultsReference) {
	...
	/**
	 * @return Returns the allocation key, should be used when storing the
	...
	/**
	 * @return Returns the assignment key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the control key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the duration key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the endpoint key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the facilityRecruitmentStatus key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the gender key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the interventions, using the keys of
	 * the intervention types, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the masking key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the phase key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the purpose key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the selection key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the timing key, should be used when storing the
	 * Study in the database.
	 */
	...
	/**
	 * @return Returns the type key, should be used when storing the
	 * Study in the database.
	 */
