...
public abstract class Table {
	...
	protected ArrayList columns; // an array of Strings which are column headings, setup during initialization
	protected int numColumns; // provided for convenience in showTable class; always equals columns.size()
	
	protected int currPageNumber; // which page are we viewing now?
	protected int totalPageNumbers; // how many page numbers are there total?  always equal to ceil(rows.size() / NUM_ROWS_PER_PAGE)
	protected int sortingColumnInd; // index into arrColumns of the Column we’re current sorting by
	protected boolean ascendingSort; // true for ascending sort, false otherwise
	protected boolean filtered; // true if we use the keyword filter, false otherwise
	protected String keywordFilter; // String the user wants to search for among the rows
