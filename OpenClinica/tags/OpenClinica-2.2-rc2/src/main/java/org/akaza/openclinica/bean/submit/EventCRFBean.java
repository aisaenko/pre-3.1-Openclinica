...
public class EventCRFBean extends AuditableEntityBean {
	...
	/**
	 * The problem with the above data entry stage getter is that you can
	 * never set the stage back to 'invalid'.
	 * @param boolean invalidate, allowing us to invalidate the stage again
	 */
