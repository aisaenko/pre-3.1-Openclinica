...
<table border="0" cellpadding="0" cellspacing="0" width="550" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;">				
	...
	<tr>
	 ...
	 <td class="table_header_column"><fmt:formatDate value="${studySubjectAudit.auditDate}" type="both" pattern="${dteFormat}" timeStyle="short"/>&nbsp;</td>
				...
				<c:forEach var="studyEventAudit" items="${studyEventAudits}">
					<c:if test="${studyEventAudit.entityId==event.id}">
						<tr>
						 ...
						 <td class="table_header_column"><fmt:formatDate value="${studyEventAudit.auditDate}" type="both" pattern="${dteFormat}" timeStyle="short"/>&nbsp;</td>
				...
				<c:forEach var="eventCRFAudit" items="${eventCRFAudits}">
					<c:if test="${eventCRFAudit.eventCRFId==eventCRF.id}">
						<tr>
						 ...
						 <td class="table_header_column"><fmt:formatDate value="${eventCRFAudit.auditDate}" type="both" pattern="${dteFormat}" timeStyle="short"/>&nbsp;</td>
