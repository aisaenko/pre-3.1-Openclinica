...
public class ImportCRFDataServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
        ...
        File xsdFile2 = new File(getServletContext().getInitParameter("propertiesDir") + "ODM1-2-1.xsd");
        ...
        if ("confirm".equalsIgnoreCase(action)) {
            ...
            try {
                ...
                logger.info("Found crf data container for study oid: " + odmContainer.getCrfDataPostImportContainer().getStudyOID());
                logger.info("found length of subject list: " + odmContainer.getCrfDataPostImportContainer().getSubjectData().size());
