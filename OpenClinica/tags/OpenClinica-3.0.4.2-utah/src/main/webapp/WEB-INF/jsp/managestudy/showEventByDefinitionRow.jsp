    ...
    <tr valign="top">  
      ...
      <td class="table_cell">
       <table border="0" cellpadding="0" cellspacing="0">
        ...
        <c:if test="${(!userRole.monitor && currRow.bean.studySubject.status.name != 'removed' && currRow.bean.studySubject.status.name != 'auto-removed' && !currRow.bean.status.deleted) && (study.status.available)}">
		<td>
