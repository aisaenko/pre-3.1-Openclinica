...
public class ListCRFRow extends EntityBeanRow {
  ...
  public static final int COL_VERSIONS = 3;

  public static final int COL_DATE_CREATED = 4;

  public static final int COL_OWNER = 5;

  public static final int COL_STATUS = 6;
  
  public static final int COL_DOWNLOAD = 7;
  ...
  protected int compareColumn(Object row, int sortingColumn) {
    ...
    case COL_DATE_CREATED:      
      ...
      break;
    case COL_OWNER:
      answer = thisCRF.getOwner().getName().toLowerCase().compareTo(
          argCRF.getOwner().getName().toLowerCase());
      break;
