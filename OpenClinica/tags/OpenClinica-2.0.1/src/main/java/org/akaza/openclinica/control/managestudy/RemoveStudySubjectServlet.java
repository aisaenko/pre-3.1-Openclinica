...
public class RemoveStudySubjectServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if (StringUtil.isBlank(studySubIdString) || StringUtil.isBlank(subIdString)
      ...
      addPageMessage("Please choose a study subject to remove.");
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        if (!studySub.getStatus().equals(Status.AVAILABLE)) {
          addPageMessage("This subject is not available for this study."
        ...
        String emailBody = "The Subject " + subject.getName() + " has been removed from the Study "
            + study.getName() + ".";
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), "Remove Subject from Study",
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
          "Remove Subject From Study", emailBody);
