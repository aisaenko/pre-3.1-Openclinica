...
<tr id="sidebar_Instructions_open" style="display: all">
		...
		<div class="sidebar_tab_content">
		  ...
		  The list of events happened in the current month in your current study/site is shown as default.
          <br><br>
          Subjects who were scheduled but no data entry done past the date scheduled are highlighted in yellow color.
