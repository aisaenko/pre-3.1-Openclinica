...
<tr id="sidebar_Instructions_open" style="display: all">
        ...
        Confirm restoration of this user to Study/Site <c:out value="${study.name}"/>.
		</div>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr valign="bottom"><td class="table_header_column_top">First Name:</td><td class="table_cell"><c:out value="${user.firstName}"/></td></tr>
  <tr valign="bottom"><td class="table_header_column_top">Last Name:</td><td class="table_cell"><c:out value="${user.lastName}"/></td></tr>
  <tr valign="bottom"><td class="table_header_column_top">Role:</td><td class="table_cell"><c:out value="${uRole.role.name}"/></td>  
  </tr> 
