...
click <input type="submit" name="submit" value="Go Back" class="button" onclick="javascript:history.go(-1)"> to go back and upload your corrected speadsheet for the CRF.
<br/>
