...
<table border="0" cellpadding="0" cellspacing="0">
 <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#StudyPhase" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#StudyPhase'); return false;">Study Phase</a>:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#StudyType" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#StudyType'); return false;">Protocol Type</a>:</td><td>
  <c:set var="type1" value="observational"/>
  <c:choose>
   <c:when test="${newStudy.protocolType == type1}">
    <input type="radio" name="protocolType" value="interventional">Interventional
    <input type="radio" checked name="protocolType" value="observational">Observational
   </c:when>
   <c:otherwise>
    <input type="radio" checked name="protocolType" value="interventional">Interventional
    <input type="radio" name="protocolType" value="observational">Observational
   </c:otherwise>
  </c:choose>
  ...
  <tr valign="top"><td class="formlabel">Study System Status:</td><td><div class="formfieldL_BG">
  ...
  <div class="formfieldL_BG"><input type="text" name="protocolDateVerification" value="<c:out value="${protocolDateVerification}" />" class="formfieldL"></div>
  <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="protocolDateVerification"/></jsp:include></td>
  <td><A HREF="#" onClick="cal1.select(document.forms[0].protocolDateVerification,'anchor3','MM/dd/yyyy'); return false;" TITLE="cal1.select(document.forms[0].protocolDateVerification,'anchor3','MM/dd/yyyy'); return false;" NAME="anchor3" ID="anchor3"><img src="images/bt_Calendar.gif" alt="Show Calendar" title="Show Calendar" border="0" /></a>* (MM/DD/YYYY) </td></tr>
  
  <tr valign="top"><td class="formlabel">Study Start Date:</td><td><div class="formfieldL_BG">
  <input type="text" name="startDate" value="<c:out value="${startDate}" />" class="formfieldL"></div>
  ...
  <tr valign="top"><td class="formlabel">Study Completion Date:</td><td><div class="formfieldL_BG">
  <input type="text" name="endDate" value="<c:out value="${endDate}" />" class="formfieldL"></div>
