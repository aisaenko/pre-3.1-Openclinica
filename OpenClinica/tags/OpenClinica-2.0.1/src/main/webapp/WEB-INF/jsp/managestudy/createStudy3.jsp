...
<table border="0" cellpadding="0" cellspacing="0">
  <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#IntPurpose" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#IntPurpose'); return false;">Purpose</a>:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#IntAllocation" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#IntAllocation'); return false;">Allocation<a/>:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><a href="definitions.html#IntMasking" target="def_win" onClick="openDefWindow('definitions.html#IntMasking'); return false;">Masking:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#IntControl" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#IntControl'); return false;">Control</a>:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#InterventionType" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#InterventionType'); return false;">Intervention(s)</a><br> (one name per line):</td><td>
   ...
   Type:
     ...
     Name: <input type="text" name="interName<c:out value="${count}"/>" value="<c:out value="${intervention.name}"/>">
      <br>  
   ...
   <c:if test="${count < 9}">
    <c:forEach begin="${count}" end="9">
     ...
     Name: <input type="text" name="interName<c:out value="${count}"/>" value=""><br>
    <c:set var="count" value="${count+1}"/>
    </c:forEach>
   </c:if>
    <br>
