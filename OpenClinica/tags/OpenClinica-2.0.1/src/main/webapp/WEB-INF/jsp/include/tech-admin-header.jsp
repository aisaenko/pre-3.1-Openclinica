						 ...
						 <c:set var="roleName" value="${userRole.role.name}"/>
                           ...
                           <c:if test="${roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}">
							...
							<td><a href="TechAdmin"
							   ...
							   onMouseOut="javascript:setImage('nav_TechAdmin','images/nav_TechAdmin_s.gif');"><img 
					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td><a href="ListUserAccounts"
							   onMouseOver="javascript:setImage('subnav_TechAdmin_Users','images/subnav_TechAdmin_Users_h.gif');"
							   onMouseOut="javascript:setImage('subnav_TechAdmin_Users','images/subnav_TechAdmin_Users.gif');"><img 
							...
							<%--<td><a href="ViewScheduler"
							   onMouseOver="javascript:setImage('subnav_TechAdmin_SystemProperties','images/subnav_TechAdmin_SystemProperties_h.gif');"
							   onMouseOut="javascript:setImage('subnav_TechAdmin_SystemProperties','images/subnav_TechAdmin_SystemProperties.gif');"><img 
							...
							<td><a href="Enterprise"
							   onMouseOver="javascript:setImage('subnav_TechAdmin_OCEnterprise','images/subnav_TechAdmin_OCEnterprise_h.gif');"
							   onMouseOut="javascript:setImage('subnav_TechAdmin_OCEnterprise','images/subnav_TechAdmin_OCEnterprise.gif');"><img 
