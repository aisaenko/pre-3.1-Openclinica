...
<a href="#global">Global Subject Record</a> &nbsp;&nbsp;&nbsp;
...
<a href="javascript:leftnavExpand('subjectRecord');javascript:setImage('ExpandGroup1','images/bt_Expand.gif');"><img 
	     name="ExpandGroup1" src="images/bt_Collapse.gif" border="0"> Subject Record for <c:out value="${studySub.label}"/></a></div>
  ...
  <c:choose>
   ...
   <c:otherwise>
    <div class="table_title_submit">
	     ...
	     name="ExpandGroup2" src="images/bt_Collapse.gif" border="0"> Events</a></a></div>
