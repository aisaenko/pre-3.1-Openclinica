...
View Event CRF: <c:out value="${studySub.label}"/>-<c:out value="${toc.crf.name}"/>
</span></h1>

Click the 'view' icon for each section in the following table to view the CRF. </p>
<p>
<div class="homebox_bullets"><a href="ViewEventCRF?id=<c:out value="${toc.eventCRF.id}"/>&studySubId=<c:out value="${studySub.id}"/>">View Event CRF Properties</a></div>
<p>
<p>
...
<a href="javascript:openDocWindow('PrintDataEntry?ecId=<c:out value="${toc.eventCRF.id}"/>')"
					...
					<a href="javascript:openDocWindow('PrintDataEntry?ecId=<c:out value="${toc.eventCRF.id}"/>')">Print Entire CRF</a>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<td class="table_header_row">Uncompleted Items</td>
