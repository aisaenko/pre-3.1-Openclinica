...
<c:out value="${study.name}" />: Add Existing Subject <a href="javascript:openDocWindow('help/2_2_enrollSubject_Help.html#step1')"><img src="images/bt_Help_Submit.gif" border="0" alt="Help" title="Help"></a>
</span></h1>
<br>

<jsp:include page="../include/alertbox.jsp" />
<p>Based on the Global Unique ID you entered, this subject already exists in the system. Please confirm the information shown below before proceeding. If any of this information is incorrect, please contact your study coordinator or OpenClinica administrator.</p>
...
<tr>
<td>
<input type="submit" name="submitEvent" value="Save and Add Study Event" class="button_long">
</td>
