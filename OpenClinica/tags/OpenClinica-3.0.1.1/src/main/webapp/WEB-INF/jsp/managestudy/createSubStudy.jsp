...
<div class="table_title_Manage"><a href="javascript:leftnavExpand('siteProperties');javascript:setImage('ExpandGroup3','images/bt_Collapse.gif');"><img
	     name="ExpandGroup3" src="images/bt_Expand.gif" border="0"> <fmt:message key="create_site_properties" bundle="${resword}"/> </a></div>
...
<table border="0" cellpadding="0" cellspacing="0">
 ...
 <div class="table_title_Manage"><a href=#><fmt:message key="update_site_event_definitions" bundle="${resword}"/></a></div>
...
<c:forEach var="def" items="${definitions}">
	...
	&nbsp&nbsp&nbsp&nbsp<b><a href="javascript:leftnavExpand('sed<c:out value="${defCount}"/>');javascript:setImage('ExpandGroup3','images/bt_Collapse.gif');"><img
	     name="ExpandGroup3" src="images/bt_Expand.gif" border="0"> <c:out value="${def.name}"/></b></a>
	</c:otherwise>
	</c:choose>
