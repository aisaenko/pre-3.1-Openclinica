  ...
  public void processRequest() throws Exception {
    ...
    if (studyId==0) {
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        ...
        //  if current active study is a site and the deleted study is this active site's parent study, 
        //  then this active site has to be removed as well (auto-removed)
