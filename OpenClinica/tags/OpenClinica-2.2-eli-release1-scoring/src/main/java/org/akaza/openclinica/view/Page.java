...
public class Page {
  ...
  //public final static Page CREATE_DATASET_DISC_ATTR = new Page("/WEB-INF/jsp/extract/selectDiscrepancyAttributes.jsp","Create Dataset and select discrepancy Attribute");
...
//  public final static Page SUBMIT_DATA_SERVLET = new Page("/SubmitData", "Submit Data Menu");
  ...
  public final static Page VIEW_SECTION_DATA_ENTRY_PREVIEW = new Page("/SectionPreview","Preview CRF Servelet");
  //YW >>
