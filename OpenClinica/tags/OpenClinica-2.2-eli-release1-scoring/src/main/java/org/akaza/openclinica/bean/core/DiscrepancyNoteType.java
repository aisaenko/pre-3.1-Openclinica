...
public class DiscrepancyNoteType extends Term {
  ...
  public static final DiscrepancyNoteType FAILEDVAL =
    new DiscrepancyNoteType(1, "Failed_Validation_Check",null);

  public static final DiscrepancyNoteType INCOMPLETE = new DiscrepancyNoteType(2, "Incomplete", null);

  public static final DiscrepancyNoteType UNCLEAR = 
    new DiscrepancyNoteType(3, "Unclear/Unreadable", null);

  public static final DiscrepancyNoteType ANNOTATION =
    new DiscrepancyNoteType(4, "Annotation",null);

  public static final DiscrepancyNoteType OTHER = new DiscrepancyNoteType(5, "Other",null);

  private static final DiscrepancyNoteType[] members = 
  {FAILEDVAL, INCOMPLETE, UNCLEAR, ANNOTATION,OTHER};
