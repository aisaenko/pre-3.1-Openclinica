...
public class StudyInfoPanel {
  ...
  public void setData(Page page, HttpSession session, HttpServletRequest request) {
	  ...
	  local_sdf = new SimpleDateFormat(ResourceBundleProvider.getFormatBundle().getString("date_format_string"));
    ...
    try {
      ...
      if (page.equals(Page.CREATE_DATASET_1)) {
        ...
        //this.setData("Number of Steps", "5");
    		  ...
    		  || page.equals(Page.CREATE_DATASET_EVENT_ATTR)
    		  || page.equals(Page.CREATE_DATASET_SUB_ATTR)
    		  || page.equals(Page.CREATE_DATASET_CRF_ATTR)
    		  || page.equals(Page.CREATE_DATASET_GROUP_ATTR)
  ...
  public String getTOCLink(DisplayEventCRFBean dec) {
    ...
    if (!dec.getEventCRF().getStatus().equals(Status.DELETED) &&
      ...
      if (dec.isContinueInitialDataEntryPermitted()) {
        ...
        answer = "ViewSectionDataEntry?eventDefinitionCRFId="+ dec.getEventDefinitionCRF().getId() +
          "&ecId="+ dec.getEventCRF().getId() + "&tabId=1";
      }
    }
    return answer;
  }
    ...
    while (itRows.hasNext()) {
      ...
      while (displayIt.hasNext()) {
        ...
        if ((count == displayCRFs.size() - 1) && dseBean.getUncompletedCRFs().size() == 0) {
          ...
          if ((ecb != null) && (ecb.getId() == dec.getEventCRF().getId()) ) {//was getName(), tbh
