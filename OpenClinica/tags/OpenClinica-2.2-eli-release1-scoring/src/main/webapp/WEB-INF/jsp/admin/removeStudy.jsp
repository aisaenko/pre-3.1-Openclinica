...
<h1><span class="title_Admin"><fmt:message key="confirm_removal_of_study" bundle="${resword}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">  
 <tr valign="top">
  ...
  <form action="RemoveStudy?action=submit&id=<c:out value="${studyToRemove.id}"/>" method="POST">  
    ...
    <input type="button" value="<fmt:message key="cancel" bundle="${resword}"/>" title="Cancel" class="button_long" size="50" onclick="history.back();"/>
 </form>
