...
<c:choose>
  ...
  Marking this CRF complete will finalize data entry. You will no longer be able to add or modify data unless the CRF is reset by an administrator. If Double Data Entry is required, you or another user may need to complete this CRF again before it is verified as complete. If you are sure you want to mark this CRF complete, please enter your password in the box below. Then select OK.
  </c:when>
  <c:otherwise>
