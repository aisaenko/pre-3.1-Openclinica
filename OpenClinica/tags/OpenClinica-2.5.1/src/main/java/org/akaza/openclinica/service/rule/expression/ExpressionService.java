...
public class ExpressionService {
    ...
    /* The variables below are used as a small Cache so that we don't go
     * to the database every time we want to get an Object by it's OID. 
     * This is a very stripped down cache which will help performance in
    ...
    */
    ...
    public StudyEventDefinitionBean getStudyEventDefinitionFromExpression(String expression, StudyBean study) {
        ...
        if (studyEventDefinitions.get(studyEventDefinitionKey) != null) {
            ...
            StudyEventDefinitionBean studyEventDefinition = getStudyEventDefinitionDao().findByOidAndStudy(studyEventDefinitionKey, study.getId());
