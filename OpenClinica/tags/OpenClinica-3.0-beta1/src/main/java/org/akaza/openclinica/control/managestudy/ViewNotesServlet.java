...
public class ViewNotesServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        //BWP  #3583; ensure that disc notes are displayed in the DN matrix
        // at the site level; for the notes
        //created at the study level <<
         ...
         * { filteredRows.add(dnr); } } } else if
         * (resolutionStatus.equalsIgnoreCase("closed")) { for (int i = 0; i <
         * noteRows.size(); i++) { DiscrepancyNoteRow dnr = (DiscrepancyNoteRow)
         * noteRows.get(i); DiscrepancyNoteBean dnb = (DiscrepancyNoteBean)
         * dnr.getBean(); if
         * (dnb.getResStatus().equals(ResolutionStatus.CLOSED)) {
         * filteredRows.add(dnr); } } } table.setRows(filteredRows); } else {
