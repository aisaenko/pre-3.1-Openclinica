...
public class ImportSpringJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            if ((target.length > 0) && (destination.length > 0)) {
                ...
                try {
                    mailSender.sendEmail(contactEmail, "Job ran for " + triggerBean.getFullName(), generateMsg(auditMessages.get(0), contactEmail), true);
            ...
            try {
                mailSender.sendEmail(contactEmail, "Job FAILURE for " + triggerBean.getFullName(), e.getMessage(), true);
    ...
    private String generateMsg(String msg, String contactEmail) {
        String returnMe =
            "Dear " + contactEmail + ",<br/>Your job ran successfully with the following messages returned.  "
    ...
    private ArrayList<String> processData(File[] dest, DataSource dataSource, ResourceBundle respage, UserAccountBean ub, StudyBean studyBean) throws Exception {
        ...
        for (File f : dest) {
            ...
            if (fail) {
                ...
                String finalLine = "<p>You can review the entered data <a href='" + SQLInitServlet.getField("sysURL.base") + "ListStudySubjects'>here</a>.";
