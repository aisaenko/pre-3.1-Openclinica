...
public class StudySubjectDAO extends AuditableEntityDAO {
    ...
    public ArrayList findAllByStudySDV(int studyId, int parentStudyId, int limit, int offset) {
        this.setTypesExpected();
        HashMap variables = new HashMap();
        ...
        return executeFindAllQuery("findAllByStudySDV", variables);
    }

    public int countAllByStudySDV(int studyId, int parentStudyId) {
        this.unsetTypeExpected();
    ...
    public Integer getCountWithFilter(ListDiscNotesSubjectFilter filter, StudyBean currentStudy) {
        ...
        System.out.println("getCountWithFilterAndSort sql=" + sql);
