...
public class ListStudySubjectTableToolbar extends DefaultToolbar {
    ...
    private final boolean studyAvailable;


    public ListStudySubjectTableToolbar(ArrayList<StudyEventDefinitionBean> studyEventDefinitions, ArrayList<StudyGroupClassBean> studyGroupClasses, boolean studyAvailable) {
        super();
        this.studyEventDefinitions = studyEventDefinitions;
        this.studyGroupClasses = studyGroupClasses;
        this.studyAvailable = studyAvailable;
