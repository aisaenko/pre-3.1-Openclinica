...
public class UpdateJobExportServlet extends SecureController {
    ...
    private void setUpServlet(Trigger trigger) {
        ...
        presetValues.put(CreateJobExportServlet.DATE_START_JOB + "Date", (calendar.get(Calendar.MONTH) + 1) + "/" + calendar.get(Calendar.DATE) + "/"
    ...
    protected void processRequest() throws Exception {
        ...
        if (StringUtil.isBlank(action)) {
            ...
            if (!errors.isEmpty()) {
                ...
                trigger = triggerService.generateTrigger(fp, sm.getUserBean(), study);
                // scheduler = getScheduler();
