...
public class EventService implements EventServiceInterface {
    ...
    public Integer validateAndSchedule(String studySubjectId, String studyUniqueId, String eventDefinitionOID, String location, Date startDateTime,
        ...
        StudyEventDefinitionBean studyEventDefinition = getStudyEventDefinitionDao().findByOidAndStudy(eventDefinitionOID, study.getId(), study.getId());
        ...
        return scheduleEvent(user, studySubject, studyEventDefinition, study, startDateTime, endDateTime, location);
    }
