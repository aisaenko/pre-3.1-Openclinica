...
<h1><span class="title_submit"><fmt:message key="double_data_entry_for" bundle="${resword}"/> <c:out value="${section.crf.name}" /> <c:out value="${section.crfVersion.name}" /></span></h1>
<%--</div>--%>
