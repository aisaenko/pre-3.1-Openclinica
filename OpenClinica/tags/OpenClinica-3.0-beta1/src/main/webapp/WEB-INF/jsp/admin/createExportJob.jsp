...
<h1><span class="title_Admin"><fmt:message key="create_scheduled_job_export_dataset" bundle="${resword}"/></span></h1>
<p>
...
<table>
	...
	<tr>
		...
		<td class="text">
			...
			<tr>
				<td class="text"><fmt:message key="spss_symtax_and_data" bundle="${resword}"/></td>
