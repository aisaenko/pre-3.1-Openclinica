...
<fmt:message key="sdv_sdv_for" bundle="${resword}"/> <c:out value="${study.name}"/> <a href="javascript:openDocWindow('help/4_2_subjects_Help.html')"><img src="../images/bt_Help_Manage.gif" border="0" alt="<fmt:message key="help" bundle="${restext}"/>" title="<fmt:message key="help" bundle="${restext}"/>"></a>
</span></h1>
        ...
        <tr>
            <td valign="bottom" id="Tab1'">
              <div id="Tab1Selected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Study Subject Id" href='viewSubjectAggregate?studyId=${studyId}' onclick="javascript:HighlightTab(1);">View By Study Subject Id</a></div></div></div></div>
...
<div id="subjectSDV">
    ...
    <script type="text/javascript">hideCols('sdv',[2,3,4])</script>
