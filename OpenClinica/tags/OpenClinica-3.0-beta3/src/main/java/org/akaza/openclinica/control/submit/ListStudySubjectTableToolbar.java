...
public class ListStudySubjectTableToolbar extends DefaultToolbar {
    ...
    public ListStudySubjectTableToolbar(ArrayList<StudyEventDefinitionBean> studyEventDefinitions, ArrayList<StudyGroupClassBean> studyGroupClasses, boolean addSubjectLinkShow) {
        super();
