...
<div class="table_title_Manage"><a href="javascript:leftnavExpand('siteProperties');javascript:setImage('ExpandGroup3','images/bt_Collapse.gif');"><img
	     name="ExpandGroup3" src="images/bt_Expand.gif" border="0"> <fmt:message key="view_site_properties" bundle="${resword}"/> </a></div>
<c:choose>
...
<br>
	...
	<div class="table_title_Manage"><a href=#><fmt:message key="view_site_event_definitions" bundle="${resword}"/> </a></div>


<c:set var="defCount" value="0"/>
<c:forEach var="definition" items="${definitions}">
<c:set var="defCount" value="${defCount+1}"/>
	&nbsp&nbsp&nbsp&nbsp<b><a href="javascript:leftnavExpand('sed<c:out value="${defCount}"/>');javascript:setImage('ExpandGroup4','images/bt_Collapse.gif');"><img
	     name="ExpandGroup4" src="images/bt_Expand.gif" border="0"> <c:out value="${definition.name}"/></b></a>
		<c:choose>
