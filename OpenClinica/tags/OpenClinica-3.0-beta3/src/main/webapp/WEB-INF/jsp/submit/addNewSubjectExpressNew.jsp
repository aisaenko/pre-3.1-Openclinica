		...
		<td class="formlabel">
	  	...
	  	<td valign="top">
            ...
            <div class="formfieldM_BG">
						<input onfocus="this.select()" type="text" name="enrollmentDate" size="15" value="<fmt:message key="enrollMMDDYYYY" bundle="${resword}"/>: <fmt:message key="date_format" bundle="${resformat}"/>" class="formfieldM" id="enrollmentDateField" />
					</td>
					<td>
					<A HREF="#">
			...
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top"><div class="formfieldM_BG">
						<input onfocus="this.select()" type="text" name="dob" size="15" value="<fmt:message key="DOB" bundle="${resword}"/>: <fmt:message key="date_format" bundle="${resformat}"/>" class="formfieldM" id="dobField" />
					</td>
					<td>
					<A HREF="#">
...
<c:if test="${(!empty studyGroupClasses)}">
    ...
    <tr valign="top">
        <td class="formlabel"><fmt:message key="SED" bundle="${resword}"/>:</td>
        <td valign="top">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr><td>
          ...
          <td valign="top">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="top">
                        <div class="formfieldM_BG">
                        <input type="text" name="startDate" size="15" value="<fmt:message key="eventMMDDYYYY" bundle="${resword}"/>: <fmt:message key="date_format" bundle="${resformat}"/>" class="formfieldM" id="enrollmentDateField2" />
                    </td>
                    <td>
                        <A HREF="#" >
    ...
    <tr>
        ...
        <input type="submit" name="addSubject" value="<fmt:message key="add" bundle="${resword}"/>" class="button" />
        &nbsp;
