...
public class ViewNotesServlet extends SecureController {
  ...
  protected void processRequest() throws Exception {
    ...
    table.setSortingIfNotExplicitlySet(2, false);//sort by event date, desc
   ...
   // String[] columns = { "Study Subject ID", "Date Created","Event Date","Event",  "CRF",
   //     "Entity Name", "Entity Value", "Description", "Detailed Notes",
   //     "# of Notes", "Resolution Status","Type", "Entity Type", "Created By", "Actions" };
   
    String[] columns = {resword.getString("study_subject_ID"), resword.getString("date_created"),
        resword.getString("event_date"),resword.getString("event"),resword.getString("CRF"),
        resword.getString("entity_name"),resword.getString("entity_value"),        
        resword.getString("description"), resword.getString("detailed_notes"),ofnotes,    		 
        resword.getString("resolution_status"), resword.getString("type"),
        resword.getString("entity_type"),resword.getString("created_by"),
