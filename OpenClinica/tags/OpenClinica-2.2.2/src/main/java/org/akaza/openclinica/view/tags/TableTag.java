...
public class TableTag extends SimpleTagSupport{
  ...
  public void doTag() throws JspException, IOException {
    ...
    boolean isViewData = ((datacontext != null &&
    datacontext.equalsIgnoreCase(VIEW_DATA_ENTRY)));
    DisplaySectionBean dBean = (DisplaySectionBean) context.
      findAttribute("section");
    StudyBean studyBean = (StudyBean) context.
      findAttribute("study");

    //tabId is used to seed the tabindex attributes of the form's input elements,
    ...
    if(dBean != null ) {
      ...
      if(tabId > 1) formBuilder.setTabindexSeed(tabId);
