		...
		<td class="formlabel"><fmt:message key="date_of_enrollment_for_study" bundle="${resword}"/>' <c:out value="${study.name}" /> ' :</td>
	  	<td valign="top">
            ...
            <div class="formfieldM_BG">
					...
					<td>
					<A HREF="#" 
					onClick="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].enrollmentDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor1" ID="anchor1">
