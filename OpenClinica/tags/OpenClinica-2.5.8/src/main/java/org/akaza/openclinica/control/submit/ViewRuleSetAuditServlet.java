...
import org.akaza.openclinica.dao.rule.RuleSetAuditDAO;
import org.akaza.openclinica.dao.rule.RuleSetRuleAuditDAO;
...
public class ViewRuleSetAuditServlet extends SecureController {
    ...
    private RuleSetAuditDAO getRuleSetAuditDao() {
        ruleSetAuditDao = this.ruleSetAuditDao != null ? ruleSetAuditDao : new RuleSetAuditDAO(sm.getDataSource());
        return ruleSetAuditDao;
    }

    private RuleSetRuleAuditDAO getRuleSetRuleAuditDao() {
        ruleSetRuleAuditDao = this.ruleSetRuleAuditDao != null ? ruleSetRuleAuditDao : new RuleSetRuleAuditDAO(sm.getDataSource());
