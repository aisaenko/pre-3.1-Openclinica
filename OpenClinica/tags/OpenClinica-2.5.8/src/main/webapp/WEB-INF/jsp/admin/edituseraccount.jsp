...
<h1><span class="title_Admin"><fmt:message key="edit_a_user_account" bundle="${resword}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<td colspan="2"> 
         ...
         <c:when test="${displayPwd == 'no'}">            
            <input type="radio" checked name="displayPwd" value="no" disabled="true"><fmt:message key="send_user_password_via_email" bundle="${resword}"/>
            <input type="radio" name="displayPwd" value="yes" disabled="true" ><fmt:message key="show_user_password_to_admin" bundle="${resword}"/>
         </c:when>
         <c:otherwise>
            <input type="radio" name="displayPwd" value="no" disabled="true"><fmt:message key="send_user_password_via_email" bundle="${resword}"/>
            <input type="radio" checked name="displayPwd" value="yes" disabled="true"><fmt:message key="show_user_password_to_admin" bundle="${resword}"/>
