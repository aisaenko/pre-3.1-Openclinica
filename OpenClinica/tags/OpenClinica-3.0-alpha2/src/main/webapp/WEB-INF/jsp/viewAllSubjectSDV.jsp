        ...
        <tr>
            ...
            <td valign="bottom" id="Tab2'">
                <div id="Tab2NotSelected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Event CRF" href='viewAllSubjectSDV?studyId=${studyId}&decorator=mydecorator' onclick="javascript:HighlightTab(2);">View By Event CRF</a></div></div></div></div>
...
<div id="subjectSDV">
    <a href="javascript:void(0)" onclick="if(this.innerHTML.indexOf('Show More') == -1){hideCols('sdv',[1,2,5,6,9,10]);} else {hideCols('sdv',[1,2,5,6,9,10],true);} toggleName(this);">Show More</a>
    <br />
    <form  action="${pageContext.request.contextPath}/pages/viewAllSubjectSDV">
