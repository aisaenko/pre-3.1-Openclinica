            ...
            <div id="Tab0NotSelected" style="display:none">
                <div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a class="tabtext" href="ListStudySubjectsSubmit?${tmpExtendedQuery}&module=${module}" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
                        </c:otherwise>
                    </c:choose>
            ...
            <div id="Tab0Selected" style="display:all">
                <div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a class="tabtext" href="ListStudySubjectsSubmit?${tmpExtendedQuery}" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
                        </c:otherwise>
                    </c:choose>
