...
<input type="submit" name="Submit" value="<fmt:message key="back_to_group_class_list" bundle="${resword}"/>" class="button_long">
<input type="button" onclick="confirmExit('ListSubjectGroupClass');"  name="exit" value="<fmt:message key="exit" bundle="${resword}"/>   " class="button_medium"/>    
</form>
