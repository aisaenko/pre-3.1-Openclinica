                                    ...
                                    <c:otherwise>
                                        <c:choose>
                                            <c:when test="${eventCRFAudit.itemDataTypeId == 11}">
                                                ...
                                                <a href="javascript:openDocWindow('DownloadAttachedFile?eventCRFId=<c:out value="${eventCRFAudit.eventCRFId}"/>&fileName=${fn:replace(path,sep,sep2)}')"><c:out value="${eventCRFAudit.oldValue}"/></a>
                                            </c:when>
