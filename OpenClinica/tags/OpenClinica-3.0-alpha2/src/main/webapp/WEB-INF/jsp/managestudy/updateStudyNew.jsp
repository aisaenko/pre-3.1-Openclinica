...
<a href="javascript:leftnavExpand('sectiona');javascript:setImage('ExpandGroup2','images/bt_Collapse.gif');">
    <img name="ExpandGroup2" src="images/bt_Expand.gif" border="0"> <span class="table_title_Admin">
...
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
    <div class="textbox_center">
        <table border="0" cellpadding="0" cellspacing="0" width="450">
          ...
          <tr valign="top">
              <td class="formlabel"><fmt:message key="purpose" bundle="${resword}"/>:</td>
              <td>
          ...
          <tr valign="top"><td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#PrimaryId" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#PrimaryId'); return false;">
              <fmt:message key="masking" bundle="${resword}"/>:</td><td>
...
<a href="javascript:leftnavExpand('sectionc');javascript:setImage('ExpandGroup4','images/bt_Collapse.gif');"><img
	     name="ExpandGroup4" src="images/bt_Expand.gif" border="0"> <span class="table_title_Admin">
...
<a href="javascript:leftnavExpand('sectiond');javascript:setImage('ExpandGroup5','images/bt_Collapse.gif');"><img
	     name="ExpandGroup5" src="images/bt_Expand.gif" border="0">
...
<br>
 ...
 <a href="javascript:leftnavExpand('sectione');javascript:setImage('ExpandGroup6','images/bt_Collapse.gif');"><img
	     name="ExpandGroup6" src="images/bt_Expand.gif" border="0"> <span class="table_title_Admin">
