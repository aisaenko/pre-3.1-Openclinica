...
<h1><span class="title_extract"><fmt:message key="create_filter" bundle="${resword}"/>: <fmt:message key="specify_parameters" bundle="${resword}"/> <a href="javascript:openDocWindow('help/3_4_createFilter_Help.html#step1')"><img src="images/bt_Help_Extract.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></span></h1>
