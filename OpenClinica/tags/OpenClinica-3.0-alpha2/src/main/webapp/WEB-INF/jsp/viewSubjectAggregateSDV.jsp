    ...
    <table border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td valign="bottom" id="Tab1'">
                ...
                <div id="Tab1Selected" style="display:none"><div class="tab_BG_h"><div class="tab_L_h"><div class="tab_R_h"><span class="tabtext">View By Study Subject Id</span></div></div></div></div></td>

            <td valign="bottom" id="Tab2'">
                <div id="Tab2NotSelected"><div class="tab_BG"><div class="tab_L"><div class="tab_R">
                    <a class="tabtext" title="View By Event CRF" href='viewAllSubjectSDV?studyId=49&decorator=mydecorator' onclick="javascript:HighlightTab(2);">View By Event CRF</a></div></div></div></div>
...
<div id="subjectSDV">
    ...
    {hideCols('sdv',[2]);}
    else {hideCols('sdv',[2],true);} toggleName(this);">Show More</a>
...
<!--        <input type="hidden" name="decorator" value="mydecorator"> -->
    ...
    <script type="text/javascript">hideCols('sdv',[2])</script>
</div>
