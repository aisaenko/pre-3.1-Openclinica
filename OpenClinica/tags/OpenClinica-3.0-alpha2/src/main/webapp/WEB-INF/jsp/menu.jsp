			 ...
			 <c:if test="${userRole.submitData || userRole.monitor}">
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_title"><a href="javascript:openDocWindow('help/4_0_manageStudy_Help.html')"><img width="24" height="15" src="images/bt_Help_Home_gray.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a> <a href="pages/studymodule"><fmt:message key="manage_study" bundle="${resworkflow}"/></a></div><br>
                       ...
                       <c:if test="${study.parentStudyId == 0}">
	                    <div class="homebox_bullets"><a href="ViewRuleAssignment"><fmt:message key="manage_rules" bundle="${resworkflow}"/></a></div><br>
                            ...
                            <div class="homebox_bullets"><a href="pages/viewAllSubjectSDVtmp?studyId=${studyId}"><fmt:message key="manage_sdv" bundle="${resworkflow}"/></a></div><br>
              ...
              <a href="javascript:openDocWindow('help/5_0_administerSystem_Help.html')"><img width="24" height="15" src="images/bt_Help_Home_gray.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a> <a href="AdminSystem"><fmt:message key="business_admin" bundle="${resworkflow}"/></a></div><br>
						...
						<div class="homebox_bullets"><a href="ViewAllJobs"><fmt:message key="administer_jobs" bundle="${resworkflow}"/></a></div><br>
						</div>
		...
		<!-- These DIVs define shaded box borders -->
		 <div style="width: 650px">
			<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<%--BWP 1/29/09 issue <span class="homebox_bullets"><a href="RequestStudy"><fmt:message key="request_study_access" bundle="${resworkflow}"/></a></span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="homebox_bullets"><a href="j_spring_security_logout"><fmt:message key="log_out" bundle="${resword}"/></a></span>
