...
<h1><span class="title_Admin">View Scheduled Import Data Jobs <a href="javascript:openDocWindow('help/5_1_administerUsers_Help.html')"><img src="images/bt_Help_Admin.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></span></h1>
