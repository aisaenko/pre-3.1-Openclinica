    ...
    <td><c:out value="${discrepancyNote.crfName}"/>&nbsp;</td>
       ...
       <tr valign="top">
		...
		<tr valign="top">
			...
			<select name="userAccountId" id="userAccountId" class="formfieldL" disabled> <%-- will eventually take away select, tbh --%>
		...
		<tr valign="top">
            ...
            <td><input name="sendEmail" value="1" type="checkbox" checked/></td>
        </tr>
