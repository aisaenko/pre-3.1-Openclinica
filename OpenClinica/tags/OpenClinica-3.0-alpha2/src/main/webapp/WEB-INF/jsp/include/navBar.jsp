        ...
        <div id="StudyInfo">
            <c:choose>
                <c:when test='${study.parentStudyId > 0}'>
                    <b><a href="${urlPrefix}ViewStudy?id=${study.parentStudyId}&viewFull=yes" ><c:out value="${study.abbreviatedParentStudyName}" /></a>
                    &nbsp;:&nbsp;<a href="${urlPrefix}ViewSite?id=${study.id}"><c:out value="${study.abbreviatedName}" /></a></b>
                </c:when>
                <c:otherwise>
                    <b><a href="${urlPrefix}ViewStudy?id=${study.id}&viewFull=yes" ><c:out value="${study.abbreviatedName}" /></a></b>
                </c:otherwise>
            </c:choose>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <td align="right" style="font-weight: normal;">
                                        ...
                                        <form METHOD="GET" action="${urlPrefix}ListStudySubjects?module=admin" onSubmit=" if (document.forms[0]['findSubjects_f_studySubject.label'].value == 'Study Subject Id) { document.forms[0]['findSubjects_f_studySubject.label'].value=''}">
