...
<h1><span class="title_extract"><fmt:message key="edit_dataset" bundle="${resword}"/>: <c:out value='${dataset.name}'/> <a href="javascript:openDocWindow('help/3_9_editDataset_Help.html')"><img src="images/bt_Help_Extract.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></span></h1>
