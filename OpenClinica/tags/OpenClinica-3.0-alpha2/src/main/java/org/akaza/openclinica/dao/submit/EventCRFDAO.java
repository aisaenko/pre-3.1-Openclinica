...
public class EventCRFDAO extends AuditableEntityDAO {
    ...
    public EntityBean update(EntityBean eb) {
        ...
        variables.put(new Integer(18), new Integer(ecb.getId()));
    ...
    public ArrayList findAllStudySubjectByCRFVersion(int versionId) {
        ...
        this.setTypeExpected(21, TypeNames.STRING);
    ...
    public Integer countEventCRFsByStudy(int studyId) {
    ...
    public ArrayList getEventCRFsByStudy(int studyId,int limit,int offset) {
    ...
    public ArrayList getEventCRFsByStudySubjectLabelLimit(String label,int limit,int offset) {
    ...
    public Integer countEventCRFsByStudySubjectLabel(String label) {
