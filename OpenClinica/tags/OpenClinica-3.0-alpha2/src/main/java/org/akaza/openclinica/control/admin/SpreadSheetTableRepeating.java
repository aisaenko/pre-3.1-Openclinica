                            ...
                            for (String v : variables) {
                                if (!allItems.containsKey(v)) {
                                    ...
                                    if (responseTypeId == 8 && !allItems.get(v).equalsIgnoreCase(group)) {
                                        errors.add(resPageMsg.getString("item") + v + resPageMsg.getString("and_item") + itemName
                                            + resPageMsg.getString("must_have_same_group_label") + resPageMsg.getString("at_row") + " " + k + ", "
                                            + resPageMsg.getString("items_worksheet") + ".");
                                        htmlErrors.put(j + "," + k + ",16", resPageMsg.getString("INVALID_FIELD"));
                                        ...
                                        if (!g.equalsIgnoreCase("ungrouped") && g.equalsIgnoreCase(group)) {
                                            errors.add(resPageMsg.getString("item") + v + resPageMsg.getString("and_item") + itemName
                                                + resPageMsg.getString("should_not_have_same_group_label") + " " + resPageMsg.getString("at_row") + " " + k
                                                + ", " + resPageMsg.getString("items_worksheet") + ".");
                                            htmlErrors.put(j + "," + k + ",16", resPageMsg.getString("INVALID_FIELD"));
                                        }
                                    }
