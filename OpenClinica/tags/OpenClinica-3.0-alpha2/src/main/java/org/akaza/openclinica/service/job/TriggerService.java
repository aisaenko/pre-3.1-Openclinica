...
public class TriggerService {
    ...
    public SimpleTrigger generateTrigger(FormProcessor fp, UserAccountBean userAccount, StudyBean study) {
    ...
    public SimpleTrigger generateImportTrigger(FormProcessor fp, UserAccountBean userAccount, StudyBean study) {
        ...
        return generateImportTrigger(fp, userAccount, study, startDateTime);
    }

    public SimpleTrigger generateImportTrigger(FormProcessor fp, UserAccountBean userAccount, StudyBean study, Date startDateTime) {
