                        ...
                        if (wrapper.getValidationErrors().containsKey(itemOid)) {
                            ...
                            for (int iter = 0; iter < messageList.size(); iter++) {
                                ...
                                DiscrepancyNoteBean parentDn =
                                    createDiscrepancyNote(ibean, message, eventCrfBean, displayItemBean, null, ub, sm.getDataSource(), currentStudy);
                                createDiscrepancyNote(ibean, message, eventCrfBean, displayItemBean, parentDn.getId(), ub, sm.getDataSource(), currentStudy);
