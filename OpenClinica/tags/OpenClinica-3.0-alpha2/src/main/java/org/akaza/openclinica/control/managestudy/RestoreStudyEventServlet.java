...
public class RestoreStudyEventServlet extends SecureController {
    ...
    private void sendEmail(String emailBody) throws Exception {
        ...
        try {
            ...
            // to study director
            em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), respage.getString("restore_event_to_study"), emailBody);

            em = null;
            em = new EmailEngine(EmailEngine.getSMTPHost());
            // to admin
            em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(), respage.getString("restore_event_to_study"), emailBody);
