    ...
    public static String eval(ArrayList<ScoreToken> expression) throws ScoreException {
        ...
        while (info.pos < expression.size()) {
            ...
            // problem.
                ...
                logger.info("weird found , in eval");
                token = new ScoreToken();
        ...
        if (size == 1) {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (isOperator(s)) {
                    ...
                    int scale = BigDecimal.valueOf(second).scale();
                    double first = st.pop();
                    int temp = BigDecimal.valueOf(first).scale();
                    ...
                    try {
                        ...
                        value = BigDecimal.valueOf(value).setScale(scale, BigDecimal.ROUND_HALF_UP).doubleValue();
                    } catch (Exception ee) {
                        ee.printStackTrace();
                        value = Double.NaN;
                    }
