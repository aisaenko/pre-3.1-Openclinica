...
public class ViewSectionDataEntryServlet extends DataEntryServlet {
    ...
    public void processRequest() throws Exception {
        ...
        if (!itemGroups.isEmpty()) {
            hasItemGroup = true;
            /*
             * newDisplayBean = formUtil. createDisplaySectionBWithFormGroups(sectionId,crfVersionId, sm );
             */
        }
        ...
        /*
         * if (hasItemGroup) { // dsb.setDisplayItemGroups(newDisplayBean.getDisplayItemGroups()); request.setAttribute("new_table", true); }
         */
