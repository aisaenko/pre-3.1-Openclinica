...
public class StudyAuditLogTableFactory extends AbstractTableFactory {
    ...
    protected void configureColumns(TableFacade tableFacade, Locale locale) {
        tableFacade.setColumnProperties("studySubject.label", "studySubject.secondarySubjectId", "studySubject.oid", "subject.dateOfBirth",
        ...
        configureColumn(row.getColumn("studySubject.secondarySubjectId"), resword.getString("secondary_subject_ID"), null, null);
        ...
        configureColumn(row.getColumn("actions"), resword.getString("actions"), new ActionsCellEditor(), null, false, false);
    ...
    public void setDataAndLimitVariables(TableFacade tableFacade) {
        ...
        for (StudySubjectBean studySubjectBean : items) {
            ...
            h.put("studySubject.secondarySubjectId", studySubjectBean.getSecondaryLabel());
