...
public class EditSelectedServlet extends SecureController {
    ...
    /*
     * TODO this function exists in four different places... needs to be added
     * to an additional superclass for Submit Data Control Servlets, tbh July
     * 2007
     */
    ...
    public void processRequest() throws Exception {
        ...
        if (selectAll) {
            ...
            Object[] arguments = { CreateDatasetServlet.allSedItemIdsInStudy((HashMap) request.getAttribute("eventlist"), crfdao, idao).size() };
