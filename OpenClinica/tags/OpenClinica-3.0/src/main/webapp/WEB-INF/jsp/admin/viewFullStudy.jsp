...
<br><br>
<a href="javascript:leftnavExpand('overview');javascript:setImage('ExpandGroup1','images/bt_Collapse.gif');">
    <img name="ExpandGroup1" src="images/bt_Expand.gif" border="0"> <span class="table_title_Admin">
...
<a href="javascript:leftnavExpand('sectionf');javascript:setImage('ExpandGroup7','images/bt_Collapse.gif');"><img
	     name="ExpandGroup7" src="images/bt_Expand.gif" border="0"> <span class="table_title_Admin"><fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> F: <fmt:message key="study_parameter_configuration" bundle="${resword}"/>]</span></a>
