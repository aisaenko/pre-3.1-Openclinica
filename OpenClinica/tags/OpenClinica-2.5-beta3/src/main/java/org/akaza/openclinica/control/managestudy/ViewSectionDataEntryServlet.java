...
public class ViewSectionDataEntryServlet extends DataEntryServlet {
    ...
    public void processRequest() throws Exception {
        ...
        if (crfVersionId > 0) {// for viewing blank CRF
            ...
            //System.out.println("event.getSubjectEventStatus()" + event.getSubjectEventStatus().getName());
        ...
        if ("saveNotes".equalsIgnoreCase(action)) {
            ...
            // response.sendRedirect(response.encodeRedirectURL("ViewStudySubject?id=" + studySubjectId));
            return;
        } else {
            ...
            //2808: Signal interviewer.jsp that the containing page is viewSectionData,
