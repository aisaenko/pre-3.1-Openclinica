...
public class DiscrepancyNoteOutputServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        List<DiscrepancyNoteBean> allDiscNotes =
          discNoteUtil.getThreadedDNotesForStudy(studyBean,
          new HashSet<Integer>(),sm.getDataSource(), 0, false);
        ...
        List<DiscrepancyNoteThread> discrepancyNoteThreads =
          discNoteUtil.createThreadsOfParents(allDiscNotes,
        ...
        if("csv".equalsIgnoreCase(format)) {
            ...
            downLoader.downLoadThreadedDiscBeans(discrepancyNoteThreads,
              DownloadDiscrepancyNote.CSV,response.getOutputStream(), null);
        } else {
            /*downLoader.downLoadDiscBeans(allDiscNotes,
            ...
            downLoader.downLoadThreadedDiscBeans(discrepancyNoteThreads,
              DownloadDiscrepancyNote.PDF,response.getOutputStream(), studyIdentifier);
        }
