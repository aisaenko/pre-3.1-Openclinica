...
<script type="text/JavaScript" language="JavaScript">
    ...
    function DisplaySectionTabs() {
        ...
        <c:when test="${studySubject != null && studySubject.id>0}">
            url = "ViewSectionDataEntry?ecId=" + <c:out value="${EventCRFBean.id}"/> + "&crfVersionId=${section.crfVersion.id}&sectionId=" + sectionId + "&tab=" + TabID + "&studySubjectId=${studySubjectId}";
