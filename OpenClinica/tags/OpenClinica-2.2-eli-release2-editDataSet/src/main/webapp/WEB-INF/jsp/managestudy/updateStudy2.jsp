...
<table border="0" cellpadding="0">
 <tr valign="top"><td class="formlabel"><fmt:message key="study_phase" bundle="${resword}"/>:</td><td>
  ...
  <tr valign="top"><td class="formlabel"><fmt:message key="study_system_status" bundle="${resword}"/>:</td><td><div class="formfieldM_BG">
   <%--
  ...
  <td><A HREF="#" onClick="cal1.select(document.forms[0].protocolDateVerification,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].protocolDateVerification,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor1" ID="anchor1"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a> <%--(<fmt:message key="date_format" bundle="${resformat}"/>)--%> *</td></tr>
  ...
  <td><A HREF="#" onClick="cal1.select(document.forms[0].startDate,'anchor2','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].startDate,'anchor2','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor2" ID="anchor2"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a> <%--(<fmt:message key="date_format" bundle="${resformat}"/>)--%> *</td></tr> 
  ...
  <td><A HREF="#" onClick="cal1.select(document.forms[0].endDate,'anchor3',<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" TITLE="cal1.select(document.forms[0].endDate,'anchor3','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" NAME="anchor3" ID="anchor3"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a> <%--(<fmt:message key="date_format" bundle="${resformat}"/>)--%></td></tr> 
