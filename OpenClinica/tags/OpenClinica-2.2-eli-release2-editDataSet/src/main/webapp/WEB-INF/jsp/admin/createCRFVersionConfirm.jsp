...
</c:choose><fmt:message key="check_CRF_version_data" bundle="${resword}"/></span></h1>
...
<p>
<div class="homebox_bullets"><a href="javascript:openDocWindow('ViewCRFVersionPreview?crfId=<c:out value="${version.crfId}"/>')">View CRF Version Metadata</a></div>
<br><br>
<table border="0">
<tr>
  <%-- ViewSectionDataEntry?crfVersionId=<c:out value=
...
"${version.crfId}"/>&name=<c:out value="${version.name}"/>" method="post">
 ...
 <input type="submit" name="submit" value="Continue" class="button_medium"></form></b> </td>
 <td><b><form action="ListCRF" method="post">
 <input type="submit" name="submit" value="Cancel" class="button_medium"></form></b> </td>
  </tr>
  </table>
<br/>
