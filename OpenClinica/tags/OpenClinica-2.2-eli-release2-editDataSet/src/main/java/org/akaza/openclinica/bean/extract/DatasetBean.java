...
public class DatasetBean extends AuditableEntityBean{
	...
	*/
	...
	//how is this different than Start/End?  not adding the two above for now, tbh
...
/*public boolean isShowDiscrepancyInformation() {
	return showDiscrepancyInformation;
}

public void setShowDiscrepancyInformation(boolean showDiscrepancyInformation) {
	this.showDiscrepancyInformation = showDiscrepancyInformation;
}*/
...
FIXME now change all the places where this is located...
