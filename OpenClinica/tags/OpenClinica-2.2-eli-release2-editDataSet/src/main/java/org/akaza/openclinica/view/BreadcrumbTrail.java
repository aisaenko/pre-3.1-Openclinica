	...
	public ArrayList generateTrail(Page jspPage, 
		...
		try {
			...
			if (jspPage.equals(Page.CREATE_DATASET_1)) {
				...
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("create_dataset_instructions"),
								"CreateDataset"+
								this.generateURLString(request),
								Status.PENDING));//0
				trail.add(
						new BreadcrumbBean(resworkflow.getString("select_items_event"),
								"CreateDataset",
								Status.UNAVAILABLE));//1
				trail.add(
						new BreadcrumbBean(resworkflow.getString("define_temporal_scope"),
								"CreateDataset",
				...
				trail.add(
						new BreadcrumbBean(resworkflow.getString("specify_dataset_properties"),
								"CreateDataset",
								Status.UNAVAILABLE));//3
				trail.add(
						new BreadcrumbBean(resworkflow.getString("confirm_dataset_properties"),
								"CreateDataset",
								Status.UNAVAILABLE));//4
				trail.add(
						new BreadcrumbBean(resworkflow.getString("generate_dataset"),
								"CreateDataset",
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("download_data"),
						"ExportDataset"+
						this.generateURLString(request),
						Status.PENDING));
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						...
						Status.AVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("instructions"),
								"CreateFiltersOne"+
								this.generateURLString(request),
								Status.PENDING));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("select_CRF"),
								"#", Status.UNAVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("select_section"),
								"#", Status.UNAVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("select_parameters"),
								"#", Status.UNAVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("specify_criteria"),
								"#", Status.UNAVAILABLE));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("export"),
								"ExportDataset", Status.UNAVAILABLE));
			} 
			else if (jspPage.equals(Page.CREATE_FILTER_SCREEN_3)) {
				trail = advanceTrail(trail, 
						new BreadcrumbBean(resworkflow.getString("select_CRF"), "CreateFiltersTwo"+this.generateURLString(request), 
								Status.PENDING), 2);
				closeRestOfTrail(2);
			}
			else if (jspPage.equals(Page.CREATE_FILTER_SCREEN_3_1)) {
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("select_section"), "CreateFiltersTwo"+this.generateURLString(request), 
						Status.PENDING), 3);
				closeRestOfTrail(3);
			}
			else if (jspPage.equals(Page.CREATE_FILTER_SCREEN_3_2)) {
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("select_parameters"), "CreateFiltersTwo"+this.generateURLString(request), 
						Status.PENDING), 4);
				closeRestOfTrail(4);
			}
			else if (jspPage.equals(Page.CREATE_FILTER_SCREEN_4)) {
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("specify_criteria"), "CreateFiltersTwo"+this.generateURLString(request), 
						Status.PENDING), 5);
				closeRestOfTrail(5);
			}
			/*else if (jspPage.equals(Page.CREATE_FILTER_SCREEN_2)
                ...
                if( request.getAttribute("id") != null){
                  trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), 
                      "ViewStudySubject?id=" + (String)request.getAttribute("id"), Status.AVAILABLE));
                } else {
				trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), 
                    "ViewStudySubject" + this.generateURLString(request), Status.AVAILABLE));
                }
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_study"), "ManageStudy" , Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("manage_subjects"), "ListStudySubject" , Status.AVAILABLE));
				//trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), "ViewStudySubject" + this.generateURLString(request), Status.AVAILABLE));
                if( request.getAttribute("id") != null){
                  trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), 
                      "ViewStudySubject?module=manage&id=" + (String)request.getAttribute("id"), Status.AVAILABLE));
                } else {
                trail.add(new BreadcrumbBean(resworkflow.getString("view_study_subject"), 
                    "ViewStudySubject" + this.generateURLString(request), Status.AVAILABLE));
                }
				...
				if (containsServlet("AddNewSubject")) {
					ordinal = 4;
					trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("study_event_overview"), "EnterDataForStudyEvent" + generateURLString(request), Status.PENDING), ordinal);				
				}
					...
					trail = new ArrayList();
					trail.add(new BreadcrumbBean(resworkflow.getString("submit_data"), "ListStudySubjectsSubmit", Status.AVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("study_event_overview"), "EnterDataForStudyEvent" + generateURLString(request), Status.PENDING));
					trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents", Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry", Status.UNAVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("mark_event_CRF_complete"), "MarkEventCRFComplete", Status.UNAVAILABLE));				
				}
				...
				if (containsServlet("EnterDataForStudyEvent")) {
					...
					trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents" + this.generateURLString(request), Status.PENDING), ordinal);
					closeRestOfTrail(ordinal);
				}
				else {
					ordinal = 1;
					trail = new ArrayList();
					trail.add(new BreadcrumbBean(resworkflow.getString("submit_data"), "ListStudySubjectsSubmit", Status.AVAILABLE));
					trail.add(new BreadcrumbBean(resworkflow.getString("event_CRF_data_submission"), "TableOfContents" + generateURLString(request), Status.PENDING));
					trail.add(new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry", Status.UNAVAILABLE));
				...
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("data_entry"), "InitialDataEntry" + this.generateURLString(request), Status.PENDING), ordinal);
				closeRestOfTrail(ordinal);
			}
			else if (jspPage.equals(Page.DOUBLE_DATA_ENTRY)) {
				int ordinal = trail.size() - 2;
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("data_entry"), "DoubleDataEntry" + this.generateURLString(request), Status.PENDING), ordinal);
				closeRestOfTrail(ordinal);
			}
			else if (jspPage.equals(Page.MARK_EVENT_CRF_COMPLETE)) {
				int ordinal = trail.size() - 1;
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("mark_event_CRF_complete"), "MarkEventCRFComplete" + this.generateURLString(request), Status.PENDING), ordinal);
				closeRestOfTrail(ordinal);
			}
			  ...
			  trail.add(new BreadcrumbBean(resworkflow.getString("create_a_new_CRF"), "CreateCRF", Status.PENDING));
				...
				//trail.add(new BreadcrumbBean(resworkflow.getString("enter_version_name"), "#", Status.PENDING));
				//trail.add(new BreadcrumbBean(resworkflow.getString("check_version"), "#", Status.UNAVAILABLE));
				...
				//trail.add(new BreadcrumbBean(resworkflow.getString("review_new_items"), "#", Status.UNAVAILABLE));
				//trail.add(new BreadcrumbBean(resworkflow.getString("review_SQL_generated"), "#", Status.UNAVAILABLE));

				/* MERGED from the following, may need to update i18n'ed text above:
				 * 
				trail.add(new BreadcrumbBean("Upload Spreadsheet", "#", Status.PENDING));
//				trail.add(new BreadcrumbBean("Check Version", "#", Status.UNAVAILABLE));
				...
				trail.add(new BreadcrumbBean("Review Spreadsheet", "#", Status.UNAVAILABLE));
...
>>>>>>> .r9766*/
				...
				trail = advanceTrail(trail, new BreadcrumbBean(resworkflow.getString("confirm_user_account_details"), "EditUserAccount" + generateURLString(request), Status.PENDING), 3);
			}
			...
			//breadcrumb trail:
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("edit_dataset_items_attributes"),
						"#",
						Status.PENDING));
				trail.add(
						new BreadcrumbBean(resworkflow.getString("define_temporal_scope"),
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("edit_filter"),
						"#",
						Status.PENDING));
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("view_dataset_details"),
						"#",
						Status.PENDING));
			}
			else if (jspPage.equals(Page.EXTRACT_DATASETS_MAIN)) {
				trail = new ArrayList();
				trail.add(new BreadcrumbBean(resworkflow.getString("home"),
						"MainMenu",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("view_dataset"),
						"#",
						Status.PENDING));
			}
				...
				trail.add(new BreadcrumbBean(resworkflow.getString("extract_datasets"),
						"ExtractDatasetsMain",
						Status.AVAILABLE));
				trail.add(new BreadcrumbBean(resworkflow.getString("view_filters"),
						"#",
						Status.PENDING));
			}
//		else {
