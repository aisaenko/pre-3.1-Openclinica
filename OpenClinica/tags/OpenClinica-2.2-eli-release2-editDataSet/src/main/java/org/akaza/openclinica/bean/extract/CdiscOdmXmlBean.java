 ...
 *    one MetaDataVersion in one file. </p>
 * <p>The generated data file is ready for PROC CDISC to create a SAS data set.</p> 
 * <p>For this class to work properly, another data type (an addition row) is added
 *	  as "text/plain" in the table export_format</p>
 * 
 */
...
public class CdiscOdmXmlBean {
  ...
  public void createCdiscOdmXML(ExtractBean eb){
	  ...
	  root_line += "ODMVersion=\"1.2\" " +
	  			"FileOID=\"" + eb.getDataset().getId() + "D" + (new SimpleDateFormat("yyyyMMddHHmmss")).format(creationDateTime) + "\" " +
