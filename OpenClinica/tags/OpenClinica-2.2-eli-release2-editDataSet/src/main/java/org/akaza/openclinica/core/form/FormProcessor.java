...
public class FormProcessor {
	...
	/**
	 * Return datetime value. If no input for "Hour" and "Minute" and "am/pm", default time will be 12:00pm.
	 * In another word, 
	 * <p>Precondition:Before calling this method, it should make sure that field has been entered valid 
	 * datetime data.
	 *
	 * @param prefix
	 * @return
...
//		presetValues.put(fieldName, fieldValue);
	...
	/**
	 * Return a String which cancatenates inputed "Date", "Hour", "Minute" and "am/pm" if applicable. 
	 * Empty string will be returned if none of them has been entered.
	 * 
	 * @param prefix
	 * @return
	 */
	...
	/**
	 * A time value consists of three html input fields: Hour, Minute, am/pm. 
	 * Return true if all of three fields have valid data
	 * <br><br>
	 * Precondition: data type validation of those three fields has been done.
	 * 
	 * @param prefix
	 * @return
	 */
