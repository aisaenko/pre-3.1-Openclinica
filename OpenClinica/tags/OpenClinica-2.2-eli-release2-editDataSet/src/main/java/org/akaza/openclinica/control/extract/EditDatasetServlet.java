...
public class EditDatasetServlet extends SecureController {
  ...
  public DatasetBean initializeAttributes(DatasetBean db) {
      ...
      session.setAttribute("allItems", (ArrayList<ItemBean>)db.getItemDefCrf().clone());
      session.setAttribute("allSelectedItems", (ArrayList<ItemBean>)db.getItemDefCrf().clone());
