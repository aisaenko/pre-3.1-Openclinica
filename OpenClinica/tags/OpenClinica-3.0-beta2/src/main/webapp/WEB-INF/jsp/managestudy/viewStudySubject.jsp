...
<a href="javascript:leftnavExpand('studySubjectRecord');javascript:setImage('ExpandGroup1','images/bt_Expand.gif');"><img
  name="ExpandGroup1" src="images/bt_Collapse.gif" border="0"> Study Subject Record</a></div>
			...
			<!-- Table Contents -->
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tbody><tr>
							...
							<td class="table_header_row"><fmt:message key="person_ID" bundle="${resword}"/></td>
