...
public class SDVUtil {
    ...
    */
    ...
    public String renderEventCRFTableWithLimit(HttpServletRequest request, int studyId, String pathPrefix) {
        ...
        tableFacade.setColumnProperties("sdvStatus", "studySubjectId", "studyIdentifier", "personId", "secondaryId", "eventName", "eventDate",
        ...
        turnOffSorts(tableFacade, new String[] { "sdvStatus", "studySubjectId", "studyIdentifier", "personId", "secondaryId", "eventName", "eventDate",
            "enrollmentDate", "studySubjectStatus", "crfNameVersion", "sdvRequirementDefinition", "crfStatus", "lastUpdatedDate", "lastUpdatedBy",
            "studyEventStatus", "sdvStatusActions" });
    ...
    public String renderSubjectsTableWithLimit(HttpServletRequest request, int studyId, int studySubjectId) {
        ...
        String[] allColumns =
            new String[] { "studySubjectId", "studyIdentifier", "personId", "secondaryId", "eventName", "eventDate", "enrollmentDate", "studySubjectStatus",
                "crfNameVersion", "sdvRequirementDefinition", "crfStatus", "lastUpdatedDate", "lastUpdatedBy", "studyEventStatus", "sdvStatusActions" };
    ...
    */
    public Collection<SubjectSDVContainer> getSubjectRows(List<EventCRFBean> eventCRFBeans, HttpServletRequest request) {
        ...
        for (EventCRFBean crfBean : eventCRFBeans) {
            ...
            //SubjectEventStatus.getSubjectEventStatusName(studyEventBean.getSubjectEventStatus().getId())
            // getCRFStatusIconPath(studyEventBean.getSubjectEventStatus().getId())
            if (crfBean.getStatus() != null) {
                tempSDVBean.setCrfStatus(getCRFStatusIconPath(studyEventBean.getSubjectEventStatus().getId(), request, studySubjectBean.getId(), crfBean
                        .getId(), crfBean.getCRFVersionId()));
            }
        ...
        for (Integer studySubjectId : studySubjectIds) {
            ...
            for (EventCRFBean eventCRFBean : eventCrfs) {
                ...
                EventDefinitionCRFBean eventDefinitionCrf =
                    eventDefinitionCrfDAO.findByStudyEventDefinitionIdAndCRFIdAndStudyId(studyEvent.getStudyEventDefinitionId(), crfBean.getId(), studySubject
                            .getStudyId());
                if (eventDefinitionCrf.getId() == 0) {
                    eventDefinitionCrf =
                        eventDefinitionCrfDAO.findForStudyByStudyEventDefinitionIdAndCRFId(studyEvent.getStudyEventDefinitionId(), crfBean.getId());
                }
    ...
    public List<EventCRFBean> filterEventCRFs(List<EventCRFBean> eventCRFBeans, BindingResult bindingResult) {
        ...
        StudySubjectDAO studySubjectDAO = new StudySubjectDAO(dataSource);
        StudyEventDAO studyEventDAO = new StudyEventDAO(dataSource);
        boolean studySub = true, studyEventDef = true, studyEventStatus = true, eventCRFStatusBool = true, eventcrfSDVStatus = true, eventCRFNameBool = true, upDatedDateBool =
            true, sdvRequirementBool = true;
