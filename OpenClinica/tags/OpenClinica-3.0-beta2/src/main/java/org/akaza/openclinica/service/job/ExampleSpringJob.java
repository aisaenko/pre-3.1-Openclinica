        ...
        try {
            ...
            if (dsId > 0) {
                ...
                if ("1".equals(tab)) {
                    ...
                    mf.applyPattern(pageMessages.getString("you_can_access_tab_delimited"));
                ...
                if ("1".equals(cdisc)) {
                    ...
                    MessageFormat mf = new MessageFormat("");
                    mf.applyPattern(pageMessages.getString("you_can_access_odm_12"));
                    Object[] arguments = { getFileIdInt(fileName) };
                    auditMessage.append(mf.format(arguments));
                ...
                if ("1".equals(cdisc12)) {
                    ...
                    MessageFormat mf = new MessageFormat("");
                    mf.applyPattern(pageMessages.getString("you_can_access_odm_12_xml"));
                    Object[] arguments = { getFileIdInt(fileName) };
                    auditMessage.append(mf.format(arguments));
                    // auditMessage.append(
                ...
                if ("1".equals(cdisc13)) {
                    ...
                    MessageFormat mf = new MessageFormat("");
                    mf.applyPattern(pageMessages.getString("you_can_access_odm_13"));
                    Object[] arguments = { getFileIdInt(fileName) };
                    auditMessage.append(mf.format(arguments));
                ...
                if ("1".equals(cdisc13oc)) {
                    ...
                    MessageFormat mf = new MessageFormat("");
                    mf.applyPattern(pageMessages.getString("you_can_access_odm_13_xml"));
                    Object[] arguments = { getFileIdInt(fileName) };
                    auditMessage.append(mf.format(arguments));
                ...
                if ("1".equals(spss)) {
                    ...
                    MessageFormat mf = new MessageFormat("");
                    mf.applyPattern(pageMessages.getString("you_can_access_spss"));
                    Object[] arguments = { getFileIdInt(fileName) };
                    auditMessage.append(mf.format(arguments));
