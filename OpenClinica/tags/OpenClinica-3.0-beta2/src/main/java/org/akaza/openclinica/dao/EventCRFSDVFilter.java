...
public class EventCRFSDVFilter implements CriteriaCommand {
    ...
    public EventCRFSDVFilter(Integer studyId) {
        ...
        columnMapping.put("crfStatus", "se.subject_event_status_id");
        ...
        if (value != null) {
            if (property.equals("sdvStatus")) {
                if (value.equals("complete")) {
                    ...
                    criteria = criteria + " " + columnMapping.get(property) + " = true ";
                } else {
                    criteria = criteria + " and ";
                    criteria = criteria + " " + columnMapping.get(property) + " = false ";
                }
                ...
                if (value.equals("Completed")) {
                    criteria = criteria + " and ";
                    criteria = criteria + " " + columnMapping.get(property) + " = 4 ";
                } else {
                    criteria = criteria + " and ";
                    criteria = criteria + " " + columnMapping.get(property) + " = 7 ";
                }
            } else {
                criteria = criteria + " and ";
