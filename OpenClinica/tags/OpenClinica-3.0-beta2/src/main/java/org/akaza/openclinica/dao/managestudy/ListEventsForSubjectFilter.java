...
public class ListEventsForSubjectFilter implements CriteriaCommand {
    ...
    private String buildCriteria(String criteria, String property, Object value) {
        if (value != null) {
            if (property.equals("status")) {
                ...
                if (!value.equals("1")) { // crf data entry stages other than DataEntryStage.UNCOMPLETED
    ...
    private int getStatusForStage(int stage) {
        ...
        if ((stage == 3) || (stage == 4)) // DataEntryStage.INITIAL_DATA_ENTRY_COMPLETE / DataEntryStage.DOUBLE_DATA_ENTRY
        {
            status = 4;
        }
