...
public class ListDiscNotesSubjectTableToolbar extends DefaultToolbar {
    ...
    private class ListNotesItem extends AbstractItem {
        ...
        public String enabled() {
            ...
            html.quote().close();
            html.img().name("bt_View1").src("images/bt_Reassign.gif").border("0").alt(resword.getString("List_of_Notes_Discrepancies")).title(
                    resword.getString("List_of_Notes_Discrepancies")).append("class=\"listAllDNotes\" width=\"24 \" height=\"15\" align=\"left\"").end().aEnd();
