...
public class ListStudySubjectTableFactory extends AbstractTableFactory {
    ...
    protected void configureColumns(TableFacade tableFacade, Locale locale) {
        ...
        ++index;
        configureColumn(row.getColumn(columnNames[index]), resword.getString("gender"), null, null);
        ++index;
        configureColumn(row.getColumn(columnNames[index]), resword.getString("secondary_label"), null, null);
        ++index;
        // group class columns
