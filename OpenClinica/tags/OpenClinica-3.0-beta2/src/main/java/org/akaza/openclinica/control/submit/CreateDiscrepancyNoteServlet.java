            ...
            if (errors.isEmpty()) {
                ...
                if (!writeToDB) {
                    ...
                    if (note.getEntityId() == 0) {
                        ...
                        System.out.println("forwarding on line 522");
                    ...
                    if ((note.getAssignedUserId() > 0) && ("1".equals(email.trim())) && (DiscrepancyNoteType.QUERY.getId() == note.getDiscrepancyNoteTypeId())) {
                         ...
                         * 
                         * 
                         * Please select the link below to view the
                         * information provided. You may need to login to
                         * OpenClinica_testbed with your user name and
                         * password after selecting the link. If you receive
                         * a page cannot be displayed message, please make
                         * sure to select the Change Study/Site link in the
                         * upper right table of the page, select the study
