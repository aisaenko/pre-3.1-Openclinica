...
<fmt:message key="create_a_new_CRF_version" bundle="${resword}"/> - <fmt:message key="version_already_exits" bundle="${resword}"/> </span></h1>  
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"> 
  ...
  <tr valign="top">        
      ...
      <td class="table_cell"><fmt:formatDate value="${def.createdDate}" dateStyle="short"/></td>
