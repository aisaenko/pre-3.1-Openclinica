...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr><td class="table_header_column"><fmt:message key="date_created" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${user.createdDate}" type="date" pattern="${dateFormatPattern}"/></td></tr>
  ...
  <tr><td class="table_header_column"><fmt:message key="date_updated" bundle="${resword}"/>:</td><td class="table_cell"><fmt:formatDate value="${user.updatedDate}" type="date" pattern="${dateFormatPattern}"/>&nbsp;</td></tr>
  ...
  <tr><td class="table_header_column"><fmt:message key="role" bundle="${resword}"/>:</td><td class="table_cell"><c:out value="${uRole.role.name}"/></td></tr>
