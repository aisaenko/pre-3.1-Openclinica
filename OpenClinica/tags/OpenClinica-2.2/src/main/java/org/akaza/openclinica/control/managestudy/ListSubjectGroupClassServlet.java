...
public class ListSubjectGroupClassServlet  extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if(parentStudyId > 0) {
    	...
    	groups = (ArrayList)sgcdao.findAllByStudy(parentStudy);
    } else {
    	groups = (ArrayList)sgcdao.findAllByStudy(currentStudy);
    }
    //YW >>
    ...
    String[] columns = {resword.getString("subject_group_class"), resword.getString("type"), resword.getString("subject_assignment"),
    		resword.getString("study_name"), resword.getString("subject_groups"), resword.getString("status"), resword.getString("actions")};
