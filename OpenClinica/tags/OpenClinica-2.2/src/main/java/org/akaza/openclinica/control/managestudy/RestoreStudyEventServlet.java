...
public class RestoreStudyEventServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if (studyEventId == 0) {
      ...
      //YW 11-07-2007, a study event could not be restored if its study subject has been removed
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), respage.getString("restore_event_to_study"),
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
    		  respage.getString("restore_event_to_study"), emailBody);
