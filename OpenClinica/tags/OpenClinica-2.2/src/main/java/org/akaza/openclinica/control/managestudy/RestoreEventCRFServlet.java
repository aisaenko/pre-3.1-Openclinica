...
public class RestoreEventCRFServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if (eventCRFId == 0) {
      ...
      //YW 11-07-2007, an event CRF could not be restored if its study subject has been removed
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        ...
        String emailBody = respage.getString("the_event_CRF") + cb.getName() + " " + respage.getString("has_been_restored_to_the_event")+
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), respage.getString("restore_event_CRF_to_event"),
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
    		  respage.getString("restore_event_CRF_to_event"), emailBody);
