...
//	}
  ...
  public void setMetadata(ItemFormMetadataBean metadata) {
    ...
    //BWP 09/18/07 >> rsb cannot be null here because I added this line to ItemFormMetadataBean's
  ...
  public void loadFormValue(String value) {
    ...
    //System.out.println("loadFormValue, line 241, DisplayItemBean "+rsb.getResponseType().getName());
    metadata.setResponseSet(rsb);
