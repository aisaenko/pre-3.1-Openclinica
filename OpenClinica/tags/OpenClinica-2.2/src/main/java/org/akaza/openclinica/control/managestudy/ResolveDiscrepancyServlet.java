...
public class ResolveDiscrepancyServlet extends SecureController {
	...
	protected void processRequest() throws Exception {
		...
		if (noteIsClosed(note)) {
			throw new InconsistentStateException(Page.VIEW_DISCREPANCY_NOTES_IN_STUDY_SERVLET, resexception.getString("the_discrepancy_choose_has_been_closed_resolved_create_new"));
		}
