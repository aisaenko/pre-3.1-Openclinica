...
import org.akaza.openclinica.bean.admin.ListCRFRow;
...
public class ListCRFServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    String[] columns = { resword.getString("CRF_name"), resword.getString("date_updated"),
    					resword.getString("last_updated_by"), resword.getString("versions"),
    					resword.getString("date_created"),resword.getString("owner"), 
    					resword.getString("status"), resword.getString("download"), 
	...
	table.addLink("Blank CRF Template", "DownloadVersionSpreadSheet?template=1");
	//YW << add "Enterprise CRF Catalog" link 
	String crfCatalogField = "crfCatalog";
	table.addLink("Enterprise CRF Catalog", SQLInitServlet.getEnterpriseField(crfCatalogField));
	//YW >>
//TODO add i18n links to the above, tbh
	table.addLink(resword.getString("create_a_new_CRF"), "CreateCRF?module=" + module);
