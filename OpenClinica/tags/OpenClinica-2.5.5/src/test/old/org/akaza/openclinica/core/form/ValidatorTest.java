...
public class ValidatorTest extends DAOTestBase {
     ...
     * "event_definition_crf_dao.xml"));
     *
     *
     * try { digester.run(); } catch (SAXException saxe) {
     * saxe.printStackTrace(); }
     *
     * super.ds = setupNewNewPostgresDataSource(); //super.ds =
     * setupOraDataSource(); //super.ds = setupDataSource(); sdao = new
     * EventDefinitionCRFDAO(super.ds, digester); }
     */
