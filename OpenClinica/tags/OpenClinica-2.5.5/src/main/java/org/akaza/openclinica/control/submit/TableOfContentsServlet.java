...
public class TableOfContentsServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        if (!allowEnterData) {
            ...
            /* BWP 2966 >> the original Page.INTERVIEWER jsp is not a complete web page and
            * did not provide a body tag for producing a popup window for discrepancy notes. So I
            * changed it to create a complete web page. */
