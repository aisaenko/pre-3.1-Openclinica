...
<fmt:message key="manage_all_discrepancy_notes_in" bundle="${restext}"/> <c:out value="${study.name}"/> 
    <c:choose>
        <c:when test="${module eq 'manage'}">
            <a href="javascript:openDocWindow('help/4_8_discrepancyNotes_Help.html')">
        ...
        <c:otherwise>
            <a href="javascript:openDocWindow('help/2_5_discrepancyNotes_Help.html')">
            <img src="images/bt_Help_Submit.gif" border="0" alt="<fmt:message key="help" bundle="${restext}"/>" title="<fmt:message key="help" bundle="${restext}"/>">
            </a>
        </c:otherwise>
    </c:choose>
</span></h1>
...
<div><a id="sumBoxParent" href="javascript:void(0)" onclick="showSummaryBox(document.getElementById('sumBox'),document.getElementById('sumBoxParent'),'<fmt:message key="show_summary_statistics" bundle="${resword}"/>','<fmt:message key="hide_summary_statistics" bundle="${resword}"/>')"><fmt:message key="show_summary_statistics" bundle="${resword}"/></a> </div>
            ...
            <td style="padding-left: 12px" valign="bottom">
                <div id="Tab0NotSelected" style="display:none">
                    <div class="tab_BG"><div class="tab_L"><div class="tab_R">
                        ...
                        <a class="tabtext" href="ListDiscNotesSubjectServlet?module=${module}&defId=${eventDefinitionId}&type=${param.type}&resolutionStatus=${param.resolutionStatus}" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
