    ...
    protected void processRequest() throws Exception {
        ...
        if(! (allDiscNotes == null || allDiscNotes.isEmpty())) {
            ...
            for (int i = 0; i < subjects.size(); i++) {
                ...
                //BWP 3197 fetch the site name from the study subject's study ID >>
                    StudyBean site = (StudyBean) studyDAO.findByPK(studySub.getStudyId());
                    if(site != null) {
                        dssb.setSiteName(site.getIdentifier());
                    }
