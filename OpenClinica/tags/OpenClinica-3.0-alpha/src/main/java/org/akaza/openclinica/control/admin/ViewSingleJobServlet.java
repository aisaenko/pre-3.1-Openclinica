...
public class ViewSingleJobServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        Trigger trigger = scheduler.getTrigger(triggerName.trim(), TRIGGER_GROUP);
        ...
        System.out.println("found trigger on the other side, full name: " + trigger.getFullName());
        ...
        try {
            ...
            if (trigger.getJobDataMap().size() > 0) {
                ...
                table.setQuery("ViewSingleJob?tname=" + triggerName, new HashMap());
