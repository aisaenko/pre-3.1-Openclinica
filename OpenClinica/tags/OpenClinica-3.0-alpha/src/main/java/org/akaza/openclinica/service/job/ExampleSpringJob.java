...
public class ExampleSpringJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            // see jobs in another screen but all properties have to be strings
            // i love quartz not working. tbh
            System.out.println("-- found the job: " + dsId + " dataset id");
            ...
            if (dsId > 0) {
                ...
                System.out.println("active study: " + userBean.getActiveStudyId() + " parent study: " + activeStudy.getParentStudyId());
                ...
                System.out.println("-- found extract bean ");
                ...
                if ("1".equals(tab)) {
                    ...
                    System.out.println("-- gen tab file 01");
                ...
                if ("1".equals(cdisc)) {
                    ...
                    System.out.println("-- gen odm file");
                    message.append("<p>" + pageMessages.getString("html_email_body_4") + " " + getFileNameStr(fileName)
                        + pageMessages.getString("html_email_body_4_5") + SQLInitServlet.getField("sysURL.base") + "AccessFile?fileId="
                        + getFileIdInt(fileName) + pageMessages.getString("html_email_body_3") + "</p>");
                ...
                if ("1".equals(spss)) {
                    ...
                    System.out.println("-- gen spss file");
                    message.append("<p>" + pageMessages.getString("html_email_body_4") + " " + getFileNameStr(fileName)
                        + pageMessages.getString("html_email_body_4_5") + SQLInitServlet.getField("sysURL.base") + "AccessFile?fileId="
                        + getFileIdInt(fileName) + pageMessages.getString("html_email_body_3") + "</p>");
                ...
                // System.out.println("-- made it here for some reason, ds id: "
                // + dsId);
            }

            // System.out.println("-- generated file: " + fileNameStr);
            // dataSource.
        } catch (Exception e) {
