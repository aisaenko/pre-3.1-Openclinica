...
public class StringUtil {
    /*
    A utility method for escaping apostrophes in Strings. "My'String" becomes "My\'String". This could
    be used for example to escape a String for insertion into a postgresql varchar field.
     */
    public static String escapeSingleQuote(String escapeSource){
        ...
        //We have to use four backslashes in a row here to properly reproduce \' from
        //a single apostrophe
