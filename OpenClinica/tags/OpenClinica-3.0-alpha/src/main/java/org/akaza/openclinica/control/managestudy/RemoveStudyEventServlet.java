...
public class RemoveStudyEventServlet extends SecureController {
    ...
    private void sendEmail(String emailBody) throws Exception {
        ...
        try {
            ...
            // to study director
            em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), respage.getString("remove_event_from_study"), emailBody);

            em = null;
            em = new EmailEngine(EmailEngine.getSMTPHost());
            // to admin
            em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(), respage.getString("remove_event_from_study"), emailBody);
