...
public class ViewJobServlet extends SecureController {
    ...
    protected void processRequest() throws Exception {
        ...
        for (int i = 0; i < triggerNames.length; i++) {
            Trigger trigger = scheduler.getTrigger(triggerNames[i], "DEFAULT");
            ...
            if (scheduler.getTriggerState(triggerNames[i], "DEFAULT") == Trigger.STATE_PAUSED) {
        ...
        String[] columns = { "Name", "Previous Fire Time", "Next Fire Time", "Description", "Period To Run", "Dataset", resword.getString("actions") };
