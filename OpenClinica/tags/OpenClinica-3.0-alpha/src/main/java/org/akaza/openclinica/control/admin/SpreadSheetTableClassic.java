                ...
                if (sheetName.equalsIgnoreCase("Items")) {
                    ...
                    for (int k = 1; k < numRows; k++) {
                        ...
                        if (StringUtil.isBlank(responseLabel)) {
                            ...
                            errors.add(resPageMsg.getString("the") + " " + resPageMsg.getString("RESPONSE_LABEL_column") + " "+ resPageMsg.getString("should_be_file") + resPageMsg.getString("at_row") + " "
                        ...
                        if (StringUtil.isBlank(dataType)) {
                            ...
                            if (!ItemDataType.findByName(dataType.toLowerCase())) {
                                ...
                                if ("file".equalsIgnoreCase(responseType) && !"FILE".equalsIgnoreCase(dataType)) {
                                    errors.add(resPageMsg.getString("the") + " " + resPageMsg.getString("DATA_TYPE_column") + " " + resPageMsg.getString("should_be_file")+ resPageMsg.getString("at_row")
                                        + " " + k + ", " + resPageMsg.getString("items_worksheet") + ".");
