 ...
 *         TODO
 *         <P>
 *         add functions for admin use cases such as assign user to study,
 *         remove user from study, etc.
 *         <P>
...
public class UserAccountDAO extends AuditableEntityDAO {
    ...
    public void delete(UserAccountBean u) {
        ...
        /*
         * this.execute(digester.getQuery("deleteStudyUserRolesByUserID"),
         * variables);
         */
     ...
     * 
     * @see
     * org.akaza.openclinica.dao.core.DAOInterface#findAll(java.lang.String,
