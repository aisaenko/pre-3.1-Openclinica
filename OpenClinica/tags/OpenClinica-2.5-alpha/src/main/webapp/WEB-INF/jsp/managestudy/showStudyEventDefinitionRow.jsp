...
<tr valign="top">     
      ...
      <td class="table_cell"><fmt:formatDate value="${currRow.bean.updatedDate}" dateStyle="short"/><br>(<c:out value="${currRow.bean.updater.name}"/>)</td>
      <td class="table_cell" style="display: none" id="Groups_0_7_<c:out value="${eblRowCount+1}"/>">
      ...
      <td class="table_cell" style="display: none" id="Groups_0_8_<c:out value="${eblRowCount+1}"/>">
        <c:forEach var="entry" items="${currRow.bean.crfsWithDefaultVersion}" varStatus="status">
