...
<h1><fmt:message key="change_your_current_study" bundle="${restext}"/> <a href="javascript:openDocWindow('help/1_3_changeStudy_Help.html')"><img src="images/bt_Help.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></h1>
...
<p><fmt:message key="please_choose_study_list" bundle="${restext}"/>:</P>
  ...
  <br>
  <p><input type="submit" name="Submit" value="<fmt:message key="change_study" bundle="${resword}"/>" class="button_long"></p>
