...
<table border="0" cellpadding="0" cellspacing="0" class="header"><img src="images/Logo.gif">="top">
						 ...
						 <c:set var="roleName" value="${userRole.role.name}"/>
                           ...
                           <c:if test="${userRole.submitData}">
							...
							<td><a href="AdminSystem"
							   ...
							   name="nav_BizAdmin" src="images/<fmt:message key="image_dir" bundle="${resformat}"/>/nav_BizAdmin.gif" border="0" alt="<fmt:message key="business_admin" bundle="${resworkflow}"/>" title="<fmt:message key="business_admin" bundle="${resworkflow}"/>"></a>
							 </td>
							</c:if>
