						...
						<tr>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td><a href="ViewNotes?resolutionStatus=open"
									   onMouseOver="javascript:setImage('subnav_Manage_Discrepancies','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_Discrepancies_h.gif');"
									   onMouseOut="javascript:setImage('subnav_Manage_Discrepancies','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_Discrepancies.gif');"><img 
									   name="subnav_Manage_Discrepancies" src="images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_Discrepancies.gif" border="0" alt="<fmt:message key="discrepancies" bundle="${resworkflow}"/>" title="<fmt:message key="discrepancies" bundle="${resworkflow}"/>"></a></td>	
									<td><a href="ImportRule"
									   onMouseOver="javascript:setImage('subnav_Manage_ImportRule','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ImportRule_h.gif');"
									   onMouseOut="javascript:setImage('subnav_Manage_ImportRule','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ImportRule.gif');"><img
									   name="subnav_Manage_ImportRule" src="images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ImportRule.gif" border="0" alt="<fmt:message key="import_rule" bundle="${resworkflow}"/>" title="<fmt:message key="import_rule" bundle="${resworkflow}"/>"></a></td>
								</tr>
							</table>
							</td>
						</tr>
