...
<h1><span class="title_Admin"><fmt:message key="create_a_user_account" bundle="${resword}"/></span></h1>
    ...
    <tr valign="top">
	  <td class="formlabel"><fmt:message key="user_password_generated" bundle="${resword}"/>:</td>
         ...
         <c:when test="${displayPwd == 'no'}">
            <input type="radio" checked name="displayPwd" value="no"><fmt:message key="send_user_password_via_email" bundle="${resword}"/>
            <br><input type="radio" name="displayPwd" value="yes"><fmt:message key="show_user_password_to_admin" bundle="${resword}"/>
         </c:when>
         <c:otherwise>
            <input type="radio" name="displayPwd" value="no"><fmt:message key="send_user_password_via_email" bundle="${resword}"/>
            <br><input type="radio" checked name="displayPwd" value="yes"><fmt:message key="show_user_password_to_admin" bundle="${resword}"/>
         </c:otherwise>
       </c:choose>
      </td>
	</tr>
