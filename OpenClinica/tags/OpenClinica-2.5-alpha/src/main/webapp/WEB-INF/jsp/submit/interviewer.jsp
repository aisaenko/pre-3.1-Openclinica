...
<div class="tablebox_center">
 ...
 <td class="table_header_row_left" style="color: #789EC5"><font color="#CC0000"><c:out value="${openNum}"/> <fmt:message key="open" bundle="${resword}"/></font>, <font color="#D4A718"><c:out value="${updatedNum}"/> <fmt:message key="updated" bundle="${resword}"/></font>, <font color="#7CB98F"><c:out value="${closedNum}"/> <fmt:message key="closed" bundle="${resword}"/></font></td>
...
<tr>
    ...
    <td class="table_cell_noborder" style="color: #789EC5">
        <c:out value="${maximumSampleOrdinal}" />
      </td>
    <td class="table_cell_top" style="color: #789EC5">
      ...
      <td valign="top" nowrap>
        <c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
          <a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?id=<c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=interviewer&column=interviewer_name','spanAlert-interviewer'); return false;">
            <img name="flag_interviewer" src="images/icon_noNote.gif" border="0" alt="<fmt:message key="discrepancy_note" bundle="${resword}"/>" title="<fmt:message key="discrepancy_note" bundle="${resword}"/>">
          </a>
        </c:if>
      </td>
    </tr>
  ...
  <table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td valign="top" nowrap><a href="#" onClick=
        "cal1.select(document.forms[0].interviewDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" title="cal1.select(document.forms[0].interviewDate,'anchor1','<fmt:message key="date_format_string" bundle="${resformat}"/>'); return false;" name="anchor1" id="anchor1"><img src="images/bt_Calendar.gif" alt="<fmt:message key="show_calendar" bundle="${resword}"/>" title="<fmt:message key="show_calendar" bundle="${resword}"/>" border="0" /></a>
        <c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
          <a href="#" onClick="openDNoteWindow('CreateDiscrepancyNote?id=<c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=interviewDate&column=date_interviewed','spanAlert-interviewDate'); return false;">
            <img name="flag_interviewDate" src="images/icon_noNote.gif" border="0" alt="<fmt:message key="discrepancy_note" bundle="${resword}"/>" title="<fmt:message key="discrepancy_note" bundle="${resword}"/>" ></a>
        </c:if>
      </td>
    </tr>
    <tr>
