...
public class ViewSectionDataEntryPreview extends DataEntryServlet {
    ...
    public void processRequest() throws Exception {
        ...
        if (sectionsMap != null) {
            for (Iterator iter = sectionsMap.entrySet().iterator(); iter.hasNext();) {
        ...
        DisplaySectionBean displaySection = beanFactory.createDisplaySectionBean(itemsMap, sectionTitle, secLabel, secSubtitle, instructions, crfName);
