...
public class HorizontalFormBuilder extends DefaultFormBuilder {
    ...
    public String createMarkup() {
        ...
        for (DisplayItemGroupBean displayItemGroup : this.displayItemGroups) {
            ...
            List<Element> thTags =
                repeatFlag ? createTheadContentsFromDisplayItems(currentDisplayItems, true) : createTheadContentsFromDisplayItems(currentDisplayItems, false);
            ...
            if (hasStoredRepeatedRows) {
                List<Element> storedRepeatedRows =
                    builderUtil.generatePersistentMatrixRows(ordinalItemDataMap, currentDisplayItems, tabindex, repeatParentId, hasDiscrepancyMgt, false);
