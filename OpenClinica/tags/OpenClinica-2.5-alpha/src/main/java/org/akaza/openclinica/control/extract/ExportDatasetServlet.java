        ...
        if (StringUtil.isBlank(action)) {
            ...
            while (fileIterator.hasNext()) {
                ...
                if (new File(asdfBean.getFileReference()).isFile()) {
                    // logger.warning(asdfBean.getFileReference()+" is a
                    // file!");
            ...
            if ("sas".equalsIgnoreCase(action)) {
                ...
                // "C:/work/ODM1-2-1/ODM1-2-1-foundation.xsd";
                // String schemaLocation =
                // "http://www.cdisc.org/models/odm/v1.2.1/ODM1-2-1.xsd";
            ...
            if ("spss".equalsIgnoreCase(action)) {
                ...
                for (int i = 0; i < items.size(); i++) {
                    ...
                    // System.out.println("crf versionname" +
