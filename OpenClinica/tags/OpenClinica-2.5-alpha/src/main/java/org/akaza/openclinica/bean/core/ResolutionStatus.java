...
public class ResolutionStatus extends Term {
    ...
    public static final ResolutionStatus CLOSED = new ResolutionStatus(3, "Resolved/Closed", null);
    ...
    private static final ResolutionStatus[] members = { OPEN, UPDATED, CLOSED };
