...
public class RuleDAO extends AuditableEntityDAO {
    ...
    public Object getEntityFromHashMap(HashMap hm) {
        ...
        /*
         * ruleBean.setRuleSet((RuleSetBean)getRuleSetDao().findByPK(ruleSetId));
         * 
         * 
         * ruleBean.setSourceCrfName(((String)hm.get("source_crf_name")));
         * ruleBean.setSourceCrfVersionName(((String)hm.get("source_crf_version_name")));
         * ruleBean.setSourceStudyEventDefinitionName(((String)hm.get("source_study_event_definition_name")));
         * int sourceStudyEventDefinitionId =
         * ((Integer)hm.get("source_study_event_definition_id")).intValue();
         * ruleBean.setSourceStudyEventDefinitionBean((StudyEventDefinitionBean)getStudyEventDefinitionDao().findByPK(sourceStudyEventDefinitionId));
         * ruleBean.setSourceExpression(((String)hm.get("source_expression")));
         * 
         * ruleBean.setTargetCrfName(((String)hm.get("target_crf_name")));
         * ruleBean.setTargetCrfVersionName(((String)hm.get("target_crf_version_name")));
         * ruleBean.setTargetStudyEventDefinitionName(((String)hm.get("target_study_event_definition_name")));
         * ruleBean.setTargetExpression(((String)hm.get("target_expression")));
         */
