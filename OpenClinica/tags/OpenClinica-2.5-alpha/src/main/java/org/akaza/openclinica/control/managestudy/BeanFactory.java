...
public class BeanFactory {
    ...
    protected static final Logger logger = Logger.getLogger("org.akaza.openclinica.control.managestudy.BeanFactory");
    ...
    public ResponseSetBean createResponseSetBean(Map<String, String> itemValuesMap, String crfName) {
        ...
        // properties
        String[] tmpArr;
        if (responseLab != null && responseLab.length() != 0 && optionsTxt != null && optionsTxt.length() == 0
    ...
    public DisplaySectionBean createDisplaySectionBean(Map<Integer, Map<String, String>> map, String sectionTitle, String sectionLabel, String sectionSubtitle,
            String instructions, String crfName) {
        /*
    ...
    public List<SectionBean> addPreviewGroupsInfo(List<SectionBean> secsList, Map<Integer, Map<String, String>> groupsMap) {
        ...
        for (Iterator<Map.Entry<Integer, Map<String, String>>> iter = groupsMap.entrySet().iterator(); iter.hasNext();) {
            groupValues = iter.next().getValue();
