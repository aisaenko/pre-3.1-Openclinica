...
public class ListCRFServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
        ...
        String[] columns =
            { resword.getString("CRF_name"), resword.getString("date_updated"), resword.getString("last_updated_by"), resword.getString("versions"),
               resword.getString("oid"), resword.getString("date_created"), resword.getString("owner"), resword.getString("status"), resword.getString("download"),
        ...
        table.addLink(resword.getString("enterprise_CRF_catalog"), SQLInitServlet.getEnterpriseField(crfCatalogField));
        // YW >>
