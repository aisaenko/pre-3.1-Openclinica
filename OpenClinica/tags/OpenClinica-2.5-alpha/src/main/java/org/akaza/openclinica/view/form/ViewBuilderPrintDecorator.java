...
public class ViewBuilderPrintDecorator {
    ...
    public void addRemoveRowControl(Element row, String repeatParentId) {
        ...
        synchronized (this.viewBuilderUtil) {
            viewBuilderUtil.addRemoveRowControl(row, repeatParentId);
        }
    }

    public void createAddRowControl(Element tbody, String repeatParentId, int columnNumber) {
        synchronized (this.viewBuilderUtil) {
            viewBuilderUtil.createAddRowControl(tbody, repeatParentId, columnNumber);
        }
    }
    ...
    public List<Element> generatePersistentMatrixRows(SortedMap<Integer, List<ItemDataBean>> sortedDataMap, List<DisplayItemBean> rowContentBeans,
        ...
        synchronized (this.viewBuilderUtil) {
            return viewBuilderUtil.generatePersistentMatrixRows(sortedDataMap, rowContentBeans, tabIndex, repeatParentId, hasDiscrepancyMgt, forPrinting);
        }
