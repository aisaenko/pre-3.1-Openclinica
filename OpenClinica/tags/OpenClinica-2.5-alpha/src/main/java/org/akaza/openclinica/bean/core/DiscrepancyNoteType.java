...
public class DiscrepancyNoteType extends Term {
    ...
    public static final DiscrepancyNoteType ANNOTATION = new DiscrepancyNoteType(4, "Annotation", null);

    public static final DiscrepancyNoteType QUERY = new DiscrepancyNoteType(6, "query", null);

    public static final DiscrepancyNoteType REASON_FOR_CHANGE = new DiscrepancyNoteType(7, "reason_for_change", null);
