...
public class DoubleDataEntryServlet extends DataEntryServlet {
    ...
    // }
    @Override
    protected List<DisplayItemGroupBean> validateDisplayItemGroupBean(DiscrepancyValidator v, DisplayItemGroupBean digb, List<DisplayItemGroupBean> digbs,// should
            // be
            // from
            // the
            // db,
