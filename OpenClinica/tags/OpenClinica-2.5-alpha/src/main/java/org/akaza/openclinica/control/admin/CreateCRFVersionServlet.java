        ...
        if (StringUtil.isBlank(action)) {
            ...
            if (nib1 != null) {
                try {
                    ...
                    System.out.println("CRF-ID [" + version.getCrfId() + "]");
                    int crfVersionId = 0;
                    if (version.getCrfId() != 0) {
            ...
            if (f == null || f.getName() == null) {
                ...
                try {
                    ...
                    // SpreadSheetTable htab = new SpreadSheetTable(new
                            ...
                            version.getName(), request.getLocale());
                    ...
                    logger.warning("Opening up the Excel file caused an error. the error message is: " + io.getMessage());
