...
public class EventDefinitionCRFDAO extends AuditableEntityDAO {
    ...
    public EntityBean update(EntityBean eb) {
        ...
        variables.put(new Integer(13), new Integer(sb.getOrdinal()));
        variables.put(new Integer(14), new Boolean(sb.isElectronicSignature()));
        variables.put(new Integer(15), new Integer(sb.getId()));
    ...
    public boolean isRequiredInDefinition(int crfVersionId, int studyEventId) {
        ...
        /*
         * select distinct event_definition_crf.required_crf from
         * event_definition_crf, event_crf, crf_version, study_event where
        ...
        System.out.println("We are returning " + answer.toString() + " for crfVersionId " + crfVersionId + " and studyEventId " + studyEventId);
