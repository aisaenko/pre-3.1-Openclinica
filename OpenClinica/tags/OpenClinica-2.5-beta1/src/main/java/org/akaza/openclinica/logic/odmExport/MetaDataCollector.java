...
public class MetaDataCollector extends OdmDataCollector {
    ...
    public void collectMetaDataVersion() {
        ...
        // populate Include
        String psOid = this.dataset.getODMPriorStudyOid();
        String pmOid = this.dataset.getODMPriorMetaDataVersionOid();
        ...
        oedao.getStudyEventAndFormMetaByStudyId(this.getStudy().getId(), metadata);
