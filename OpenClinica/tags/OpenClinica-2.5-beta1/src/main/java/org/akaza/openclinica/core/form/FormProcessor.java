...
public class FormProcessor {
    ...
    /**
     * @param dateTime
     *            A string in in "MM/dd/yyyy hh:mm:ss a" format.
    ...
    public Date getDateTime(String prefix) {
        ...
        // TODO have to add the below back in?
        // if ("".equals(half)) {
        //            
        // half = "pm";
        //            
     ...
     * Return true if all of three fields have valid data <br>
     * <br>
    ...
    public boolean timeEntered(String prefix) {
        if ("-1".equals(getString(prefix + "Hour")) || "-1".equals(getString(prefix + "Minute")) || "".equals(getString(prefix + "Half"))) {
            return false;
        } else {
            return true;
        }
