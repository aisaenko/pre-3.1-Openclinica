...
public class DisplayStudySubjectRow extends EntityBeanRow {
    ...
    protected int compareColumn(Object row, int sortingColumn) {
        ...
        case COL_STUDYGROUP:
            answer =
                ((SubjectGroupMapBean) thisStudy.getStudyGroups().get(sortingColumn - 3)).getStudyGroupName().toLowerCase().compareTo(
        ...
        case COL_STUDYEVENT:
            ...
            answer =
                ((StudyEventBean) thisStudy.getStudyEvents().get(sortingColumn - 3 - groupSize)).getSubjectEventStatus().compareTo(
    ...
    public String getSearchString() {
        ...
        return thisStudy.getStudySubject().getLabel() + " " + thisStudy.getStudySubject().getGender() + " " + toStr;
    }
