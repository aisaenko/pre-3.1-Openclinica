...
public class OpenClinicaExpressionParser {
    ...
    public void parseExpression(String expression) throws OpenClinicaSystemException {
        ...
        if (getTextIO().peek() != '\n')
            throw new OpenClinicaSystemException("Extra data after end of expression.");
    ...
    private ExpressionNode termTree3() throws OpenClinicaSystemException {
        ...
        while (textIO.peek() == 'e' && textIO.peek(3).matches("eq ") || textIO.peek() == 'n' && textIO.peek(3).matches("ne ") || textIO.peek() == 'g'
            && textIO.peek(3).matches("gt ") || textIO.peek() == 'g' && textIO.peek(4).matches("gte ") || textIO.peek() == 'l' && textIO.peek(3).matches("lt ")
