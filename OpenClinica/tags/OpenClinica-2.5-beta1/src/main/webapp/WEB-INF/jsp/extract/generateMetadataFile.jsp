		 ...
		 <c:set var="eblRowCount" value="${0}" />
			...
			<tr>
	         <td class="table_cell">
	          ...
	          <td class="table_cell"><fmt:formatDate value="${currRow.bean.dateCreated}" dateStyle="short"/></td>
