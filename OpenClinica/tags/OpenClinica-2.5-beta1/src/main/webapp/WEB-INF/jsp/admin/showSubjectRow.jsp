...
<tr valign="top">        
      ...
      <td class="table_cell"><fmt:formatDate value="${currRow.bean.subject.createdDate}"  dateStyle="short"/></td>
      <td class="table_cell"><c:out value="${currRow.bean.subject.owner.name}"/></td>
      <td class="table_cell"><fmt:formatDate value="${currRow.bean.subject.updatedDate}"  dateStyle="short"/>&nbsp;</td>
