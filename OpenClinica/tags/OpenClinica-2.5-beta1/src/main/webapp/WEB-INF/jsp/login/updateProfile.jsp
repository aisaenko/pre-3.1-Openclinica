...
<h1><fmt:message key="change_user_profile" bundle="${resword}"/> <a href="javascript:openDocWindow('help/1_1_updateProfile_Help.html')"><img src="images/bt_Help.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a></h1>
