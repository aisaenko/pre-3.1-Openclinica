...
<h1><fmt:message key="request_study_access" bundle="${resword}"/> <a href="javascript:openDocWindow('help/1_2_requestStudy_Help.html')"><img src="images/bt_Help.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>" ></a></h1>
