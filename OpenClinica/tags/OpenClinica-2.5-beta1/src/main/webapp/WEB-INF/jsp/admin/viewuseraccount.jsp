...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <td class="table_header_column"><fmt:message key="date_created" bundle="${resword}"/>:</td>
		<td class="table_cell"><fmt:formatDate value="${user.createdDate}" type="date" pattern="${dateFormatPattern}"/>&nbsp;</td>
	</tr>
  <tr>
	...
	<tr>
		...
		<td class="table_cell"><fmt:formatDate value="${user.updatedDate}" type="date" pattern="${dateFormatPattern}"/>&nbsp;</td>
	</tr>
	<tr>
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
   ...
   <form action='EditUserAccount?userId=<c:out value="${user.id}" />' method="POST">
    <input type="submit" name="submit" value="<fmt:message key="edit_this_user_account" bundle="${resword}"/>" class="button_xlong">
   </form>
   </td>
   <td>
   </td>
