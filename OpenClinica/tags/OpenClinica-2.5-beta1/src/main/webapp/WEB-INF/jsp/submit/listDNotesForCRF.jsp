...
:</strong>
    ...
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=4" <c:if test="${param.type == 4}">style="color:green"</c:if>><fmt:message key="Annotation" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    ...
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=2" <c:if test="${param.type == 2}">style="color:green"</c:if>><fmt:message key="Incomplete" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=6" <c:if test="${param.type == 6}">style="color:green"</c:if>><fmt:message key="query" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=7" <c:if test="${param.type == 7}">style="color:green"</c:if>><fmt:message key="reason_for_change" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=3" <c:if test="${param.type == 3}">style="color:green"</c:if>><fmt:message key="Unclear/Unreadable" bundle="${resterm}"/></a>&nbsp;|&nbsp;
    <a href="ListDiscNotesForCRFServlet?module=${module}&resolutionStatus=${param.resolutionStatus}&defId=${eventDefinitionId}&tab=${param.tab}&type=5" <c:if test="${param.type == 5}">style="color:green"</c:if>><fmt:message key="Other" bundle="${resterm}"/></a>
...
<c:choose>
   <c:when test="${userRole.manageStudy}">
    <a class="tabtext" href="ListDiscNotesForCRFServlet" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
   </c:when>
   <c:otherwise>
    <a class="tabtext" href="ListDiscNotesForCRFServlet" onclick="javascript:HighlightTab(0);"><fmt:message key="all_events" bundle="${restext}"/></a>
   </c:otherwise>
