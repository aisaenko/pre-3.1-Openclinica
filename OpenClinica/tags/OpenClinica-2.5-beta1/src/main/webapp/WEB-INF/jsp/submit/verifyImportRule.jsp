...
<jsp:useBean scope='session' id='importedData' class='org.akaza.openclinica.bean.rule.RulesPostImportContainer'/>
...
InValid Rules :
<div class="box_T" style="float:left"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
<div class="tablebox_center">
<table border="0" cellpadding="0" cellspacing="0">
...
<c:forEach var="ruleBeanWrapper" items="${importedData.validRuleSetDefs}" >
    <tr valign="top">   
        ...
        <td class="table_cell_left">
            ...
            <tr valign="top">
                <td class="table_header_row">Rule OID</td>
                <td class="table_header_row">ActionType</td>
                <td class="table_header_row">ActionMessage</td> 
            </tr>
...
<tr valign="top">
    <td class="table_header_row">Target</td> 
    <td class="table_header_row">Rules</td>
    <td class="table_header_row">Errors</td>
</tr>
