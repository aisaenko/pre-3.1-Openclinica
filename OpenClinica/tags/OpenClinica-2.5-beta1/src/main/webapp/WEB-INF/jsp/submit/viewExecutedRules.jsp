...
<jsp:useBean scope='request' id='ruleSet' class='org.akaza.openclinica.bean.rule.RuleSetBean'/>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <c:forEach var ="result" items="${ruleSetResult}" varStatus="status">
    ...
    <td class="table_cell"><a class="closed" href="#"  id="a${status.count}" onClick="showOrHideSubjects(${status.count},'<fmt:message key="rule_show_subjects" bundle="${resword}" />','<fmt:message key="rule_hide_subjects" bundle="${resword}" />')"><fmt:message key="rule_show_subjects" bundle="${resword}" /></a></td>
    </tr>
...
<tr>
<td>
<input type="button" name="Submit" id="submit" value="Submit" class="button_long" onClick="window.location.href='RunRuleSet?ruleSetId=${ruleSet.id}&dryRun=no';"/></td>
</td>
<td>
<input type="button" name="Cancel" id="cancel" value="Cancel" class="button_long" onClick="window.location.href='ViewRuleAssignment';"/></td>
</tr></table>
