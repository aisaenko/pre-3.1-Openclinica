...
<p>
<div class="homebox_bullets"><a href="javascript:openDocWindow('ViewCRFVersionPreview?crfId=<c:out value="${version.crfId}"/>')"><fmt:message key="view_CRF_version_metadata" bundle="${resword}"/></a></div>
<br><br>
<table border="0">
<tr>
  <%-- ViewSectionDataEntry?crfVersionId=<c:out value=
