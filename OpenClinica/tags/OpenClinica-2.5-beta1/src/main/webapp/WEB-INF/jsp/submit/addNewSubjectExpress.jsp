			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<td valign="top" align="right">
					 ...
					 <c:set var="tabCount" value="${tabCount+1}"/>
					<td valign="top">
					<input onfocus="if (this.value == '<fmt:message key="eventMMDDYYYY" bundle="${resword}"/>'){ this.value =''}" type="text" name="enrollmentDate" size="15" value="<fmt:message key="eventMMDDYYYY" bundle="${resword}"/>" tabindex="<c:out value="${tabCount}"/>" class="formfield" id="enrollmentDateField"/>
					</td>
					 <c:set var="tabCount" value="${tabCount+1}"/>				
