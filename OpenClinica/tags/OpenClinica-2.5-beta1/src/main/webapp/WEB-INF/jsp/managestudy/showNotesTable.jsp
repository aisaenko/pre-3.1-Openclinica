                        ...
                        <c:if test="${fn:length(keyword_filter) == 0}">
                            <c:if test="${fn:length(param.discNoteType) > 0}">
                                <c:choose>
                                    ...
                                    <c:when test="${param.discNoteType == 2}"><c:set var="keyword_filter"><fmt:message key="Incomplete" bundle="${resterm}"/></c:set></c:when>
                                    <c:when test="${param.discNoteType == 3}"><c:set var="keyword_filter"><fmt:message key="Unclear/Unreadable" bundle="${resterm}"/></c:set></c:when>
                                    <c:when test="${param.discNoteType == 4}"><c:set var="keyword_filter"><fmt:message key="Annotation" bundle="${resterm}"/></c:set></c:when>
                                    <c:when test="${param.discNoteType == 5}"><c:set var="keyword_filter"><fmt:message key="Other" bundle="${resterm}"/></c:set></c:when>
                                    <c:when test="${param.discNoteType == 6}"><c:set var="keyword_filter"><fmt:message key="query" bundle="${resterm}"/></c:set></c:when>
                                    <c:when test="${param.discNoteType == 7}"><c:set var="keyword_filter"><fmt:message key="reason_for_change" bundle="${resterm}"/></c:set></c:when>
                                </c:choose>
                            </c:if>
                        </c:if>
