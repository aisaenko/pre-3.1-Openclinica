...
<a href="javascript:openDocWindow('help/4_8_discrepancyNotes_Help.html')"><c:choose>
        ...
        <c:otherwise><img src="images/bt_Help_Submit.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></c:otherwise></c:choose></a>
...
:</strong>
    ...
    <a href="ViewNotes?module=${module}&type=50" <c:if test="${param.type == 50}">style="color:green"</c:if>>All Notes</a>&nbsp;

    <a href="ViewNotes?module=${module}&resolutionStatus=1&discNoteType=${param.discNoteType}"><img
    ...
    <a href="ViewNotes?module=${module}&resolutionStatus=2&discNoteType=${param.discNoteType}"><img
    ...
    <a href="ViewNotes?module=${module}&resolutionStatus=3&discNoteType=${param.discNoteType}"><img
    ...
    <a href="ViewNotes?module=${module}&resolutionStatus=4&discNoteType=${param.discNoteType}"><img
...
:</strong>
     <a href="ViewNotes?module=${module}&discNoteType=50&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 50}">style="color:green"</c:if>>All notes</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=4&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 4}">style="color:green"</c:if>>Annotation</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=1&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 1}">style="color:green"</c:if>>Failed Validation Check</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=2&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 2}">style="color:green"</c:if>>Incomplete</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=6&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 6}">style="color:green"</c:if>>Query</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=7&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 7}">style="color:green"</c:if>>Reason for Change</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=3&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 3}">style="color:green"</c:if>>Unclear/Unreadable</a>&nbsp;|&nbsp;
    <a href="ViewNotes?module=${module}&discNoteType=5&resolutionStatus=${param.resolutionStatus}" <c:if test="${param.discNoteType == 5}">style="color:green"</c:if>>Other</a>
