...
<c:if test="${section.eventCRF.id > 0}">
 <p><fmt:message key="enter_note_for_blank_item" bundle="${restext}"/></p>
</c:if>
<c:choose>
...
<a href="ViewCRF?crfId=<c:out value="${crfId}"/>">
 ...
 <c:if test="${section.eventCRF.id > 0}">
         <input type="submit" name="submit" value="<fmt:message key="submit_notes" bundle="${resword}"/>" class="button_xlong"/>
 </c:if>
<br/>
                                    ...
                                    <c:when test="${stage !='adminEdit' && section.lastSection}">
                                        <c:choose>
                                            <c:when test="${section.eventDefinitionCRF.electronicSignature == true}">
                                                ...
                                                <td valign="bottom" nowrap="nowrap">&nbsp; <fmt:message key="sign_and_mark_CRF_complete" bundle="${resword}"/>&nbsp;&nbsp;&nbsp;</td>
                                            </c:when>
                                            <c:otherwise>
                                                <td valign="bottom">  <input type="checkbox" id="markCompleteId" name="markComplete" value="Yes"
