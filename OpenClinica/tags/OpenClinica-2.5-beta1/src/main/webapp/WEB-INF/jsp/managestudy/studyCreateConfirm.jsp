...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
 ...
 <c:out value="${newStudy.protocolType}"/>
  ...
  <fmt:formatDate value="${newStudy.protocolDateVerification}" dateStyle="short"/>
  </td></tr>
 ...
 -->
  ...
  <tr valign="top"><td class="table_header_column"><fmt:message key="start_date" bundle="${resword}"/>:</td><td class="table_cell">
   <fmt:formatDate value="${newStudy.datePlannedStart}" dateStyle="short"/>
  </td></tr> 
  ...
  <tr valign="top"><td class="table_header_column"><fmt:message key="estimated_completion_date" bundle="${resword}"/>:</td><td class="table_cell">
   <fmt:formatDate value="${newStudy.datePlannedEnd}" dateStyle="short"/>&nbsp;
  </td></tr>   
 ...
 <tr>
  ...
  <td>
    <form action="CreateStudy" method="POST">
         ...
         <input type="submit" name="Cancel" value="<fmt:message key="cancel_creation" bundle="${resword}"/>" class="button_long">
    </form>
  </td>
 </tr>
</table>
