...
public class RequestAccountServlet extends SecureController {
    ...
    private void submitAccount() throws Exception {
        ...
        try {
            em.process(EmailEngine.getAdminEmail(), ubForm.getEmail().trim(), "request account", emailBody);
            logger.info("Sending email...done");

            addPageMessage(respage.getString("your_request_has_been_sent_succesfully"));
