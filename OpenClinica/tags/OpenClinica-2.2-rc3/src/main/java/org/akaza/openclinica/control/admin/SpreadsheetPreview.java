...
public final class SpreadsheetPreview implements Preview{
  ...
  public Map<Integer,Map<String,String>> createItemsOrSectionMap(HSSFWorkbook workbook,
    ...
    String[] itemHeaders = {"item_name","description_label","left_item_text",
      "units","right_item_text","section_label","header",
      "subheader","parent_item","column_number","page_number",
      "question_number","response_type","response_label",
      "response_options_text","response_values","data_type",
      "validation","validation_error_message","phi","required"};
    String[] sectionHeaders = {"section_label","section_title","subtitle",
      "instructions","page_number","parent_section"};
  ...
  public Map<Integer,Map<String,String>> createGroupsMap(
    ...
    String[] groupHeaders = {"group_label","group_layout","group_header",
      "group_sub_header","group_repeat_number","group_repeat_max",
    "group_repeat_array","group_row_start_number"};
    Map<String,String> rowCells= new HashMap<String,String>();
    SortedMap<Integer,Map<String,String>> allRows = new TreeMap<Integer,Map<String,String>>();
    String str = "";
    for(int i = 0; i < workbook.getNumberOfSheets(); i++) {
        ...
        for(int k = 0; k < crfHeaders.length; k++)    {
          ...
          if (cell != null)  {  //the cell does not have a blank value
            ...
            switch (cell.getCellType())  {
              ...
              case  HSSFCell.CELL_TYPE_BOOLEAN :   val=new Boolean(cell.getBooleanCellValue()).
                toString(); break;
