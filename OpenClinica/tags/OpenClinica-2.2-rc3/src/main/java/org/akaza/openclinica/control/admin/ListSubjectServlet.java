...
public class ListSubjectServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    String[] columns = { resword.getString("person_ID"), resword.getString("Protocol_Study_subject_IDs"), 
    		resword.getString("gender"), resword.getString("date_created"),
    		resword.getString("owner"), resword.getString("date_updated"),
    		resword.getString("last_updated_by"), resword.getString("status"),
