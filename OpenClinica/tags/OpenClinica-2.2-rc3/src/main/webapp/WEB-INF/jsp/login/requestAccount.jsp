...
<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="email2"/></jsp:include></td></tr>
 ...
 <tr><td class="formlabel"><fmt:message key="default_active_study" bundle="${resword}"/>:</td><td>
...
<table border="0" cellpadding="0">
 <tr><td>
 <input type="submit" name="submit" value="<fmt:message key="confirm_account_reset" bundle="${resword}"/>" class="button_xlong">
 </td>
