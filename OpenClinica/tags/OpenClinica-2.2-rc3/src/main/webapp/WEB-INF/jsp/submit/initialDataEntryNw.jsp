...
margin-top:20px; border:solid thick black; updateTabs(<c:out value="${tabId}"/>);--%>
...
<h1><span class="title_submit"><fmt:message key="initial_data_entry_for" bundle="${resword}"/> <c:out value="${section.crf.name}" /> <c:out value="${section.crfVersion.name}" /> <a href="javascript:openDocWindow('help/2_2_enrollSubject_Help.html#step2c')"><img src="images/bt_Help_Submit.gif" border="0" alt="Help" title="Help"></a></span></h1>
