...
public class DisplayStudySubjectRow extends EntityBeanRow {
    ...
    protected int compareColumn(Object row, int sortingColumn) {
        ...
        case COL_STUDYEVENT:
            ...
            answer =
                ((StudyEventBean) thisStudy.getStudyEvents().get(sortingColumn - 5 - groupSize)).getSubjectEventStatus().compareTo(
                        ((StudyEventBean) argStudy.getStudyEvents().get(sortingColumn - 5 - groupSize)).getSubjectEventStatus());
            break;
        // YW >>
        }
        return answer;
