...
<h1>
 <span class="title_extract">
   ...
   <a href="javascript:openDocWindow('help/3_2_createDataset_Help.html#step1')">
   <img src="images/bt_Help_Extract.gif" border="0" alt="<fmt:message key="help" bundle="${resword}"/>" title="<fmt:message key="help" bundle="${resword}"/>"></a>
 </span>
</h1>
...
<input type="checkbox" name="all" value="1" 
	onClick="javascript:selectAll();"> <fmt:message key="select_all_items" bundle="${resword}"/><br/>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr>
    ...
    <td class="table_header_column_top">Section(s)</td> 
    <td class="table_header_column_top">Group(s)</td> 
    ...
    <td class="table_header_column_top">Response Type</td>      
    ...
    <td class="table_header_column_top">Validation</td>
    <td class="table_header_column_top">Default Value</td>
    <td class="table_header_column_top">Max Repeats</td>
