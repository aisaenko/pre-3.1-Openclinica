...
<h1><span class="title_extract"><fmt:message key="restore_dataset" bundle="${resword}"/>: <c:out value="${dataset.name}"/></span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
  ...
  <fmt:formatDate value="${dataset.updatedDate}" dateStyle="short"/>
  </td></tr>
