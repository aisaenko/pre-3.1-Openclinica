...
public class StudyUserRoleBean extends AuditableEntityBean {
  ...
  public void setRole(Role role) {
    ...
    //roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}
    this.canSubmitData=(this.role==Role.COORDINATOR
    		||this.role==Role.STUDYDIRECTOR
    		||this.role==Role.RESEARCHASSISTANT
    		||this.role==Role.INVESTIGATOR);
    this.canExtractData=(this.role==Role.COORDINATOR
    		||this.role==Role.STUDYDIRECTOR
    		||this.role==Role.INVESTIGATOR);
    this.canManageStudy=(this.role==Role.COORDINATOR
    		||this.role==Role.STUDYDIRECTOR);
  }
