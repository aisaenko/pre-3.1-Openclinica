...
public class EditSelectedServlet extends SecureController {
  ...
  /*
   * TODO this function exists in four different places...
   * needs to be added to an additional superclass for
   * Submit Data Control Servlets, tbh July 2007
   */
  ...
  public void processRequest() throws Exception {
    ...
    if (selectAll) {
      ...
      addPageMessage("You choose to include all items in current study for the dataset, " +
          db.getItemIds().size() + " items total.");
    }//end of if selectAll

    if (selectAllItemsGroupsAttrs) {
    	System.out.println("select everything....");
    	db = selectAll(db);
