...
<c:choose>
<c:when test="${userBean.sysAdmin && module=='admin'}">
<h1><span class="title_Admin"><fmt:message key="view_CRF_version_details" bundle="${resword}"/>: <c:out value="${crfname}"/> <c:out value="${version.name}"/>  </span></h1>
</c:when>
<c:otherwise>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr valign="top">
  <td class="table_header_row_left">Group Name</td>
  <td class="table_header_row">Header</td>
  <td class="table_header_row">Repeat Number</td>
  <td class="table_header_row">Repeat Max</td>
 </tr>
