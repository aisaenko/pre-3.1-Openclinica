...
<h1><span class="title_extract"><fmt:message key="edit_dataset_properties" bundle="${resword}"/>: <c:out value='${dsName}'/></span></h1>

<p><fmt:message key="please_update_dataset_properties" bundle="${restext}"/>.  
<fmt:message key="all_fields_are_required" bundle="${resword}"/></p>
...
<table>
 ...
 <input type="submit" name="remove" value="<fmt:message key="update_dataset_properties" bundle="${resword}"/>" class="button_xlong"/>		
