...
public class AuditLogStudyServlet extends SecureController {
	 ...
	 */
	  ...
	  /*
	   * (non-Javadoc)
	   * redo this servlet to run the audits per study subject for the study;
	   * need to add a studyId param and then use the StudySubjectDAO.findAllByStudyOrderByLabel()
	   * method to grab a lot of study subject beans and then return them much like in 
	...
	protected void processRequest() throws Exception {
	    ...
	    ArrayList studySubjects = (ArrayList) subdao.findAllByStudyOrderByLabel(currentStudy);
	    ...
	    for (int ss = 0; ss < studySubjects.size(); ss++) {
	    	...
	    	//logger.info("just set a subject with a status of "+subject.getStatus().getName());
	    	...
	    	//request.setAttribute("studySubjectAudits"+ss, studySubjectAudits);
...
//	    	}
	    	...
	    	//eventCRFAuditsHashMap.put(new Integer(studySubject.getId()), eventCRFAudits);
