...
public class AuditEventStudyRow extends EntityBeanRow {
	...
	protected int compareColumn(Object row, int sortingColumn) {
	    ...
	    case AUDIT_UPDATER_NAME:
	      answer = thisBean.getUpdater().getName().toLowerCase().compareTo(
	      		argBean.getUpdater().getName().toLowerCase());
	      break;
	    case AUDIT_SUBJECT_NAME:
		      answer = thisBean.getSubjectName().compareTo(
		      		argBean.getSubjectName());
		      break; 
	    case AUDIT_CHANGES:
	    	//LEAVE THIS BLANK?
