...
<%--  working on a change to parsed names for error checking, tbh 01/2010 --%>
<c:set var="errorInputName" value="${repeatParentId}_${rowCount}input${itemId}" />
<c:set var="errorParsedInputName" value="${repeatParentId}_manual${rowCount}input${itemId}" />
...
<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
  ...
  <c:when test="${(originJSP eq 'administrativeEditing') && (isForcedRFC eq 'false')}">
