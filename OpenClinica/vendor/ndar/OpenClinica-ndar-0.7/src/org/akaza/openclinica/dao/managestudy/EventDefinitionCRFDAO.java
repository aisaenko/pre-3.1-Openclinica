...
public class EventDefinitionCRFDAO extends AuditableEntityDAO {
  ...
  public int countAllRequiredActiveByEventDefinitionId(int eventDefinitionId) {
  	HashMap<Integer, Object> variables = new HashMap<Integer, Object>();
  	variables.put(new Integer(1), new Integer(eventDefinitionId));
  	
  	return executeCountQuery("countAllRequiredActiveByEventDefinitionId", variables);
  }
