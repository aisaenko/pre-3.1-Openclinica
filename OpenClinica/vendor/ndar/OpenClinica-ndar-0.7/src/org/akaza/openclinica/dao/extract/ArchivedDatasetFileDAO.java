...
public class ArchivedDatasetFileDAO extends AuditableEntityDAO {
	...
	public EntityBean create(EntityBean eb) {
		...
		variables.put(new Integer(3), new Integer(fb.getDatasetId()));
		variables.put(new Integer(4), new Integer(fb.getExportFormatId()));
		variables.put(new Integer(5), fb.getFileReference());
		variables.put(new Integer(6), new Integer(fb.getFileSize()));
		variables.put(new Integer(7), new Integer(fb.getRunTime()));
		variables.put(new Integer(8), new Integer(fb.getOwnerId()));
	...
	public EntityBean update(EntityBean eb) {
		...
		variables.put(new Integer(6), new Integer(fb.getRunTime()));
	...
	public Object getEntityFromHashMap(HashMap hm) {
		...
		fb.setRunTime(((Integer)hm.get("run_time")).intValue());
	...
	public Collection findAll() {
		...
		while (it.hasNext()) {
			ArchivedDatasetFileBean fb = 
				(ArchivedDatasetFileBean) this.getEntityFromHashMap((HashMap) it.next());
			al.add(fb);
		}
		return al;
	}
	...
	public ArrayList findByDatasetId(int did) {
		...
		while (it.hasNext()) {
			ArchivedDatasetFileBean fb = (ArchivedDatasetFileBean) 
				this.getEntityFromHashMap((HashMap) it.next());
			al.add(fb);
		}
