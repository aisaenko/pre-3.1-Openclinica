                           ...
                           <c:if test="${roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}">
							<td>
							 <a href="ListStudySubjectsSubmit"
							   onMouseOver="setImage('nav_Submit','images/nav_Submit_s_h.gif');"
							   onMouseOut="setImage('nav_Submit','images/nav_Submit_s.gif');"><img 
					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><a href="ListStudySubjectsSubmit"
							   onMouseOver="setImage('subnav_Submit_ViewAllSubjects','images/subnav_Submit_ViewAllSubjects_h.gif');"
							   onMouseOut="setImage('subnav_Submit_ViewAllSubjects','images/subnav_Submit_ViewAllSubjects.gif');"><img 
							...
							<td><a href="AddNewSubject?instr=1"
							   onMouseOver="setImage('subnav_Submit_EnrollSubject','images/subnav_Submit_EnrollSubject_h.gif');"
							   onMouseOut="setImage('subnav_Submit_EnrollSubject','images/subnav_Submit_EnrollSubject.gif');"><img 
							...
							<td><a href="CreateNewStudyEvent"
							   onMouseOver="setImage('subnav_Submit_CreateStudyEvent','images/subnav_Submit_CreateStudyEvent_h.gif');"
							   onMouseOut="setImage('subnav_Submit_CreateStudyEvent','images/subnav_Submit_CreateStudyEvent.gif');"><img 
						    ...
						    <td><a href="ViewStudyEvents"
							   onMouseOver="setImage('subnav_Submit_ViewEvents','images/subnav_Submit_ViewEvents_h.gif');"
							   onMouseOut="setImage('subnav_Submit_ViewEvents','images/subnav_Submit_ViewEvents.gif');"><img 
