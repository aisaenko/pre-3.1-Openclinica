						 ...
						 <c:set var="roleName" value="${userRole.role.name}"/>
                           ...
                           <c:if test="${roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}">
							...
							<td><a href="ManageStudy"
							   onMouseOver="setImage('nav_Manage','images/nav_Manage_s_h.gif');"
							   onMouseOut="setImage('nav_Manage','images/nav_Manage_s.gif');"><img 
				...
				<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0">
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td><a href="ListStudySubject"
									   onMouseOver="setImage('subnav_Manage_Subjects','images/subnav_Manage_Subjects_h.gif');"
									   onMouseOut="setImage('subnav_Manage_Subjects','images/subnav_Manage_Subjects.gif');"><img 
									...
									<td><a href="ListSubjectGroupClass"
									   onMouseOver="setImage('subnav_Manage_Groups','images/subnav_Manage_Groups_h.gif');"
									   onMouseOut="setImage('subnav_Manage_Groups','images/subnav_Manage_Groups.gif');"><img 
									...
									<td><a href="ViewStudyEvents"
									   onMouseOver="setImage('subnav_Manage_ViewEvents','images/subnav_Manage_ViewEvents_h.gif');"
									   onMouseOut="setImage('subnav_Manage_ViewEvents','images/subnav_Manage_ViewEvents.gif');"><img 
									...
									<td><a href="ViewNotes"
									   onMouseOver="setImage('subnav_Manage_Discrepancies','images/subnav_Manage_Discrepancies_h.gif');"
									   onMouseOut="setImage('subnav_Manage_Discrepancies','images/subnav_Manage_Discrepancies.gif');"><img 
						...
						<tr>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td><img src="images/subnav_Manage_row2_L.gif" alt=""></td>
									<td><a href="ListStudyUser"
									   onMouseOver="setImage('subnav_Manage_Users','images/subnav_Manage_Users_h.gif');"
									   onMouseOut="setImage('subnav_Manage_Users','images/subnav_Manage_Users.gif');"><img 
									   name="subnav_Manage_Users" src="images/subnav_Manage_Users.gif" border="0" alt="Manage Users" title="Manage Users"></a></td>
									<td><a href="ListSite"
									   onMouseOver="setImage('subnav_Manage_Sites','images/subnav_Manage_Sites_h.gif');"
									   onMouseOut="setImage('subnav_Manage_Sites','images/subnav_Manage_Sites.gif');"><img 
									...
									<td><a href="ListEventDefinition"
									   onMouseOver="setImage('subnav_Manage_StudyEventDefinitions','images/subnav_Manage_StudyEventDefinitions_h.gif');"
									   onMouseOut="setImage('subnav_Manage_StudyEventDefinitions','images/subnav_Manage_StudyEventDefinitions.gif');"><img 
									...
									<td><a href="ListCRF"
									   onMouseOver="setImage('subnav_Manage_CRFs','images/subnav_Manage_CRFs_h.gif');"
									   onMouseOut="setImage('subnav_Manage_CRFs','images/subnav_Manage_CRFs.gif');"><img 
