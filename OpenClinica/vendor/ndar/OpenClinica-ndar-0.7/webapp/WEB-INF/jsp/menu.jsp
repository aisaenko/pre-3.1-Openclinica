			  ...
			  <c:if test="${roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}">
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_center">
						 ...
						 <div class="homebox_title"><a href="ListStudySubjectsSubmit">Submit Data</a>&nbsp;<a href="javascript:openDocWindow('help/2_0_submitData_Help.html')"><img src="images/bt_Help_Home.gif" border="0" alt="Help" title="Help"></a></div><br>
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_title"><a href="ExtractDatasetsMain">Extract Data</a>&nbsp;<a href="javascript:openDocWindow('help/3_0_extractData_Help.html')"><img src="images/bt_Help_Home.gif" border="0" alt="Help" title="Help"></a></div><br>
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_title"><a href="ManageStudy">Manage Study</a>&nbsp;<a href="javascript:openDocWindow('help/4_0_manageStudy_Help.html')"><img src="images/bt_Help_Home.gif" border="0" alt="Help" title="Help"></a></div><br>
	                    ...
	                    <div class="homebox_bullets"><a href="ListSubjectGroupClass">Manage Templates</a></div><br>
				...
				<!-- These DIVs define shaded box borders -->
					<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
						...
						<div class="homebox_title"><a href="AdminSystem">Business Admin</a>&nbsp;<a href="javascript:openDocWindow('help/5_0_administerSystem_Help.html')"><img src="images/bt_Help_Home.gif" border="0" alt="Help" title="Help"></a></div><br>
