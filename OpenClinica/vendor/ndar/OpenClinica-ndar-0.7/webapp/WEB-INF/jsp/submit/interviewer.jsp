...
<table border="0" cellpadding="0" cellspacing="0">
	<tr id="CRF_infobox_closed"  style="display: none;">
		...
		<a href="javascript:leftnavExpand('CRF_infobox_closed'); leftnavExpand('CRF_infobox_open');"><img src="images/sidebar_expand.gif" border="0" align="right" hspace="10" alt="v" title="" /></a>
...
<c:otherwise>
 <td class="table_cell" style="color: #789EC5">Person ID:</td>
		...
		<td class="table_cell_left">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<img name="interviewer" src="images/icon_noNote.gif" border="0" alt="Discrepancy Note" title="Discrepancy Note" /></a>
					</c:if>				
					</tr>
				<tr>
					<td valign="top">
...
<span ID="spanAlert-interviewer" class="alert"></span>
		...
		<td class="table_cell" nowrap>Assessment Date: *&nbsp;<br>(MM/DD/YYYY)</a>
		<td class="table_cell_left">
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<div class="formfieldM_BG"><c:choose>
									<c:when
										...
										<input type="text" name="assessmentDate" size="15"
											value="<c:out value="${assessmentDate}" />" class="formfieldM">
									</c:when>
									<c:otherwise>
										<input type="text" disabled size="15"
											value="<c:out value="${assessmentDate}" />" class="formfieldM">
										<input type="hidden" name="assessmentDate"
											value="<c:out value="${assessmentDate}" />">
									</c:otherwise>
								</c:choose></div>
								<jsp:include page="../showMessage.jsp">
									<jsp:param name="key" value="assessmentDate" />
								</jsp:include>
					</td>
					<td valign="top" nowrap><a href="#" onClick="cal1.select(document.forms[0].assessmentDate,'anchor1','MM/dd/yyyy'); return false;" TITLE="cal1.select(document.forms[0].assessmentDate,'anchor1','MM/dd/yyyy'); return false;" NAME="anchor1" ID="anchor1"><img src="images/bt_Calendar.gif" alt="Show Calendar" title="Show Calendar" border="0" /></a>
					<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}">
					<a href="#" onClick="openDNoteWindow('CreateDiscrepancyNote?id=<c:out value="${toc.eventCRF.id}"/>&name=eventCrf&field=assessmentDate&column=date_interviewed','spanAlert-assessmentDate'); return false;">
					<img name="assessmentDate" src="images/icon_noNote.gif" border="0" alt="Discrepancy Note" title="Discrepancy Note" /></a>
					</c:if>
				</tr>
				<tr>
					<td valign="top">
...
<span ID="spanAlert-assessmentDate" class="alert"></span>
</td>
				</tr>
			</table>
