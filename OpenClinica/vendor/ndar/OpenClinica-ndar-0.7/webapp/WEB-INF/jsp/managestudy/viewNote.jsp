...
<div class="table_title_manage">View Discrepancy Notes &nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:window.close();">Close Window</a></div>
 ...
 <p><img src="images/bullet.gif" alt=">" title="">&nbsp;<b><c:out value="${singleNote.description}"/></b></p>
   ...
   <c:if test="${singleNote.entityName !=''}">
    ...
    <c:choose>
      <c:when test="${singleNote.entityType=='ItemData'}">
       <a href="javascript: openDocWindow('ViewItemDetail?itemName=<c:out value="${singleNote.entityName}"/>')"><c:out value="${singleNote.entityName}"/></a>
      </c:when>
      <c:otherwise>
