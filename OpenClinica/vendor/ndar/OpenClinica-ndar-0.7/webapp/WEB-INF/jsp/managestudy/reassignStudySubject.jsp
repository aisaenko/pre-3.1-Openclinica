...
Transfer Subject to Another Site
</span></h1>
<p>You choose to transfer the following subject to another site:</p>
...
<p><strong>Please choose a study in the following list:</strong></P>
  ...
  <p><input type="submit" name="Submit" value="Transfer Subject" class="button_long"></p>
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							<span class="title_manage">				
							  ...
							  <b> Transfer Subject to Another Site </b>					
