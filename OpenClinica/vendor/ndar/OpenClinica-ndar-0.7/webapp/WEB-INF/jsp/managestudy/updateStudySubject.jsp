	...
	<table border="0" cellpadding="0">
	  ...
	  <tr valign="top">
	   ...
	   <td><div class="formfieldM_BG"> <select name="studyGroupId<c:out value="${count}"/>" class="formfieldM">
	        ...
	        <c:otherwise>	
	          <td>                   
			   <fmt:formatDate value="${group.studyTemplateStartDate}" pattern="MM/dd/yyyy"/>
			   <input type="hidden" name="studyTemplateStartDate<c:out value="${count}"/>"  value="<fmt:formatDate value="${group.studyTemplateStartDate}" pattern="MM/dd/yyyy"/>" class="formfieldM" />	 	
	          </td>
	         </c:otherwise>  
	        </c:choose>
	        </tr>
