...
<tr id="sidebar_Instructions_open" style="display: all">
        ...
        The current study can have several sites where subject data is collected. Each site uses the same study protocol, while managing its own subjects and users. 
        View details on each site or create a new one.
		</div>
...
Manage All Sites in Study <c:out value="${study.name}"/> <a href="javascript:openDocWindow('help/4_3_sites_Help.html')"><img src="images/bt_Help_Manage.gif" border="0" alt="Help" title="Help"></a></span></h1>
...
View Current Study Details</a>
</div>
<div class="homebox_bullets"><a href="CreateSubStudy">Create a New Site</a></div>
<p></p>
