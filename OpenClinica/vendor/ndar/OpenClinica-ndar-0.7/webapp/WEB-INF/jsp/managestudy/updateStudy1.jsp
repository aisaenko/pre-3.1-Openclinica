...
<table border="0" cellpadding="0" cellspacing="0" width="400">  
  ...
  <tr valign="top"><td class="formlabel">Brief Title:</td><td><div class="formfieldXL_BG">
  ...
  <tr valign="top"><td class="formlabel">Official Title:</td><td><div class="formfieldXL_BG">
  ...
  <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="description"/></jsp:include></td><td class="formlabel">*</td></tr>
   ...
   <tr valign="top"><td class="formlabel">Detailed Description:</td><td>
  ...
  <tr valign="top"><td class="formlabel">Sponsor:</td><td>
