...
<table border="0" cellpadding="0" cellspacing="0">
 <input type="hidden" name="changeDate" value="<c:out value="${changeDate}"/>">
  <tr valign="top"><td class="formlabel">Event:</td>
  <td><div class="formfieldXL_BG">
  &nbsp;&nbsp;<c:out value="${eventDefinition.name}"/></div>
  </td></tr>
 
  <tr valign="top"><td class="formlabel">Location:</td>
  <td>
  	<table border="0" cellpadding="0" cellspacing="0">
  	<tr><td>
  ...
  <tr valign="top">
  	<td class="formlabel">Start Date/Time:</td>
	  	<td valign="top">
			  ...
			  <c:otherwise>
			    <tr><td>
			    &nbsp;<fmt:formatDate value="${event.dateStarted}" pattern="MM/dd/yyyy hh:mm:ss a"/>
			    </td></tr>
...
<br>
 <input type="submit" name="Submit" value="Submit Changes" class="button_long">
</form>
