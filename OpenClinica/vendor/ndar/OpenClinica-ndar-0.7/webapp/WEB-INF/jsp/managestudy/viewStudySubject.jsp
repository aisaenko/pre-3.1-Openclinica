...
<h1>View Subject: <c:out value="${studySub.label}"/></h1>
 </div>
 </td>
 <td align="right">
 <!-- <span style="font-size:11px"><a href="#"><img 
		    src="images/bt_View.gif" border="0" alt="View" title="View"></a>View Printable Record</span>-->
</td></tr>
</table>

<p><a href="#events">Events</a> &nbsp; &nbsp; &nbsp; <a href="#group">Group Templates</a> &nbsp;&nbsp;&nbsp; <a href="#log">Recent Activity Log</a> &nbsp;&nbsp;&nbsp;  <a href="#global">Global Subject Record</a></p>
<c:choose>
 <c:when test="${isAdminServlet == 'admin' && userBean.sysAdmin}">
...
<a href="javascript:leftnavExpand('subjectRecord'); setImage('ExpandGroup1','images/bt_Collapse.gif');"><img 
...
</c:choose>	<a name="events" href="javascript:leftnavExpand('subjectEvents'); setImage('ExpandGroup2','images/bt_Collapse.gif');"><img 
	     name="ExpandGroup2" src="images/bt_Expand.gif" border="0"> Events</a></div>
...
</c:choose> <a name="group" href="javascript:leftnavExpand('groups'); setImage('ExpandGroup3','images/bt_Collapse.gif');"><img 
	     name="ExpandGroup3" src="images/bt_Expand.gif" border="0"> Group Templates</a></div>
	...
	<!-- These DIVs define shaded box borders -->
		...
		<!-- end Table Actions row (pagination, search, tools) -->
			...
			<!-- Table Contents -->
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td class="table_header_row_left">Group Template</td>
							<td class="table_header_row">Study Group</td>
							<td class="table_header_row">Notes</td>
							<td class="table_header_row">Template Start Date</td>
						</tr>
						<c:choose>
						 <c:when test="${!empty groups}">
						  <c:forEach var="group" items="${groups}">
                           <tr>
                            ...
                            <td class="table_cell"><c:out value="${group.studyTemplateStartDate}"/>&nbsp;</td>
                           </tr>
                          </c:forEach>
                         </c:when> 
                         <c:otherwise>
                          <tr>
                            <td class="table_cell" colspan="2">Currently no templates.</td>                           
                           </tr>
                         </c:otherwise>
                       </c:choose>
					</table>
...
</c:choose><a name="log" href="javascript:leftnavExpand('logs'); setImage('ExpandGroup4','images/bt_Collapse.gif');"><img 
	     name="ExpandGroup4" src="images/bt_Expand.gif" border="0"> Recent Activity Log</a></div>
...
</c:choose>	<a name="global" href="javascript:leftnavExpand('globalRecord'); setImage('ExpandGroup5','images/bt_Collapse.gif');"><img 
	     name="ExpandGroup5" src="images/bt_Expand.gif" border="0"> Global Subject Record</a></div>
