...
<tr id="sidebar_Instructions_open" style="display: none">
		...
		<a href="javascript:leftnavExpand('sidebar_Instructions_open'); leftnavExpand('sidebar_Instructions_closed');"><img src="images/sidebar_collapse.gif" border="0" align="right" hspace="10" alt="-" title="" alt="-" title=""></a>
...
<a href="DataImporting?crfId=<c:out value="${crfId}"/>&versionId=<c:out value="${versionId}"/>">ISACC Data Importing - ADOS Module 2</a>
