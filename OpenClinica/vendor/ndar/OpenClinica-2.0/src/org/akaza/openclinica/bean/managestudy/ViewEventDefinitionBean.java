...
public class ViewEventDefinitionBean {
  ...
  /**
   * @param firstScheduledStartDate The firstScheduledStartDate to set.
   */
  ...
  /**
   * @param studyEventTable The studyEventTable to set.
   */
  ...
  /**
   * @param subjectCompleted The subjectCompleted to set.
   */
  ...
  /**
   * @param subjectDiscontinued The subjectDiscontinued to set.
   */
  ...
  /**
   * @param subjectScheduled The subjectScheduled to set.
   */
