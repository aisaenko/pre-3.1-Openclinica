...
public class RestoreStudyEventServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if (studyEventId == 0) {
      addPageMessage("Please choose a study event to restore.");
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        if (event.getStatus().equals(Status.AVAILABLE)) {
          addPageMessage("This event is already available for this study."
        ...
        String emailBody = "The Event " + event.getStudyEventDefinition().getName()
            + " has been restored to the Study " + study.getName() + ".";
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), "Restore Event to Study",
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
          "Restore Event to Study", emailBody);
