...
Confirm Restore of CRF</span></h1>


<p>You choose to restore the following CRF:</p>
...
<form action='RestoreCRF?action=submit&id=<c:out value="${crfToRestore.id}"/>' method="POST">
<input type="submit" name="submit" value="Restore CRF" class="button_long" onClick='return confirm("If you restore this CRF, all the assigned uses of the CRF and any data entered using it will be restored as well. Are you sure you want to restore it?");'>
</form>
