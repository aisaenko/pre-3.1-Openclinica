		...
		<c:when test='${(currRow.bean.techAdmin && !(userBean.techAdmin))}'>
			...
			<c:otherwise>
				...
				<c:when test='${currRow.bean.status.name == "removed"}'>
				    ...
				    onMouseUp="javascript:setImage('bt_Restore3','images/bt_Restore.gif');">	<img name="bt_Restore3" src="images/bt_Restore.gif" border="0" alt="Restore" title="Restore" align="left" hspace="6"></a>
				   	</td>
			</c:when>
			<c:otherwise>
