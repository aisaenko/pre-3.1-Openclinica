...
<h1><span class="title_extract">Restore Dataset: <c:out value="${dataset.name}"/></span></h1>

<P><jsp:include page="../showInfo.jsp"/></P>

<P>Please review the dataset properties below and confirm that you would like to restore this dataset.  
</P>
...
<form action="RestoreDataset" method="post">
	...
	<input type="submit" name="action" value="Restore this Dataset" class="button_xlong"/>
