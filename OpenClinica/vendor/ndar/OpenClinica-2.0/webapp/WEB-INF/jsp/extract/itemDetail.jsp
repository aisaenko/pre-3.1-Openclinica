 ...
 <c:forEach var="versionItem" items="${versionItems}">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
   <tr>
	 ...
	 <td valign="top" class="leftmenu"><a href="javascript:leftnavExpand('leftnavSubRow_SubSection<c:out value="${versionCount}"/>'); 
	     javascript:setImage('ExpandGroup<c:out value="${versionCount}"/>','images/bt_Collapse.gif');"><b><c:out value="${versionItem.crfName}"/>&nbsp;<c:out value="${versionItem.crfVersionName}"/></b></a>
	 </td>
   </tr>  
