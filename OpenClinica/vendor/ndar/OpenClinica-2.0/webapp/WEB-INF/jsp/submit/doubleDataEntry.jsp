...
<h1><span class="title_submit">Validation for <c:out value="${section.crf.name}" /> <c:out value="${section.crfVersion.name}" /></span></h1>
</div>

<form method="POST" action="DoubleDataEntry">
