							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">		
							   <c:choose>
							    <c:when test="${eventStatus =='not scheduled'}">
							      ...
							      <a href="CreateNewStudyEvent?studySubjectId=<c:out value="${subjectId}"/>"><img src="images/bt_Schedule.gif" border="0" align="left"></a>&nbsp;&nbsp; <a href="CreateNewStudyEvent?studySubjectId=<c:out value="${subjectId}"/>">Schedule</a></td></tr>
							    </c:when>
