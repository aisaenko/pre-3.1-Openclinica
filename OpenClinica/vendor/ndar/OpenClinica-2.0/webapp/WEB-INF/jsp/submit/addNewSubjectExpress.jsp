			  ...
			  <input type="hidden" name="addWithEvent" value="1"/>
				<c:choose>
			      ...
			      <c:otherwise>
			        ...
			        <input type="text" name="label" value="Study Subject ID" size="12" class="formfield">
			      </c:otherwise>
			    </c:choose>
			</td>
					...
					<td valign="top" align="right">
					 <c:choose>
					    ...
					    <c:when test="${study.studyParameterConfig.collectDob == '2'}">
					     &nbsp;<input type="text" name="yob" size="15" value="value="YOB: YYYY"" class="formfield" /><span class="formlabel">*</span>
					    </c:when>
					    <c:otherwise>
