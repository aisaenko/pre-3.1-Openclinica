		...
		<td colspan="2">
			...
			<c:forEach var="displayItem" items="${section.items}">
				<c:if test="${currPage != displayItem.metadata.pageNumberLabel}">
					<a href="#item<c:out value="${displayItem.item.id}"/>"><c:out value="${displayItem.metadata.pageNumberLabel}" /></a>
			 ...
			 <tr>				
				...
				<td class="table_cell_left" valign="bottom" nowrap style="padding-right: 50px">
					...
					<%--
				     ...
				     Page: <c:out value="${displayItem.metadata.pageNumberLabel}" />
			        </a>	
			        --%>
					<a name="top">Page: <c:out value="${displayItem.metadata.pageNumberLabel}" /></a>
				</td>
				  ...
				  <table border="0" cellpadding="0" cellspacing="0">
							<tr>
							   ...
							   --%>
								...
								--%>
								<td><input type="submit" name="submittedExit" value="Exit w/o Saving" class="button_medium" onClick="return confirm('are you sure you want to exit without saving?');" /></td>
							...
							<%--	
								<c:choose>
								 ...
								 <c:otherwise>
								  ...
								  --%>
								<td><input type="submit" name="submittedExit" value="Exit w/o Save" class="button_medium" onClick="return confirm('are you sure you want to exit without saving?');" /></td>
