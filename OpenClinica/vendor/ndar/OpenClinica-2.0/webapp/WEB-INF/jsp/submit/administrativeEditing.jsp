...
<tr id="sidebar_Instructions_open" style="display: all">
		...
		<div class="sidebar_tab_content">
         Please enter data in the form provided. To exit this form you must click either the 'Save' or 'Exit w/o Saving' button.
		</div>
...
<h1><span class="title_submit">Administrative Editing for <c:out value="${section.crf.name}" /> <c:out value="${section.crfVersion.name}" /></span></h1>
</div>

<form method="POST" action="AdministrativeEditing">
...
<c:if test="${!section.firstSection}">
		...
		<td><input type="submit" name="submittedResume" value="<c:out value="${buttonAction}"/> and Edit Later" class="button_xlong" /></td>
...
<c:import url="showSection.jsp">
  <c:param name="stage" value="adminEdit" />
</c:import>
