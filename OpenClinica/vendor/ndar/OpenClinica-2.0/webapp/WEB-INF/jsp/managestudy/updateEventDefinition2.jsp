...
<tr id="sidebar_Instructions_open" style="display: all">
        ...
        Please choose CRFs (Case Report Form) for this study event definition from the CRF table.
		</div>
...
<h1><span class="title_manage">Update Study Event Definition- add CRF(s)</span></h1>
...
<c:param name="outerFormName" value="crfForm" />
 ...
 <input type="submit" name="Submit" value="Add" class="button_medium">
</form>
<br><br>
		...
		<!-- Workflow items -->
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							Enter<br>Definition Name<br>& Description
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							<span class="title_manage">
				            <b>Add CRFs<br>to<br>Definition</b>
							</span>
