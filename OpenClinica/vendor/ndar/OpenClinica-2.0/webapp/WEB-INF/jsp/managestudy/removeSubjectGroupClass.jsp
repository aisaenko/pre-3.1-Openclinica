...
<h1><span class="title_manage">Confirm to Remove a Subject Group Class</span></h1>
<p>Confirm deletion of this subject group class from Study/Site <c:out value="${study.name}"/>.</p>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
 ...
 <form action='RemoveSubjectGroupClass?action=submit&id=<c:out value="${group.id}"/>' method="POST">
    <input type="submit" name="submit" value="Remove Subject Group Class" class="button_xlong" onClick='return confirm("If you remove this subject group class, all the associated subjects will be removed from this group class as well. Are you sure you want to remove it?");'>
 </form> 
<br><br>
