...
<tr id="sidebar_Instructions_open" style="display: none">
        ...
        Confirm restoration of this subject group class to Study/Site <c:out value="${study.name}"/>.
		</div>
...
<h1><span class="title_manage">Confirm to Restore a Subject Group Class</span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
 ...
 <form action='RestoreSubjectGroupClass?action=submit&id=<c:out value="${group.id}"/>' method="POST">
    <input type="submit" name="submit" value="Restore Subject Group Class" class="button_xlong" onClick='return confirm("If you restore this subject group class, all the associated subjects will be restored from this group class as well. Are you sure you want to restore it?");'>
 </form> 
</form>
		...
		<!-- Workflow items -->
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							<b>Restore Subject Group Class</b>					
