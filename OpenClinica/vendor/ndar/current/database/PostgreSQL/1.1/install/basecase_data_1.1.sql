...
INSERT INTO study VALUES (1, NULL, 'default-study', 'default-study', 'Default Study', 'This is a default study used to pre-populate the system', NOW(), NOW(), NOW(), NOW(), 1, NULL, 1, 1, 'default', '', '', '', '', '', '', '', '', '', '', 'observational', '', NOW(), 'default', 0, 'default', '', '', '', '', '', '', '', 'both', '', '', false, 'Natural History', '', '', '', '', '', '', 'longitudinal', 'Convenience Sample', 'Retrospective', '', false, false);
