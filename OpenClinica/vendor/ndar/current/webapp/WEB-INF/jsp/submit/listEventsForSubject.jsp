...
<c:choose>
   <c:when test="${userRole.role.name=='coordinator' || userRole.role.name=='director'}">
    ...
    Manage All Subjects in <c:out value="${study.name}"/>
    
<a href="javascript:openDocWindow('help/2_1_viewAllSubjects_Help.html')"><img src="images/bt_Help_Manage.gif" border="0" alt="Help" title="Help"></a></span></h1>
   </c:when>
   <c:otherwise>
