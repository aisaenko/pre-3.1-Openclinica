...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 <tr>
  ...
  <tr valign="top">              
    <td class="table_cell" colspan="4"><a href="nullValue.htm" target="def_win" onClick="openDefWindow('nullValue.htm'); return false;">Null Values</a>:<c:out value="${edc.nullValues}"/></td> 
   </tr>
