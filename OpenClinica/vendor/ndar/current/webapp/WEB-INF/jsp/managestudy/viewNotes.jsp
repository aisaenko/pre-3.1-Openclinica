...
<tr id="sidebar_Instructions_open" style="display: all">
		...
		<div class="sidebar_tab_content">
		 ...
		 The section allows a Study Manager to view and resolve discrepancy notes, which are generated during the course of data collection and data entry. 
		 <br><br>The screen will list all discrepancy notes that have been created for a given study. 
		 <br><br>You may click on the action icons to view, annotate and/or resolve these notes. 
		 <br><br>To view only 'Open' or 'Resolved' notes, please enter the appropriate status keyword in the search box. You should disable pop-up blocking to enable discrepancy note annotation and resolution.
