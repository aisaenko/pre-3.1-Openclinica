...
<tr id="sidebar_Instructions_open" style="display: all">
    ...
    Please select users in the following table. Checkbox will be available in the "Selected" column
if the user doesn't have a role in your current study, otherwise the user is marked as "assigned".
...
<h1><span class="title_manage">Assign Users to Current Study <c:out value="${study.name}"/></span></h1>
...
<br>
<p><input type="submit" name="Submit" value="Submit" class="button_medium"></p>
				...
				<!-- These DIVs define shaded box borders -->
						<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
							...
							<span class="title_manage">				
							  ...
							  <b>Assign Users to Current Study</b>					
