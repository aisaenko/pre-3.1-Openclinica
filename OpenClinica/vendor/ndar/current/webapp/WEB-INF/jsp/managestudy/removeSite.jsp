...
Confirm Removal of Site</span></h1>

<p>You choose to remove the following site:</p>
...
<form action='RemoveSite?action=submit&id=<c:out value="${siteToRemove.id}"/>' method="POST">
 <input type="submit" name="submit" value="Remove Site" class="button_long" onClick='return confirm("If you remove this site, all the data and subjects in this site will be unavailable. The site can be restored by a study director. Are you sure you want to remove it?");'>
</form>
