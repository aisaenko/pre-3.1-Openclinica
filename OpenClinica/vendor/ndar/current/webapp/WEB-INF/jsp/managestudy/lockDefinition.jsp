...
<h1><span class="title_manage">Confirm Locking Event Definition </span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">  
 ...
 <tr valign="top"><td class="table_header_column">Repeating:</td><td class="table_cell">
  <c:choose>
   <c:when test="${definitionToLock.repeating == true}"> Yes </c:when>
...
<input type="submit" name="submit" value="Lock Event Definition" class="button_xlong" onclick="return confirm('If you lock this definition, all the data and subjects will be locked. The definition can only be unlocked by System Administrator. Are you sure you want to lock it?');" />
</form>
