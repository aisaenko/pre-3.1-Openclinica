...
<tr id="sidebar_Instructions_open" style="display: none">
        ...
        Confirm restoration of this group template to Study/Site <c:out value="${study.name}"/>.
		</div>
...
<h1><span class="title_manage">Confirm to Restore a Group Template</span></h1>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">   
 ...
 <form action='RestoreSubjectGroupClass?action=submit&id=<c:out value="${group.id}"/>' method="POST">
    <input type="submit" name="submit" value="Restore Group Template" class="button_xlong" onClick='return confirm("If you restore this subject group class, all the associated subjects will be restored from this group class as well. Are you sure you want to restore it?");'>
 </form> 
</form>
