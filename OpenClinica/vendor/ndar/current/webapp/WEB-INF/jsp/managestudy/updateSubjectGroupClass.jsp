...
<h1><span class="title_manage">Update a Group Template</span></h1>
...
<br> 
 Group Template: <br />
 1.Duration and ideal time are required if you choose an event for the group template.
 <br />2.Status column indicates if an event is availabe in the current template. 
   <br />&nbsp;&nbsp;An 'available' event can be removed if you unselect it.
   <br />&nbsp;&nbsp;A 'removed' event can be restored if you select it.
   <br />&nbsp;&nbsp;A 'new' event, which is not in the current template yet, can be added if you select it.
 <!-- These DIVs define shaded box borders -->
<div style="width: 600px">
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">  
   ...
   <c:forEach var="def" items="${availableTempDefs}">
     <tr valign="top">    
    ...
    <td class="table_cell">
     <c:choose>      
      <c:when test="${def.status.name=='unavailable'}">
       new
      </c:when>
      <c:otherwise>
       <c:out value="${def.status.name}"/>
      </c:otherwise>
     </c:choose> 
    </td>
