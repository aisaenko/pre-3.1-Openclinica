...
Confirm Removal of CRF Version</span></h1>

<p>You choose to remove the following CRF Version:</p>
...
<form action='RemoveCRFVersion?action=submit&id=<c:out value="${versionToRemove.id}"/>' method="POST">
 <input type="submit" name="submit" value="Remove CRF Version" class="button_xlong" onClick='return confirm("If you remove this CRF Version, all the assigned uses of the CRF Version and any data entered using it will be removed as well. Are you sure you want to remove it?");'>
</form>
