      ...
      <td class="table_cell">
       <table border="0" cellpadding="0" cellspacing="0">
        ...
        <td><a href="InitCreateCRFVersion?crfId=<c:out value="${currRow.bean.id}"/>&name=<c:out value="${currRow.bean.name}"/>"
			onMouseDown="setImage('bt_NewVersion1','images/bt_NewVersion_d.gif');"
			onMouseUp="setImage('bt_NewVersion1','images/bt_NewVersion.gif');"><img 
    ...
    <td class="table_cell">
      ...
      <c:when test="${version.downloadable}">
        <a href="DownloadVersionSpreadSheet?crfId=<c:out value="${currRow.bean.id}"/>&crfVersionName=<c:out value="${version.name}"/>"
			onMouseDown="setImage('bt_Download1','images/bt_Download_d.gif');"
			onMouseUp="setImage('bt_Download1','images/bt_Download.gif');"><img 
       ...
       <td><a href="RemoveCRFVersion?action=confirm&id=<c:out value="${version.id}"/>"
		...
		<c:otherwise>
		 <td><a href="RestoreCRFVersion?action=confirm&id=<c:out value="${version.id}"/>"
			onMouseDown="setImage('bt_Restor1','images/bt_Restore_d.gif');"
			onMouseUp="setImage('bt_Restore1','images/bt_Restore.gif');"><img 
