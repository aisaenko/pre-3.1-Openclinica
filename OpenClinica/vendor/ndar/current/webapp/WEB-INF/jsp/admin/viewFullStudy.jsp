...
<a href="javascript:leftnavExpand('overview');setImage('ExpandGroup1','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('sectiona');setImage('ExpandGroup2','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('sectionb');setImage('ExpandGroup3','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('sectionc');setImage('ExpandGroup4','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('sectiond');setImage('ExpandGroup5','images/bt_Collapse.gif');"><img 
...
<br>
 ...
 <a href="javascript:leftnavExpand('sectione');setImage('ExpandGroup6','images/bt_Collapse.gif');"><img 
...
<br>
<a href="javascript:leftnavExpand('sectionf');setImage('ExpandGroup7','images/bt_Collapse.gif');"><img 
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">  
 ...
 <tr valign="top"><td class="table_header_column">When rescheduling an event, if it causes events to exceed scheduling window, how do you want to reschedule it?:</td>
 <td class="table_cell">
   <c:choose>
   <c:when test="${studyToView.studyParameterConfig.reschedule == 'reschedule based on first event'}">
    Based on the first event   
   </c:when>    
   <c:otherwise>
    Based on the previous event
   </c:otherwise>
  </c:choose>
  </td>
  </tr>
  
 <tr valign="top"><td class="table_header_column">Show Person ID on CRF Header?:</td>
   <td class="table_cell">
   <c:choose>
  ...
  <tr valign="top"><td class="table_header_column">Assessment Date Required?:</td>
  <td class="table_cell">
   <c:choose>
  ...
  <tr valign="top"><td class="table_header_column">Assessment Date Default as Blank?:</td>
  <td class="table_cell">
   <c:choose>
  ...
  <tr valign="top"><td class="table_header_column">Assessment Date Editable?:</td>
  <td class="table_cell">
   <c:choose>
...
<br>
 <a href="javascript:leftnavExpand('sites');setImage('ExpandGroup7','images/bt_Collapse.gif');"><img 
...
<br>
 ...
 <a href="javascript:leftnavExpand('definitions');setImage('ExpandGroup8','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('subjects');setImage('ExpandGroup9','images/bt_Collapse.gif');"><img 
...
<a href="javascript:leftnavExpand('users');setImage('ExpandGroup10','images/bt_Collapse.gif');"><img 
