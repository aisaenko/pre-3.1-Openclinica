...
<h1><span class="title_Admin">Administer Subjects <a href="javascript:openDocWindow('help/5_2_administerSubjects_Help.html')"><img src="images/bt_Help_Admin.gif" border="0" alt="Help" title="Help"></a></span></h1>
