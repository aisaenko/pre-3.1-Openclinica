...
</c:choose>Confirm Restore of CRF Version</span></h1>

<p>You choose to restore the following CRF Version:</p>
...
</c:choose>Associated Event CRFs</span>
<div style="width: 600px">
<div class="box_T"><div class="box_L"><div class="box_R"><div class="box_B"><div class="box_TL"><div class="box_TR"><div class="box_BL"><div class="box_BR">
...
<form action='RestoreCRFVersion?action=submit&id=<c:out value="${versionToRestore.id}"/>' method="POST">
 <input type="submit" name="submit" value="Restore CRF Version" class="button_xlong" onClick='return confirm("If you Restore this CRF Version, all the assigned uses of the CRF Version and any data entered using it will be Restored as well. Are you sure you want to restore it?");'>
</form>
