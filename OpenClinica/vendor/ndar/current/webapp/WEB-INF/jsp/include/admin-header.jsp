						 ...
						 <c:set var="roleName" value="${userRole.role.name}"/>
                           ...
                           <c:if test="${roleName=='coordinator' || roleName=='director' || roleName=='ra' || roleName=='investigator'}">
							...
							<td><a href="AdminSystem"
							   onMouseOver="setImage('nav_Administer','images/nav_BizAdmin_s_h.gif');"
							   onMouseOut="setImage('nav_BizAdmin','images/nav_BizAdmin_s.gif');"><img 
					...
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td><a href="ListUserAccounts"
							   onMouseOver="setImage('subnav_Admin_Users','images/subnav_Admin_Users_h.gif');"
							   onMouseOut="setImage('subnav_Admin_Users','images/subnav_Admin_Users.gif');"><img 
							   name="subnav_Admin_Users" src="images/subnav_Admin_Users.gif" border="0" alt="Users" title="Users"></a></td>
							<td><a href="ListSubject"
							   onMouseOver="setImage('subnav_Admin_Subjects','images/subnav_Admin_Subjects_h.gif');"
							   onMouseOut="setImage('subnav_Admin_Subjects','images/subnav_Admin_Subjects.gif');"><img 
							   name="subnav_Admin_Subjects" src="images/subnav_Admin_Subjects.gif" border="0" alt="Subjects" title="Subjects"></a></td>
							<td><a href="ListStudy"
							   onMouseOver="setImage('subnav_Admin_Studies','images/subnav_Admin_Studies_h.gif');"
							   onMouseOut="setImage('subnav_Admin_Studies','images/subnav_Admin_Studies.gif');"><img 
							   name="subnav_Admin_Studies" src="images/subnav_Admin_Studies.gif" border="0" alt="Studies" title="Studies"></a></td>
							<td><a href="ListCRF"
							   onMouseOver="setImage('subnav_Admin_CRFs','images/subnav_Admin_CRFs_h.gif');"
							   onMouseOut="setImage('subnav_Admin_CRFs','images/subnav_Admin_CRFs.gif');"><img 
