 ...
 <c:if test="${userBean != null && userBean.id>0}">	 
  <c:choose>
	...
	<tr id="sidebar_Alerts_open" style="display: all">
		...
		<a href="javascript:leftnavExpand('sidebar_Alerts_open'); leftnavExpand('sidebar_Alerts_closed');"><img src="images/sidebar_collapse.gif" border="0" align="right" hspace="10" alt="-" title=""></a>
	...
	<tr id="sidebar_Alerts_closed" style="display: none">
		...
		<a href="javascript:leftnavExpand('sidebar_Alerts_open'); leftnavExpand('sidebar_Alerts_closed');"><img src="images/sidebar_expand.gif" border="0" align="right" hspace="10" alt="v" title=""></a>
