...
public class StudyParameterConfig implements Serializable {
  ...
  private String genderRequired;// required, or not used
  ...
  private String reschedule;//used If any event reschedule causes events to exceed scheduling window
  ...
  public StudyParameterConfig() {
    ...
    reschedule = "reschedule based on first event"; 
