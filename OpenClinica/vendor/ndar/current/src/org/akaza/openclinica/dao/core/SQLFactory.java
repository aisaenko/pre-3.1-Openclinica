...
public class SQLFactory {
  ...
  public final String DAO_STUDYTEMPLATE = "study_template";
  ...
  public final String DAO_SKIPRULE = "skip_rule";
  
  public final String DAO_SUBJECT_ENTRY_LABEL = "subjectentrylabel";
  
  public final String DAO_SUBJECT_LABEL_MAP = "subject_label_map";
  
  public final String DAO_VERSIONING_MAP = "versioning_map";
  
  public final String DAO_RESPONSE_SET = "response_set";
  
  public final String DAO_STUDY_PARAMETER="study_parameter";
  
  public final String DAO_STUDY_TEMPLATE_EVENT_DEF="study_template_event_def";
  
  public final String DAO_FORM_USAGE_COUNT="form_usage_count";
  
  public final String DAO_SCORE_USAGE_COUNT="score_usage_count";
  
  public final String DAO_SCORE_USAGE_COUNT_DETAIL="score_usage_count_detail";
  
  public final String DAO_PUBLISHER="publisher";
  
  public final String DAO_TABLE = "table";
  ...
  public void run(String dbName) {
    ...
    if ("oracle".equals(dbName)) {
    	...
    	fileList.put(this.DAO_STUDYTEMPLATE, "oracle_study_template_dao.xml");
        ...
        fileList.put(this.DAO_SKIPRULE, "oracle_skip_rule_dao.xml");
        fileList.put(this.DAO_STUDY_PARAMETER, "oracle_study_parameter_value_dao.xml");
        
        //no xml for postgres yet- 01/22/07
        fileList.put(this.DAO_STUDY_TEMPLATE_EVENT_DEF, "oracle_study_template_event_def_dao.xml");
        
        fileList.put(this.DAO_SUBJECT_ENTRY_LABEL, "oracle_subject_entry_label_dao.xml");
        
        fileList.put(this.DAO_SUBJECT_LABEL_MAP, "oracle_subject_label_map_dao.xml");
        
        fileList.put(this.DAO_RESPONSE_SET, "oracle_response_set_dao.xml");
        
        fileList.put(this.DAO_VERSIONING_MAP, "oracle_versioning_map_dao.xml");
        
        fileList.put(this.DAO_FORM_USAGE_COUNT, "oracle_form_usage_count_dao.xml");
        
        fileList.put(this.DAO_SCORE_USAGE_COUNT, "oracle_score_usage_count_dao.xml");
        
        fileList.put(this.DAO_SCORE_USAGE_COUNT_DETAIL, "oracle_score_usage_count_detail_dao.xml");
        
        fileList.put(this.DAO_PUBLISHER, "oracle_publisher_dao.xml");
        
        fileList.put(this.DAO_TABLE, "oracle_table_score_dao.xml");
    	...
    	fileList.put(this.DAO_STUDYTEMPLATE, "study_template_dao.xml");
        ...
        // Adds the rule_dao.xml to the dao file list.
        fileList.put(this.DAO_SKIPRULE, "skip_rule_dao.xml");
        fileList.put(this.DAO_STUDY_PARAMETER, "study_parameter_value_dao.xml");
        
        fileList.put(this.DAO_SUBJECT_ENTRY_LABEL, "subject_entry_label_dao.xml");
        
        fileList.put(this.DAO_SUBJECT_LABEL_MAP, "subject_label_map_dao.xml");
        
        fileList.put(this.DAO_RESPONSE_SET, "response_set_dao.xml");
        
        fileList.put(this.DAO_VERSIONING_MAP, "versioning_map_dao.xml");
        
        fileList.put(this.DAO_TABLE, "table_score_dao.xml");
