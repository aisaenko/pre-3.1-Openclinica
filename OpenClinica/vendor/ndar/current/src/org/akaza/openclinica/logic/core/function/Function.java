...
/**
 * The Function defines the interface for the calculation, 
 * which includes operator, fields and sub functions.
 * 
 * @author Hailong Wang
 * @version 1.0
 * @since 08/21/2006
...
public interface Function {
    /**
     * @return the value which was calculated out by this function
    ...
    /**
     * @param arguments the argument list for the function.
     */
     ...
     *
     * @param map   the map of item id and item value.
     */
