...
public class StudyEventAuditBean {
  ...
  private SummaryDataEntryStatus oldSummaryDataEntryStatus;
  private SummaryDataEntryStatus newSummaryDataEntryStatus;
  ...
  /**
   * @param newSubjectEventStatus The newSubjectEventStatus to set.
   */
  ...
  /**
   * @param oldSubjectEventStatus The oldSubjectEventStatus to set.
   */
  ...
  /**
   * @return the newSummaryDataEntryStatus
   */
  public SummaryDataEntryStatus getNewSummaryDataEntryStatus() {
	return newSummaryDataEntryStatus;
  }
  /**
   * @param newSummaryDataEntryStatus the newSummaryDataEntryStatus to set
   */
  public void setNewSummaryDataEntryStatus(SummaryDataEntryStatus newSummaryDataEntryStatus) {
	this.newSummaryDataEntryStatus = newSummaryDataEntryStatus;
  }
  /**
   * @return the oldSummaryDataEntryStatus
   */
  public SummaryDataEntryStatus getOldSummaryDataEntryStatus() {
	return oldSummaryDataEntryStatus;
  }
  /**
   * @param oldSummaryDataEntryStatus the oldSummaryDataEntryStatus to set
   */
  public void setOldSummaryDataEntryStatus(SummaryDataEntryStatus oldSummaryDataEntryStatus) {
	this.oldSummaryDataEntryStatus = oldSummaryDataEntryStatus;
  }
}
