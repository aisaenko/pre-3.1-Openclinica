...
public class Page {
  ...
  public final static Page LOGIN_USER_ACCOUNT_DELETED = new Page("/WEB-INF/jsp/login/login.jsp" + "?action=userAccountDeleted", "Unsuccessful Login Due to Account Deletion");
  ...
  public final static Page LIST_SUBJECT_ENTRY_LABELS = new Page("/WEB-INF/jsp/subjectmgmt/listSubjectEntryLabels.jsp", "List subject entry labels");
  public final static Page LIST_SUBJECT_ENTRY_LABELS_SERVLET = new Page("/ListSubjectEntryLabels", "List subject entry labels");
  
  public final static Page CREATE_SUBJECT_ENTRY_LABEL = new Page("/WEB-INF/jsp/subjectmgmt/createSubjectEntryLabel.jsp", "Create a subject entry label");
  public final static Page CREATE_SUBJECT_ENTRY_LABEL_SERVLET = new Page("/CreateSubjectEntryLabel", "Create a subject entry label");
  
  /**
   * Page for editing a subject entry label, and confirmation page.
   */
  public final static Page EDIT_SUBJECT_ENTRY_LABEL = new Page("/WEB-INF/jsp/subjectmgmt/editSubjectEntryLabel.jsp", "Edit a subject entry label");
  public final static Page EDIT_SUBJECT_ENTRY_LABEL_CONFIRM = new Page("/WEB-INF/jsp/subjectmgmt/editSubjectEntryLabelConfirm.jsp", "Edit a subject entry label");
  
  /**
   * Page for editing a subject, and confirmation page.
   */
  public final static Page EDIT_SUBJECT = new Page("/WEB-INF/jsp/subjectmgmt/editSubject.jsp", "Edit a subject");
  public final static Page EDIT_SUBJECT_CONFIRM = new Page("/WEB-INF/jsp/subjectmgmt/editSubjectConfirm.jsp", "Edit a subject");
  
  /**
   * Page for viewing a subject entry label, and confirmation page.
   */
  public final static Page VIEW_SUBJECT_ENTRY_LABEL = new Page("/WEB-INF/jsp/subjectmgmt/viewSubjectEntryLabel.jsp", "View subject entry label");
  public final static Page VIEW_SUBJECT_ENTRY_LABEL_SERVLET = new Page("/viewSubjectEntryLabel", "View subject entry label");
  ...
  public final static Page CREATE_SUBJECT_GROUP_CLASS_CONFIRM= new Page("/WEB-INF/jsp/managestudy/createSubjectGroupClassConfirm.jsp", "Create Subject Group Class Confirm");
  ...
  public final static Page UPDATE_SUBJECT_GROUP_CLASS_CONFIRM= new Page("/WEB-INF/jsp/managestudy/updateSubjectGroupClassConfirm.jsp", "Update Subject Group Class Confirm");
  ...
  public final static Page UPDATE_EVENT_DEFINITION_CONFIRM = new Page("/WEB-INF/jsp/managestudy/updateEventDefinitionConfirm.jsp", "Update Event Definition Confirm");
  ...
  public final static Page CREATE_CRF_VERSION_CONFIRMSQL = new Page("/WEB-INF/jsp/admin/createCRFVersionConfirmSQL.jsp", "Create a new CRF Version Confirm SQL");
  ...
  public final static Page CREATE_CRF_VERSION_NODELETE = new Page("/WEB-INF/jsp/admin/createCRFVersionNoDelete.jsp", "Create a new CRF cannot delete version");
  ...
  public final static Page SUBJECT_MGMT = new Page(path + "subjectmgmt/index.jsp", "Subject Management Menu");
  
  
  public final static Page SUBMIT_DATA = new Page(path + "submit/index.jsp", "Submit Data Menu");
//  public final static Page SUBMIT_DATA_SERVLET = new Page("/SubmitData", "Submit Data Menu");
  ...
  public final static Page ADD_NEW_SUBJECT_WITH_PII = new Page(path + "submit/addNewSubjectWithPii.jsp", "Enroll A New Subject With Pii");
  
  public final static Page INSTRUCTIONS_ENROLL_SUBJECT_SERVLET = new Page("/AddNewSubject?instr=1", "Enroll New Subject Servlet");

  public final static Page INSTRUCTIONS_ENROLL_PII_SUBJECT = new Page(path + "submit/instructionsEnrollSubject.jsp", "Enroll New Subject - Instructions");
  public final static Page ADD_NEW_PII_SUBJECT = new Page(path + "admin/addNewPiiSubject.jsp", "Enroll New Subject");
  public final static Page ADD_NEW_PII_SUBJECT_USING_WS = new Page(path + "admin/addNewPiiSubjectUsingWS.jsp", "Enroll New Subject");
  public final static Page ADD_EXISTING_PII_SUBJECT = new Page(path + "submit/addExistingSubject.jsp", "Enroll An Existing Subject");
  
  public final static Page ADD_PII_SUBJECT_SERVLET = new Page("/AddNewPiiSubject", "Add New PII Subject Servlet");
  public final static Page LIST_PII_SUBJECT_SERVLET = new Page("/ListPiiSubject", "List PII Subject Servlet");
  public final static Page VIEW_PII_SUBJECT=new Page(path + "admin/viewPiiSubject.jsp", "View PII Subject");
  public final static Page VIEW_PII_SUBJECT_SERVLET=new Page("/ViewPiiSubject", "View PII Subject Servlet");
  public final static Page INSTRUCTIONS_ENROLL_PII_SUBJECT_SERVLET = new Page("/AddNewPiiSubject?instr=1", "Enroll New Subject Servlet");
  ...
  public final static Page ASSESSMENT_INFO = new Page(path + "submit/assessmentInfo.jsp", "Assessment Info Page");
  ...
  public final static Page ASSIGN_STUDY_SUBJECT=new Page(path + "managestudy/assignStudySubject.jsp", "assign a subject");
  public final static Page ASSIGN_STUDY_SUBJECT_CONFIRM=new Page(path + "managestudy/assignStudySubjectConfirm.jsp", "confirm assign a subject");
  public final static Page ASSIGN_PII_SUBJECT=new Page(path + "admin/assignPiiSubject.jsp", "assign a subject");
  public final static Page ASSIGN_PII_SUBJECT_CONFIRM=new Page(path + "admin/assignPiiSubjectConfirm.jsp", "confirm assign a subject");
   ...
   */
  public final static Page PII_SUBJECT_LIST = new Page("/WEB-INF/jsp/admin/listPiiSubject.jsp", "List all PII Subjects");
  public final static Page PII_SUBJECT_LIST_SERVLET = new Page("/ListPiiSubject", "List all PII subjects servlet");
  ...
  public final static Page DELETE_DISCREPANCY_NOTE_DONE = new Page("/WEB-INF/jsp/submit/deleteDiscrepancyNoteDone.jsp", "Delete Discrepancy Note Done");
  ...
  public final static Page VIEW_DISCREPANCY_NOTES_IN_STUDY_PRINT = new Page("/WEB-INF/jsp/managestudy/viewNotesPrint.jsp", "View Discrepancy Notes in Study Print");
  ...
  public final static Page UPLOAD_DATA_FILE = new Page("/WEB-INF/jsp/techadmin/uploadDataFile.jsp", "Upload Data File");
  ...
  /**
   * Creates a new Page object with a customized filename
   * @param newFileName the new customized filename
   * @return a new Page object
   */
  public Page cloneWithNewFileName(String newFileName) {
	return new Page(newFileName, this.title);
  }
