...
public class RemoveEventCRFServlet extends SecureController {
  ...
  public void processRequest() throws Exception {
    ...
    if (eventCRFId == 0) {
      addPageMessage("Please choose an Event CRF to remove.");
      ...
      if ("confirm".equalsIgnoreCase(action)) {
        if (eventCRF.getStatus().equals(Status.DELETED)) {
          addPageMessage("This event CRF is removed for this study."
        ...
        String emailBody = "The Event CRF " + cb.getName() + " has been removed from the Event "
  ...
  private void sendEmail(String emailBody) throws Exception {
    ...
    try {
      ...
      //to study director
      em.process(ub.getEmail().trim(), EmailEngine.getAdminEmail(), "Remove Event CRF from Event",
          emailBody);
      ...
      em.process(EmailEngine.getAdminEmail(), EmailEngine.getAdminEmail(),
          "Remove Event CRF From Event", emailBody);
