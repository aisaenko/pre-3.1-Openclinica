...
public class ResponseSetDAO extends AuditableEntityDAO {
    public ResponseSetDAO(DataSource ds) {
        super(ds);
      }

      public ResponseSetDAO(DataSource ds, DAODigester digester) {
        super(ds);
    ...
    protected void setDigesterName() {
        digesterName = SQLFactory.getInstance().DAO_RESPONSE_SET;
    }
