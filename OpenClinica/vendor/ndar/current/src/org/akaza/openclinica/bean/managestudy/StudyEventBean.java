...
public class StudyEventBean extends AuditableEntityBean {
  ...
  private int studyTemplateEventDefId;
  ...
  private SummaryDataEntryStatus summaryDataEntryStatus;
  ...
  /**
   * @return the studyTemplateEventDefId
   */
  public int getStudyTemplateEventDefId() {
	return studyTemplateEventDefId;
  }
  /**
   * @param studyTemplateEventDefId the studyTemplateEventDefId to set
   */
  public void setStudyTemplateEventDefId(int studyTemplateEventDefId) {
	this.studyTemplateEventDefId = studyTemplateEventDefId;
  }
  /**
   * @return the summaryDataEntryStatus
   */
  public SummaryDataEntryStatus getSummaryDataEntryStatus() {
	return summaryDataEntryStatus;
  }
  /**
   * @param summaryDataEntryStatus the summaryDataEntryStatus to set
   */
  public void setSummaryDataEntryStatus(SummaryDataEntryStatus summaryDataEntryStatus) {
	this.summaryDataEntryStatus = summaryDataEntryStatus;
  }
  /**
  ...
  /**
   * @param repeatingNum The repeatingNum to set.
   */
  ...
  /**
   * @param studySubjectLabel The studySubjectLabel to set.
   */
  ...
  public StudyEventBean() {
    ...
    summaryDataEntryStatus = SummaryDataEntryStatus.NOT_STARTED;
  }
  ...
  /**
   * @param scheduledDatePast The scheduledDatePast to set.
   */
