...
public class ItemFormMetadataDAO extends EntityDAO {
  ...
  public List findAllByCRFVersionIdAndResponseTypeId(int crfVersionId, int responseTypeId) throws OpenClinicaException {
    ArrayList answer = new ArrayList();
  ...
  public ArrayList findAllByItemId(int itemId){
    ...
    this.setTypesExpected();
    this.setTypeExpected(24,TypeNames.STRING);//version name
    HashMap variables = new HashMap();
