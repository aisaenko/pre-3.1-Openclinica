						...
						<tr>
							...
							<table border="0" cellpadding="0" cellspacing="0">
								<tr>
                                    ...
                                    <td>
                                         <a href="AuditLogStudy"
									   onMouseOver="javascript:setImage('subnav_Manage_ViewAudits','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ViewAudits_h.gif');"
									   onMouseOut="javascript:setImage('subnav_Manage_ViewAudits','images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ViewAudits.gif');"><img
									   name="subnav_Manage_ViewAudits" src="images/<fmt:message key="image_dir" bundle="${resformat}"/>/subnav_Manage_ViewAudits.gif" border="0" alt="<fmt:message key="view_study_audit_log" bundle="${resword}"/>" title="<fmt:message key="view_study_audit_log" bundle="${resword}"/>"></a>
                                       </td>
                                </tr>
							</table>
							</td>
