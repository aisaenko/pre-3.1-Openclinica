...
public class UpdateStudyEventServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
        ...
        for(int i = 0; i < eventCrfs.size(); i++){
            ...
            EventDefinitionCRFBean edcBean = edcdao.findByStudyEventIdAndCRFVersionId(studyEventId, ecrf.getCRFVersionId());
...
//-------------------
                ...
                //EventDefinitionCRFDAO edcdao = new EventDefinitionCRFDAO(sm.getDataSource());
                ArrayList eventDefinitionCRFs = edcdao.findAllActiveByEventDefinitionId(studyEvent.getStudyEventDefinitionId());
                ...
                ArrayList displayEventCRFs =
                  ViewStudySubjectServlet.getDisplayEventCRFs(sm.getDataSource(), eventCRFs, eventDefinitionCRFs, ub, currentRole, studyEvent.getSubjectEventStatus());
                ...
                //Don't filter for res status or disc note type; disc note beans are returned with eventCRFId set
        ...
        }else if(action.equalsIgnoreCase("confirm")){//confirming the signed status
