    ...
    public void addNodeClinicalData() {
        ...
        for (ExportSubjectDataBean sub : subs) {
            ...
            if ("oc1.2".equalsIgnoreCase(ODMVersion) || "oc1.3".equalsIgnoreCase(ODMVersion)) {
                ...
                if (sub.getAgeAtEvent() != null) {
                    xml.append("\" OpenClinica:AgeAtEvent=\"" + sub.getAgeAtEvent());
                }
                ...
                if (sub.getSubjectGender() != null) {
                    xml.append("\" OpenClinica:Gender=\"" + sub.getSubjectGender());
                }
            }
            xml.append("\">");
            xml.append(nls);
            //
            ArrayList<ExportStudyEventDataBean> ses = sub.getExportStudyEventData();
