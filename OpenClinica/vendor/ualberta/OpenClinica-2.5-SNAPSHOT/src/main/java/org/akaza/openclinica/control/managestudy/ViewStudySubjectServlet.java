...
public class ViewStudySubjectServlet extends SecureController {
    //The study subject has an existing discrepancy note related to their unique identifier; this
    //value will be saved as a request attribute
    public final static String HAS_UNIQUE_ID_NOTE = "hasUniqueIDNote";
    //The study subject has an existing discrepancy note related to their date of birth; this
    //value will be saved as a request attribute
    public final static String HAS_DOB_NOTE = "hasDOBNote";
    //The study subject has an existing discrepancy note related to their Gender; this
    //value will be saved as a request attribute
    public final static String HAS_GENDER_NOTE = "hasGenderNote";
    //The study subject has an existing discrepancy note related to their Enrollment Date; this
    //value will be saved as a request attribute
    ...
    public void mayProceed() throws InsufficientPermissionException {
        //YW 10-18-2007, if a study subject with passing parameter does not belong to user's studies, it can not be viewed
        mayAccess();
    ...
    public void processRequest() throws Exception {
        ...
        if (studySubId == 0) {
            ...
            //study ID, then its study ID may be different than the study subject's ID.
            ...
            if(subjectStudyIsCurrentStudy && isParentStudy) {
                ...
                if(! isParentStudy) {
                    StudyBean stParent = (StudyBean) studydao.findByPK(study.getParentStudyId());
                     allNotesforSubject = discrepancyNoteDAO.findAllSubjectByStudiesAndSubjectId(
                      stParent,study,subjectId);
    ...
    */
    ...
    private void addDiscrepancyNotesFromChildStudies(List<DiscrepancyNoteBean> discBeans,
                                                     int parentStudyId,
                                                     int subjectId,
                                                     int studySubId,
                                                     StudyDAO studyDAO,
        ...
        ArrayList<StudyBean> childStudies =
          (ArrayList) studyDAO.findAllByParent(parentStudyId);
