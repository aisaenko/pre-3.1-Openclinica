...
public class ViewDiscrepancyNoteServlet extends SecureController {
    ...
    */
    ...
    protected void processRequest() throws Exception {
        ...
        HashMap<Integer,DiscrepancyNoteBean> noteTree = new
          HashMap<Integer,DiscrepancyNoteBean>();
    ...
    /**
     * Update a parent DiscrepancyNoteBean's resolution status and updated date to that of the
     * latest child DiscrepancyNoteBean.
     * @param noteTree  A HashMap of an Integer representing the DiscrepancyNoteBean,
