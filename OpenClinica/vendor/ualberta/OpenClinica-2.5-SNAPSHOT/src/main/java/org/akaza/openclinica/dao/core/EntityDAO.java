...
public abstract class EntityDAO implements DAOInterface {
    ...
    public ArrayList selectStudySubjects(int studyid, int parentid, String sedin, String it_in, String dateConstraint) {
        clearSignals();
        String query = getSQLSubjectStudySubjectDataset(studyid, parentid, sedin, it_in, dateConstraint, SQLInitServlet.getDBName());
    ...
    protected String getSQLSubjectStudySubjectDataset(int studyid, int studyparentid, String sedin, String it_in, String dateConstraint, String databaseName) {
        /**
         * 
         * SELECT
         * 
        ...
        if ("oracle".equalsIgnoreCase(SQLInitServlet.getDBName())) {
            ...
            return "SELECT distinct study_subject.study_subject_id , study_subject.label,  study_subject.subject_id, "
                ...
                + "SELECT DISTINCT studysubjectid FROM " + "( " + getSQLDatasetBASE_EVENTSIDE(studyid, studyparentid, sedin, it_in, dateConstraint)
                + " ) SBQTWO " + "  ) order by study_subject.study_subject_id";
            /*
            ...
            return " SELECT   " + " DISTINCT ON (study_subject.study_subject_id ) "
                ...
                + getSQLDatasetBASE_EVENTSIDE(studyid, studyparentid, sedin, it_in, dateConstraint) + " ) AS SBQTWO " + "  ) ";
    ...
    public boolean loadBASE_ITEMGROUPSIDEHashMap(int studyid, int parentid, String sedin, String it_in, ExtractBean eb) {
        ...
        String query = getSQLDatasetBASE_ITEMGROUPSIDE(studyid, parentid, sedin, it_in, genDatabaseDateConstraint(eb));
        // YW, 09-2008 >>
     ...
     * @return
     */
    protected String getSQLDatasetBASE_EVENTSIDE(int studyid, int studyparentid, String sedin, String it_in, String dateConstraint) {
        ...
        if ("oracle".equalsIgnoreCase(SQLInitServlet.getDBName())) {
            return " SELECT  "
                ...
                + " 	JOIN crf_version  ON event_crf.crf_version_id = crf_version.crf_version_id and (event_crf.status_id = 2 OR event_crf.status_id = 6) "
                ...
                + " 									   AND "
                + " 										(event_crf.status_id = 2  OR event_crf.status_id = 6 ) "
                + " 									   ) "
                + " 					WHERE "
                + dateConstraint
                + " 					    AND "
                ...
                + " 	)  "
                + " 	AND  "
                + " 	(item_data.status_id = 2  OR item_data.status_id = 6 )  "
     ...
     * @return
     */
    protected String getSQLInKeyDatasetHelper(int studyid, int studyparentid, String sedin, String it_in, String dateConstraint) {
        /**
        ...
        if ("oracle".equalsIgnoreCase(SQLInitServlet.getDBName())) {
            return " 	SELECT DISTINCT  " + "	study_event.study_event_definition_id,  " + "	study_event.sample_ordinal,  " + "	crfv.crf_id,  "
                ...
                + " JOIN crf_version crfv ON ec.crf_version_id = crfv.crf_version_id AND (ec.status_id = 2 OR ec.status_id = 6)  "
                ...
                + getSQLDatasetBASE_EVENTSIDE(studyid, studyparentid, sedin, it_in, dateConstraint) + "	) SBQTWO " + " ) ";
    ...
    public HashMap setHashMapInKeysHelper(int studyid, int parentid, String sedin, String itin, String dateConstraint) {
        clearSignals();
        // YW, 09-2008, << modified syntax of sql for oracle database
        String query = getSQLInKeyDatasetHelper(studyid, parentid, sedin, itin, dateConstraint);
        // YW, 09-2008 >>
