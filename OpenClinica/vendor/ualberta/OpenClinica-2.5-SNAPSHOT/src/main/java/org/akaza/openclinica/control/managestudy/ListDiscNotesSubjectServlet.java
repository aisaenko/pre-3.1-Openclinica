    ...
    protected void processRequest() throws Exception {
        ...
        if(! (allDiscNotes == null || allDiscNotes.isEmpty())) {
            ...
            for (int i = 0; i < subjects.size(); i++) {
                ...
                //if currentStudy is a site (it has a parentStudyId > 0) then provide its identifier;
                //if currentStudy doesn;t have any sites, then you want to provide its
                //identifier anyways; so, just provide the currentStudy's identifier
                if(currentStudy != null){
                    dssb.setSiteName(currentStudy.getIdentifier());
                }
                //if the study subject bean does not have any DN's then do not add it to this list.
        ...
        //BWP 2837 <<
        columnArray.add(resword.getString("site_name"));
        //>>
