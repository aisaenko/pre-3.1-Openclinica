                        ...
                        if (dbName.equals("oracle")) {
                            ...
                            sql =
                                "INSERT INTO RESPONSE_SET (LABEL, OPTIONS_TEXT, OPTIONS_VALUES, " + "RESPONSE_TYPE_ID, VERSION_ID)" + " VALUES ('"
                                    + stripQuotes(responseLabel) + "', '" + stripQuotes(resOptions.replaceAll("\\\\,", "\\,")) + "','" + stripQuotes(resValues.replace("\\\\","\\")) + "',"
                        ...
                        if (dbName.equals("oracle")) {
                            sqlGroupLabel =
                                "INSERT INTO ITEM_GROUP_METADATA (" + "item_group_id,\"header\"," + "subheader, layout, repeat_number, repeat_max,"
                                    ...
                                    //+ "(SELECT MAX(ITEM_ID) FROM ITEM WHERE NAME='"
                                    //+ itemName + "' ),"
                                    + "(SELECT MAX(ITEM.ITEM_ID) FROM ITEM,ITEM_FORM_METADATA,CRF_VERSION WHERE ITEM.NAME='" + itemName + "' "
                            ...
                            sqlGroupLabel =
                                "INSERT INTO ITEM_GROUP_METADATA (" + "item_group_id,HEADER," + "subheader, layout, repeat_number, repeat_max,"
                                    ...
                                    + "" + "', '" + "" + "', '" + "" + "', " + 1 + ", " + 1 + ", '', 1," + versionIdString + ","
                                    //+ "(SELECT ITEM_ID FROM ITEM WHERE NAME='" + itemName + "' ORDER BY OID DESC LIMIT 1)," 
                                    + "(SELECT ITEM.ITEM_ID FROM ITEM,ITEM_FORM_METADATA,CRF_VERSION WHERE ITEM.NAME='" + itemName + "' "
                                    + "AND ITEM.ITEM_ID = ITEM_FORM_METADATA.ITEM_ID and ITEM_FORM_METADATA.CRF_VERSION_ID=CRF_VERSION.CRF_VERSION_ID "
                                    + "AND CRF_VERSION.CRF_ID= " + crfId + " ORDER BY ITEM.OID DESC LIMIT 1),"
                                    + k + ",0)";
                        }
