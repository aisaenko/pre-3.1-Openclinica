...
public class ViewRuleAssignmentFilter implements CriteriaCommand {
    ...
    public ViewRuleAssignmentFilter() {
        ...
        columnMapping.put("ruleType", "et.id");
    ...
    private String buildCriteria(String criteria, String property, Object value) {
        ...
        if (value != null) {
        	//@pgawade 09-Nov-2011 issue #11488
//            if (property.equals("studyId") || property.equals("actionType") || property.equals("actionExecuteOn") || property.equals("ruleSetRuleStatus")) {
        	  if (property.equals("studyId") || property.equals("actionType") || property.equals("actionExecuteOn") || property.equals("ruleSetRuleStatus") || property.equals("ruleType")) {
