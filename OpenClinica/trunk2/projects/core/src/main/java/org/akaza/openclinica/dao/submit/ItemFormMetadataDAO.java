 ...
 */
    ...
    public ArrayList findUniqueItemsForCrf(int crfId) throws OpenClinicaException {
        ...
        String sql = digester.getQuery("findUniqueItemsForCrf");
        ArrayList alist = this.select(sql, variables);
        Iterator it = alist.iterator();
    ...
    public ArrayList findCodingResponseOptionsForItem(int itemId) throws OpenClinicaException {
        ArrayList answer = new ArrayList<ItemFormMetadataBean>();
        ...
        String sql = digester.getQuery("findCodingResponseOptionsForItem");
        ArrayList alist = this.select(sql, variables);
        Iterator it = alist.iterator();
