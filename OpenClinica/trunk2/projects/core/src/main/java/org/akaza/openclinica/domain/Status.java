...
public enum Status implements CodedEnum {
    ...
    INVALID(0, "invalid"), AVAILABLE(1, "available"), UNAVAILABLE(2, "unavailable"), PRIVATE(3, "private"), PENDING(4, "pending"), DELETED(5, "removed"), LOCKED(
            ...
            NOT_CODED(11, "not-coded"), CODED(12, "coded"), MATCH_NOT_FOUND(13, "match-not-found"), CODE_APPROVED(14, "code-approved"), 
            //MULTIPLE_MATCHES(15, "multiple-matches");
            NO_EXACT_MATCH(15, "no-exact-match");
