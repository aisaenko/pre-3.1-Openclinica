...
public enum ActionType implements CodedEnum {
    ...
    FILE_DISCREPANCY_NOTE(1, "DiscrepancyNoteAction"), EMAIL(2, "EmailAction"), SHOW(3, "ShowAction"), INSERT(4, "InsertAction"), HIDE(5, "HideAction"), TRIGGER_AUTO_CODING(6, "TriggerAutoCodingAction");
