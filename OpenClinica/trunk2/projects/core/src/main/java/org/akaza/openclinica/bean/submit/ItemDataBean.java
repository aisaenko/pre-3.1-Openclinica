...
public class ItemDataBean extends AuditableEntityBean {
    ...
    private int codingStatusId;//@pgawade 26-Oct-2011 - added to support status of medical coding
	...
	public int getCodingStatusId() {
		return codingStatusId;
	}

	public void setCodingStatusId(int codingStatusId) {
