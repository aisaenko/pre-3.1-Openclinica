...
public class ListNotesSort implements CriteriaCommand {
    ...
    public ListNotesSort() {
        ...
        columnMapping.put("siteId", "site_id");
        columnMapping.put("eventName", "event_name");
        columnMapping.put("crfName", "crf_name");
        columnMapping.put("crfStatus", "crf_status");
        columnMapping.put("entityName", "entity_name");
