...
public class ResponseType extends Term {
    ...
    //@pgawade 4-Aug-2011 Added the new response type for medical codes
    public static final ResponseType MEDICAL_CODE = new ResponseType(11, "hidden-code");
...
//    private static final ResponseType[] members = { TEXT, TEXTAREA, CHECKBOX, FILE, RADIO, SELECT, SELECTMULTI, CALCULATION, GROUP_CALCULATION};// , CODING };
    private static final ResponseType[] members = { TEXT, TEXTAREA, CHECKBOX, FILE, RADIO, SELECT, SELECTMULTI, CALCULATION, GROUP_CALCULATION, MEDICAL_CODE};
