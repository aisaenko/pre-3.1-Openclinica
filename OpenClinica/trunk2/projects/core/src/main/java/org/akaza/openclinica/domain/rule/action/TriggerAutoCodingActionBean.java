...
public class TriggerAutoCodingActionBean extends RuleActionBean {

    private List<PropertyBean> properties;

    public TriggerAutoCodingActionBean() {
        setActionType(ActionType.TRIGGER_AUTO_CODING);
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TriggerAutoCodingActionBean other = (TriggerAutoCodingActionBean) obj;
        if (properties == null) {
