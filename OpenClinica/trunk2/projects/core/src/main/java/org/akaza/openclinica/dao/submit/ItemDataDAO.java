...
public class ItemDataDAO extends AuditableEntityDAO {
    ...
    public void setTypesExpected() {
       ...
       //@pgawade 27-Oct-2011 Updated to set value of newly added column coding_status_id
...
//    }
    ...
    public Object getEntityFromHashMap(HashMap hm) {
        ...
        //@pgawade 27-Oct-2011 Updated to set value of newly added column coding_status_id
        eb.setCodingStatusId(((Integer) hm.get("coding_status_id")).intValue());
        return eb;
    }
...
//        Map<String,String> nameMap = new HashMap<String,String>();
    	ArrayList<CodeItemData> codeData = new ArrayList<CodeItemData>();
        this.unsetTypeExpected();
        this.setTypeExpected(1, TypeNames.INT);//study_subject_id
        this.setTypeExpected(2, TypeNames.STRING);//event
        this.setTypeExpected(3, TypeNames.INT);//event_ordinal
        this.setTypeExpected(4, TypeNames.STRING);//crf        
        this.setTypeExpected(5, TypeNames.STRING);//crf_version
        this.setTypeExpected(6, TypeNames.STRING);//grp
        this.setTypeExpected(7, TypeNames.INT);//grp_ordinal
        this.setTypeExpected(8, TypeNames.STRING);//item_name
        this.setTypeExpected(9, TypeNames.STRING);//options_values
        this.setTypeExpected(10, TypeNames.STRING);//dt
        this.setTypeExpected(11, TypeNames.INT);//crf_id
        this.setTypeExpected(12, TypeNames.INT);//event_crf_id
        
        HashMap variables = new HashMap();
        variables.put(new Integer(1), new Integer(studyId));
        variables.put(new Integer(2), new Integer(studyId));
        
        String sql = digester.getQuery("getMedicalCodeDataPerStudySubject");
        ...
        while (it.hasNext()) {
        	...
        	Integer eventOrdinal = (Integer) row.get("event_ordinal");
        	String crfName = (String) row.get("crf");
        	String crfVersionName = (String) row.get("crf_version");
        	String groupName = (String) row.get("grp");
        	Integer groupOrdinal = (Integer) row.get("grp_ordinal");        	
        	String codeItemName = (String) row.get("item_name");
        	String codeItemValue = (String) row.get("dt");
        	String responseOptionValues = (String) row.get("options_values");
...
//        	Integer statusId = (Integer) row.get("status_id");
        	...
        	CodeItemData codeItemData = new CodeItemData(studySubjectId, eventName, eventOrdinal, crfName, 
        			crfVersionName, groupName, groupOrdinal,  
        			 codeItemName, codeItemValue, responseOptionValues, crfId, eventCrfId/*, statusId*/);
        	codeData.add(codeItemData);
    ...
    /**
     * This will update item data value along with coding status
     * 
     * @param eb
     * @return
     */
    public EntityBean updateValueWithCodingStatus(EntityBean eb, String current_df_string) {
        ItemDataBean idb = (ItemDataBean) eb;
        ...
        variables.put(new Integer(2), idb.getValue());
        variables.put(new Integer(3), new Integer(idb.getUpdaterId()));        
        variables.put(new Integer(4), new Integer(idb.getCodingStatusId()));
        variables.put(new Integer(5), new Integer(idb.getId()));
        this.execute(digester.getQuery("updateWithCodingStatus"), variables);
