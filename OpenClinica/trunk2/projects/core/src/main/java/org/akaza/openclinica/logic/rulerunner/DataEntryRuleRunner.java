...
import org.akaza.openclinica.domain.rule.action.TriggerAutoCodingActionProcessor;
                    ...
                    try {
                        ...
                        if (itemData != null) {
                            ...
                            while (itr.hasNext()) {
                                ...
                                //@pgawade 19-Oct-2011 Changes for medical coding
//                                if(ruleActionBean.getActionType()==ActionType.INSERT) {
                                if((ruleActionBean.getActionType()==ActionType.INSERT) || (ruleActionBean.getActionType()==ActionType.TRIGGER_AUTO_CODING)) {
