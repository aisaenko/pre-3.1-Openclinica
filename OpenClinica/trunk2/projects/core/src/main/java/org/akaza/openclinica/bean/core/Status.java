...
public class Status extends Term implements Comparable {
    ...
    public static final Status NOT_CODED = new Status(11, "not-coded");
    public static final Status CODED = new Status(12, "coded");
    public static final Status MATCH_NOT_FOUND = new Status(13, "match-not-found");
    public static final Status CODE_APPROVED = new Status(14, "code-approved");
//    public static final Status MULTIPLE_MATCHES = new Status(15, "multiple-matches");no-exact-match
    public static final Status NO_EXACT_MATCH = new Status(15, "no-exact-match");

    private static final Status[] members =
        { INVALID, AVAILABLE, PENDING, PRIVATE, UNAVAILABLE, LOCKED, DELETED, AUTO_DELETED, SIGNED, FROZEN, SOURCE_DATA_VERIFICATION, NOT_CODED, CODED, MATCH_NOT_FOUND, CODE_APPROVED, NO_EXACT_MATCH};
