(function($) {
	...
	"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
	{
		...
		nFirst.className = "paginate_button_first";
		nPrevious.className = "paginate_button_previous";
		nNext.className="paginate_button_next";
		nLast.className = "paginate_button_last";
