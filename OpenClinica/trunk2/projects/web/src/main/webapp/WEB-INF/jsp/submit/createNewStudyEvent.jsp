			...
			<c:choose>
				...
				<c:otherwise>
					<div >
						...
						<input type="text" class="formfieldXL" size="50" value="<c:out value="${chosenSubjectLabel}"/>" name="studySubjectLabel required"/>
						*
						</div>
						<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studySubject"/></jsp:include>
		...
		<td class="formlabel"><fmt:message key="start_date_time" bundle="${resword}"/>:</td>
	  	<td valign="top">
			...
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>) <span class="indicates_required_field">*</span><c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=start&column=start_date','spanAlert-start'); return false;">
	...
	<tr valign="top">
		...
		<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=end&column=end_date','spanAlert-end'); return false;">
    ...
    <tr>
        <td class="formlabel"><fmt:message key="location" bundle="${resword}"/>:</td>
          <td valign="top"> <div>
                    ...
                    <c:if test="${study.studyParameterConfig.eventLocationRequired == 'required'}"><span class="indicates_required_field">*</span></c:if>
                    ...
                    <img name="flag_location" src="images/icon_noNote.gif" border="0" alt="<fmt:message key="discrepancy_note" bundle="${resword}"/>" title="<fmt:message key="discrepancy_note" bundle="${resword}"/>"></a>
                    </c:if>
                    </div>
...
<a href="javascript:leftnavExpand('schedule0');"   class="anchor_page_section_oc">
    <img id="excl_schedule0" src="images/bt_Expand.gif" border="0"> 
    <fmt:message key="schedule_another_event" bundle="${resword}"/></a>
...
<table border="0" cellpadding="0" cellspacing="0"   class="shaded_table  table_first_column_w30">
 ...
 <tr>
  	...
  	<td valign="top"><div >
					...
					</select><span class="indicates_required_field">*</span>
				</div>
				<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyEventDefinitionScheduled0"/></jsp:include>
	...
	<tr>
		<td class="formlabel"><fmt:message key="location" bundle="${resword}"/>:</td>
	  	<td valign="top">	<div >
               ...
               <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="locationScheduled0"/></jsp:include>
		</td>
	</tr>
    </c:if>
    <c:if test="${study.studyParameterConfig.eventLocationRequired == 'not_used'}">
    ...
    <tr valign="top">
		...
		<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=endScheduled0&column=end_date','spanAlert-endScheduled0'); return false;">
...
<a href="javascript:leftnavExpand('schedule1');"   class="anchor_page_section_oc">
...
<table border="0" cellpadding="0" cellspacing="0"   class="shaded_table  table_first_column_w30">
 ...
 <tr>
  	...
  	<td valign="top">	<div >
				...
				<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyEventDefinitionScheduled1"/></jsp:include>
		</td>
	</tr>
    <c:if test="${study.studyParameterConfig.eventLocationRequired != 'not_used'}">
	<tr>
		<td class="formlabel"><fmt:message key="location" bundle="${resword}"/>:</td>
	  	<td valign="top"><div>
				    ...
				    <img name="flag_schLocation" src="images/icon_noNote.gif" border="0" alt="<fmt:message key="discrepancy_note" bundle="${resword}"/>" title="<fmt:message key="discrepancy_note" bundle="${resword}"/>"></a></c:if>
				   </div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="locationScheduled1"/></jsp:include>
		</td>
	</tr>
    </c:if>
    <c:if test="${study.studyParameterConfig.eventLocationRequired == 'not_used'}">
		...
		<td class="formlabel"><fmt:message key="start_date_time" bundle="${resword}"/>:</td>
	  	<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)*<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=startScheduled1&column=start_date','spanAlert-startScheduled1'); return false;">
    ...
    <tr valign="top">
		...
		<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=endScheduled1&column=end_date','spanAlert-endScheduled1'); return false;">
...
<a href="javascript:leftnavExpand('schedule2');"   class="anchor_page_section_oc">
...
<table border="0" cellpadding="0" cellspacing="0"   class="shaded_table  table_first_column_w30">
 ...
 <tr>
  	...
  	<td valign="top"><div >
				...
				<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyEventDefinitionScheduled2"/></jsp:include>
		</td>
	</tr>
    <c:if test="${study.studyParameterConfig.eventLocationRequired != 'not_used'}">
	<tr>
		<td class="formlabel"><fmt:message key="location" bundle="${resword}"/>:</td>
	  	<td valign="top">	<div >
			...
			<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="locationScheduled2"/></jsp:include></td>
		...
		<td class="formlabel"><fmt:message key="start_date_time" bundle="${resword}"/>:</td>
	  	<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)*<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=startScheduled2&column=start_date','spanAlert-startScheduled2'); return false;">
    ...
    <tr valign="top">
		...
		<td valign="top">
			...
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=endScheduled2&column=end_date','spanAlert-endScheduled2'); return false;">
...
<a href="javascript:leftnavExpand('schedule3');"   class="anchor_page_section_oc">
...
<table border="0" cellpadding="0" cellspacing="0"   class="shaded_table  table_first_column_w30">
 ...
 <tr>
  	<td class="formlabel"><fmt:message key="study_event_definition" bundle="${resword}"/>:</td>
  	<td valign="top"><div>
			<select name="studyEventDefinitionScheduled3" class="formfieldXL required">
						<option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
						<c:forEach var="definition" items="${eventDefinitionsScheduled}">
							<c:choose>
								<c:when test="${definition.repeating}">
				...
				<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyEventDefinitionScheduled3"/></jsp:include>
		</td>
	</tr>
...
<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="locationScheduled3"/></jsp:include>
		</td>
	</tr>
    </c:if>
    <c:if test="${study.studyParameterConfig.eventLocationRequired == 'not_used'}">
		...
		<td class="formlabel"><fmt:message key="start_date_time" bundle="${resword}"/>:</td>
	  	<td valign="top">	<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)*<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=startScheduled3&column=start_date','spanAlert-startScheduled3'); return false;">
    ...
    <tr valign="top">
		...
		<td valign="top"><table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="padding: 0;">(<fmt:message key="date_time_format" bundle="${resformat}"/>)<c:if test="${study.studyParameterConfig.discrepancyManagement=='true'}"><a href="#" onClick="openDSNoteWindow('CreateDiscrepancyNote?subjectId=${chosenSubject.id}&name=studyEvent&field=endScheduled3&column=end_date','spanAlert-endScheduled3'); return false;">
