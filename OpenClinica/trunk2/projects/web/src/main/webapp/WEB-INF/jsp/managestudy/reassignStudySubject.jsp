...
<div class="table_name"><fmt:message key="you_choose_to_reassign_the_following_subject2" bundle="${restext}"/></div>
...
<input type="hidden" name="id" value="<c:out value="${studySub.id}"/>">
 ...
 <table border="0" cellpadding="0" cellspacing="0"   width="700"   class="shaded_table cell_borders  hrow">
  <tr>
   <th><fmt:message key="study_subject_ID" bundle="${resword}"/></td>
   <td class="table_cell"><c:out value="${studySub.label}"/></td>
 </tr>

 <tr>
   <th><fmt:message key="person_ID" bundle="${resword}"/></td>
   <td class="table_cell"><c:out value="${subject.uniqueIdentifier}"/></td>
 </tr>
 <tr>
   <th><fmt:message key="gender" bundle="${resword}"/></td>
   <td class="table_cell"><c:out value="${subject.gender}"/></td></tr>
 <tr>
   <th><fmt:message key="date_created" bundle="${resword}"/></td>
