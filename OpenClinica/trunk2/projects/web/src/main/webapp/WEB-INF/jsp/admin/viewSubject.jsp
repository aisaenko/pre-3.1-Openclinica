...
<h1><span class="title_manage"><fmt:message key="view_subject_details" bundle="${resword}"/></span></h1>


<table border="0" cellpadding="0" cellspacing="0" width="400" class="shaded_table table_first_column_w30 fcolumn cell_borders  ">
...
<br>
<br>
<div class="table_name"> <fmt:message key="associated_study_subjects" bundle="${resword}"/>:</div>
...
<br><a href="ListSubject" class="go_back_to_"><fmt:message key="go_back_to_subject_list" bundle="${resword}"/></a>
