...
<jsp:useBean scope="request" id="toc" class="org.akaza.openclinica.bean.submit.DisplayTableOfContentsBean" />
 ...
 <h1><span class="title_manage"><fmt:message key="view_CRF_version_data_entry" bundle="${resword}"/></span></h1>
...
<p>
<div class="title_manage"><fmt:message key="section_properties" bundle="${resword}"/>:</div>
