...
<br> <div class="table_name"><fmt:message key="you_choose_to_remove_the_following_subject" bundle="${restext}"/>:</div>
...
<br>
<div class="table_name"><fmt:message key="associated_study_events" bundle="${resword}"/>:</div>
  <table border="0" cellpadding="0" cellspacing="0"   width="700"   class="shaded_table cell_borders  hrow">
  <tr valign="top">
