...
<br><br>
<a href="javascript:leftnavExpand('overview');" class="anchor_page_section_oc">
    <img id="excl_overview" src="images/bt_Collapse.gif" border="0">
    <span class="section_link">
    <fmt:message key="study_description" bundle="${resword}"/>
    <!--<fmt:message key="overview" bundle="${resword}"/>-->
    </span></a>
...
<a href="javascript:leftnavExpand('sectionc');"  class="anchor_page_section_oc">
    ...
    <!--<fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> C: <fmt:message key="conditions_and_eligibility" bundle="${resword}"/>]-->
...
<a href="javascript:leftnavExpand('sectiond');"  class="anchor_page_section_oc">
   ...
   <fmt:message key="facility_information" bundle="${resword}"/>
    
   <!--  <fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> D: <fmt:message key="facility_information" bundle="${resword}"/>]-->
    </span></a>
...
<br>
 ...
 <a href="javascript:leftnavExpand('sectione');"  class="anchor_page_section_oc">
  ...
  <fmt:message key="related_infomation" bundle="${resword}"/>
     ...
     <!--<fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> E: <fmt:message key="related_infomation" bundle="${resword}"/>]-->
     </span></a>
...
<a href="javascript:leftnavExpand('sectionf');"  class="anchor_page_section_oc">
    ...
    <!--<fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> F: <fmt:message key="study_parameter_configuration" bundle="${resword}"/>]-->
    </span>    </a>
...
<br>
 <a href="javascript:leftnavExpand('sites');"  class="anchor_page_section_oc">
     <img id="excl_sites" src="images/bt_Collapse.gif" border="0"> <span class="section_link"><fmt:message key="sites" bundle="${resword}"/>: (<c:out value="${siteNum}"/> <fmt:message key="sites" bundle="${resword}"/>)</span></a>
...
<br>
 ...
 <a href="javascript:leftnavExpand('definitions');"  class="anchor_page_section_oc">
     <img id="excl_definitions" src="images/bt_Collapse.gif" border="0"> <span class="section_link"><fmt:message key="event_definitions" bundle="${resword}"/>: (<c:out value="${defNum}"/> <fmt:message key="definitions" bundle="${resword}"/>)</span></a>
 <div id="definitions" style="display:none">
 <table border="0" cellpadding="0" width="700"   class="shaded_table  cell_borders hrow">

 <tr valign="top">
   <th"><fmt:message key="name" bundle="${resword}"/></th>
   <th><fmt:message key="OID" bundle="${resword}"/></th>
   <th><fmt:message key="description" bundle="${resword}"/></th>
   <th><fmt:message key="of_CRFs" bundle="${resword}"/></th>
   <th>&nbsp;</th>
   <th></th>
  </tr>
...
<br>
<a href="javascript:leftnavExpand('users');"  class="anchor_page_section_oc">
    <img id="excl_users" src="images/bt_Expand.gif" border="0">  <span class="section_link"><fmt:message key="users" bundle="${resword}"/>: (<c:out value="${userNum}"/> <fmt:message key="users" bundle="${resword}"/>)</span></a>
