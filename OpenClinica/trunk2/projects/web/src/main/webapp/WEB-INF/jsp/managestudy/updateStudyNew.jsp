...
<a href="javascript:leftnavExpand('sectiona');"   class="anchor_page_section_oc">
    <img id="excl_sectiona" src="images/bt_Collapse.gif" border="0"><span class="section_link">
    <fmt:message key="study_description_status" bundle="${resword}"/> </span> </a>
<div id="sectiona" style="display: ">
   <table border="0" cellpadding="0" cellspacing="0" width="700"   class="shaded_table  table_first_column_w30 ">
          <tr valign="top">
              <td class="formlabel"><a href="http://prsinfo.clinicaltrials.gov/definitions.html#PrimaryId" target="def_win" onClick="openDefWindow('http://prsinfo.clinicaltrials.gov/definitions.html#PrimaryId'); return false;"><b><fmt:message key="unique_protocol_ID" bundle="${resword}"/>:</a></td><td><div class="formfieldXL_BG">
          <input type="text" name="uniqueProId" value="<c:out value="${studyToView.identifier}"/>" class="formfieldXL required"><span class="indicates_required_field">*</span></div>
          <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="uniqueProId"/></jsp:include></td>
            </tr>

          <tr valign="top"><td class="formlabel"><fmt:message key="brief_title" bundle="${resword}"/>:</td><td><div class="formfieldXL_BG">
          <input type="text" name="name" value="<c:out value="${studyToView.name}"/>" class="formfieldXL required"><span class="indicates_required_field">*</span></div>
          <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="name"/></jsp:include></td></tr>

          <tr valign="top"><td class="formlabel"><fmt:message key="official_title" bundle="${resword}"/>:</td><td><div class="formfieldXL_BG">
          ...
          <select class="formfieldXL required" name="statusId" disabled="true">
       ...
       <div>   <input type="text" name="prinInvestigator" value="<c:out value="${studyToView.principalInvestigator}"/>" class="formfieldXL required"></div>
          <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="prinInvestigator"/></jsp:include></td></tr>
            ...
            <textarea class="formtextareaXL4 required" name="description" rows="4" cols="50"><c:out value="${studyToView.summary}"/></textarea><span class="indicates_required_field">*</span></div>
            ...
            <div class="formfieldXL_BG"><input type="text" name="sponsor" value="<c:out value="${studyToView.sponsor}"/>" class="formfieldXL required"><span class="indicates_required_field">*</span></div>
...
<br>
            <!-- section B-->
            <a href="javascript:leftnavExpand('sectionb');"  class="anchor_page_section_oc">
    <img id="excl_sectionb" src="images/bt_Expand.gif" border="0">
    <span class="section_link">
    <!--<fmt:message key="view_study_details" bundle="${resword}"/>: [<fmt:message key="section" bundle="${resword}"/> B: <fmt:message key="study_status_and_design" bundle="${resword}"/>]-->
    <fmt:message key="study_status_and_design" bundle="${resword}"/>
    </span></a>
<div id="sectionb" style="display: ">
...
<table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30">
          <tr valign="top"><td class="formlabel"><fmt:message key="study_phase" bundle="${resword}"/>:</td><td>
           ...
           <div class="formfieldXL_BG"><select name="phase" class="formfieldXL required">
           ...
           <div class="formfieldXL_BG">
               <input type="text" name="protocolDateVerification" value="<c:out value="${protocolDateVerification}"/>" class="formfieldM" id="protocolDateVerificationField">
           ...
           <input type="text" name="startDate" value="<c:out value="${startDate}" />" class="formfieldXL required" id="startDateField">
           ...
           </a><span class="indicates_required_field">*</span></div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="startDate"/></jsp:include></td></tr>
          ...
          <tr valign="bottom"><td class="formlabel"><fmt:message key="purpose" bundle="${resword}"/>:</td><td>
           <c:set var="purpose1" value="${studyToView.purpose}"/>
          <div class="formfieldXL_BG"><select name="purpose" class="formfieldXL required">
...
<a href="javascript:leftnavExpand('sectionc');"   class="anchor_page_section_oc">
	<img id="excl_sectionc" src="images/bt_Expand.gif" border="0"> <span class="section_link">
         <fmt:message key="conditions_and_eligibility" bundle="${resword}"/></span></a>
<div id="sectionc" style="display: ">

  <table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30 table_first_column_w30">
      ...
      <div class="formfieldXL_BG"><input type="text" name="expectedTotalEnrollment" value="<c:out value="${studyToView.expectedTotalEnrollment}"/>" class="formfieldXL required">
       <span class="indicates_required_field">*</span></div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="expectedTotalEnrollment"/></jsp:include>
      </td></tr>
...
<a href="javascript:leftnavExpand('sectiond');"   class="anchor_page_section_oc">
...
<br>
 ...
 <a href="javascript:leftnavExpand('sectione');"   class="anchor_page_section_oc">
 	<img id="excl_sectione" src="images/bt_Expand.gif" border="0"> <span class="section_link">
...
<br>
<a href="javascript:leftnavExpand('sectionf');"   class="anchor_page_section_oc">
	<img id="excl_sectionf" src="images/bt_Expand.gif" border="0"> <span class="section_link">
    <fmt:message key="study_parameter_configuration" bundle="${resword}"/></span></a>
<div id="sectionf" style="display: ">
<table border="0" cellpadding="0" cellspacing="0" width="700"   class="shaded_table table_first_column_w30 table_first_column_w30">
  ...
  <tr valign="top">
      <td class="formlabel"><fmt:message key="event_location_required" bundle="${resword}"/></td>
      <td>
