...
<br>
 ...
 <span class="table_name"><fmt:message key="subject_events" bundle="${resword}"/> </span>
<table border="0" cellpadding="0" cellspacing="0"   width="700"   class="shaded_table cell_borders  hrow">
     <tr>
        <th><fmt:message key="last_update" bundle="${resword}"/></th>
        ...
        <th><fmt:message key="update_by" bundle="${resword}"/></th>
