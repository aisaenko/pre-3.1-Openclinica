...
<!-- Main Content Area -->
<div align="justify" style="width: 630px; height: 400px; background:#FFFFFF; padding:5px 8px 0px 8px">
<h1 style="color: #789EC5;"><fmt:message key="request_password_form" bundle="${resword}"/></h1>
...
<table cellpadding="0" border="0" class="shaded_table table_first_column_w30" style="width: 550px;">
