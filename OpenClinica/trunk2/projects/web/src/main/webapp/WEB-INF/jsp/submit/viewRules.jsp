...
<h1><span class="title_manage"><fmt:message key="rule_manage_rule_title" bundle="${resword}"/> <c:out value="${ruleSet.itemName}"/></span></h1>
...
<table cellpadding="0" border="0" class="shaded_table cell_borders  hrow">
  <tr valign="top">
    ...
    <th><fmt:message key="rule_oid" bundle="${resword}"/></th>
...
<p><a   class="go_back_to_" href="ViewRuleAssignment"/><fmt:message key="rule_go_back_to_Assignment_list" bundle="${resword}"/></a></p>
