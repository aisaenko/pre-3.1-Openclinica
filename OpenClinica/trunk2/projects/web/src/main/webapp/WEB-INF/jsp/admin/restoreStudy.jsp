...
<table border="0" cellpadding="0" width="700"   class="shaded_table  table_first_column_w30 fcolumn">
...
<br>
<div class="table_name"><fmt:message key="sites" bundle="${resword}"/>:</div>
<table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30 cell_borders  hrow">
 ...
 <tr valign="top">
  ...
  <br>
<div class="table_name"><fmt:message key="user_and_roles" bundle="${resword}"/>:</div>
<table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30 cell_borders  hrow">
 ...
 <table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30 cell_borders  hrow">
  ...
  <tr valign="top"><th width="400"><fmt:message key="study_subject_ID" bundle="${resword}"/></th>
...
<br>
 <div class="table_name"><fmt:message key="SED" bundle="${resword}"/>:</div>
 <table border="0" cellpadding="0" width="700"   class="shaded_table table_first_column_w30 cell_borders  hrow">
