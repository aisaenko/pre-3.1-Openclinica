...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<tr valign="top">
		...
		<td valign="top">
			<div><input type="text" id="firstName" name="firstName" value="<c:out value="${firstName}"/>" size="20" class="formfieldM" />
					<span class="indicates_required_field">*</span>
					</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="firstName" /></jsp:include>
		</td>
	</tr>

	<tr valign="top">
		<td class="formlabel"><fmt:message key="last_name" bundle="${resword}"/>:</td>
		<td valign="top"><div><input type="text" id="lastName" name="lastName" value="<c:out value="${lastName}"/>" size="20" class="formfieldM" />
					<span class="indicates_required_field">*</span>
					</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="lastName" /></jsp:include>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<input type="text" id="email" name="email" value="<c:out value="${email}"/>" size="20" class="formfieldM" />
					&nbsp;(<fmt:message key="username@institution" bundle="${resword}"/>)<span class="indicates_required_field">*</span>
					</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="email" /></jsp:include>
		</td>
	</tr>
	...
	<tr valign="top">
		...
		<td valign="top"><div><input type="text" id="institutionalAffiliation" name="institutionalAffiliation" value="<c:out value="${institutionalAffiliation}"/>" size="20" class="formfieldM" />
					<span class="indicates_required_field">*</span>
					</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="institutionalAffiliation" /></jsp:include>
		</td>
	</tr>
...
<!-- EDIT !! -->
		<td valign="top"><div><select name="activeStudy" id="activeStudy" class="formfieldXL" onchange="sendUrl();">
				...
				<span class="indicates_required_field">*</span>
				</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="activeStudy" /></jsp:include>
		</td>
	</tr>

	<tr valign="top">
	  	<td class="formlabel"><fmt:message key="role" bundle="${resword}"/>:</td>
		<td valign="top"><div>	<select name="role" id="role" class="formfieldM">
							<option value="0">-<fmt:message key="select" bundle="${resword}"/>-</option>
					...
					<span class="indicates_required_field">*</span>
					</div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="role" /></jsp:include>
		</td>
	</tr>
	<!--jn: hiding for now, there is a constraint on user_account table that needs to be disabled fk_user_acc_ref_user__user_typ before this block is removed--> 
	<tr valign="top" style="display:none">
	  	<td class="formlabel"><fmt:message key="user_type" bundle="${resword}"/>:</td>
		<td valign="top"><select name="type" id="type" class="formfieldM">
	...
	<tr valign="top" class="webservicesRow">
        ...
        <td valign="top"><div>   <br><input type="checkbox" name="runWebServices" id="runWebServices" value="1"
                            <c:if test="${runWebServices != 0}">checked</c:if>
                        >
                   </div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="runWebServices" /></jsp:include>
        </td>
    </tr>
