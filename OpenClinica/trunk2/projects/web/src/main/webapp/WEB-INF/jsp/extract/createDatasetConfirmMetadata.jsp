...
<fmt:message key="edit_dataset" bundle="${resword}"/> - <fmt:message key="confirm_dataset_properties" bundle="${resword}"/>
...
<table>
	...
	<tr>
		...
		<td>
		  <input type="submit" name="btnSubmit" value="<fmt:message key="back" bundle="${resword}"/>" class="button_medium"/>
		</td>
	</tr>
</table>
