...
<a href="javascript:leftnavExpand('globalRecord');" class="anchor_page_section_oc">
    <img id="excl_overview" src="images/bt_Collapse.gif" border="0">
    <span class="section_link">
    <fmt:message key="globalRecord" bundle="${resword}"/>
     </span></a>
<div id="globalRecord" style="">
<table  cellpadding="0" border="0" class="shaded_table  " style="width: 350px;">
       <tr>
...
<p><div class="table_title"><fmt:message key="CRFs_in_this_study_event" bundle="${resword}"/>:</div>
...
<tr>
    ...
    <th><fmt:message key="initial_data_entry" bundle="${resword}"/></th>
                ...
                <c:when test="${studySubject.status.name != 'removed'&& studySubject.status.name != 'auto-removed' && study.status.available && !studyEvent.status.deleted && !userRole.monitor}">
                    <td class="table_cell">
                        <a href="#" onclick="checkCRFLockedInitial('<c:out value="${dedc.eventCRF.id}"/>',document.startForm<c:out value="${dedc.edc.crf.id}"/>);"
                           ...
                           onMouseUp="javascript:setImage('bt_EnterData<c:out value="${rowCount}"/>','images/bt_EnterData.gif');"><img name="bt_EnterData<c:out value="${rowCount}"/>" src="images/bt_EnterData.gif" border="0" alt="<fmt:message key="enter_data" bundle="${resword}"/>" title="<fmt:message key="enter_data" bundle="${resword}"/>" align="left" hspace="2"></a>&nbsp;
                    </td>
                </c:when>
...
<tr>
<td class="table_cell_left"><c:out value="${dec.eventCRF.crf.name}" />&nbsp;</td>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:if test="${studySubject.status.name != 'removed'&& studySubject.status.name != 'auto-removed' && !userRole.monitor}">
                <c:if test="${dec.continueInitialDataEntryPermitted}"><a href="#"
                    ...
                    onclick="checkCRFLocked('<c:out value="${dec.eventCRF.id}"/>', '<c:out value="${actionQuery}"/>');"><img name="bt_EnterData1" src="images/bt_EnterData.gif" border="0" alt="<fmt:message key="continue_entering_data" bundle="${resword}"/>" title="<fmt:message key="continue_entering_data" bundle="${resword}"/>" align="left" hspace="6"></a>
                </c:if>
                <c:if test="${dec.startDoubleDataEntryPermitted}"><a href="#"
                    onMouseDown="javascript:setImage('bt_EnterData1','images/bt_EnterData_d.gif');"
                    onMouseUp="javascript:setImage('bt_EnterData1','images/bt_EnterData.gif');"
                    onclick="checkCRFLocked('<c:out value="${dec.eventCRF.id}"/>', '<c:out value="${actionQuery}"/>');"><img name="bt_EnterData1" src="images/bt_EnterData.gif" border="0" alt="<fmt:message key="begin_double_data_entry" bundle="${resword}"/>" title="<fmt:message key="begin_double_data_entry" bundle="${resword}"/>" align="left" hspace="6"></a>
                </c:if>
                <c:if test="${dec.continueDoubleDataEntryPermitted}"><a href="#"
                    onMouseDown="javascript:setImage('bt_EnterData1','images/bt_EnterData_d.gif');"
                    onMouseUp="javascript:setImage('bt_EnterData1','images/bt_EnterData.gif');"
