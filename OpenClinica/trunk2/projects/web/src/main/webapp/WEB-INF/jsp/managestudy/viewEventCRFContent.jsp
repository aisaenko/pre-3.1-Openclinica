...
<jsp:useBean scope="request" id="toc" class="org.akaza.openclinica.bean.submit.DisplayTableOfContentsBean" />
  ...
  <h1><span class="title_manage"><fmt:message key="view_event_CRF" bundle="${resword}"/>: <c:out value="${studySub.label}"/>-<c:out value="${toc.crf.name}"/>
</span>
</h1>
...
<a href="javascript:openDocWindow('PrintDataEntry?ecId=<c:out value="${toc.eventCRF.id}"/>')"
					...
					<p>
       <div class="table_title"><fmt:message key="section_properties" bundle="${resword}"/></div>
