...
<br><input type="button" onclick="confirmExitWithMessage('ViewAllJobs', '<fmt:message key="sure_to_exit_no_transaction" bundle="${resword}"/>');" name="exit" value="<fmt:message key="exit" bundle="${resword}"/>   "class="button_medium"/>   </td>
<br><br>
