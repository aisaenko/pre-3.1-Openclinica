...
<table cellpadding="0" border="0" class="shaded_table cell_borders  hrow">
    <tr valign="top">
        <th colspan="2"><fmt:message key="summary_statistics" bundle="${resword}"/>:</th>
    </tr>
    <tr valign="top">
...
<c:otherwise>
    <input type="button" onClick="proceed()" value="<fmt:message key="continue" bundle="${resword}"/>" class="button_medium"> 
</c:otherwise>
</c:choose>
...
<tr valign="top">
    <th><fmt:message key="rule_verify_import_rule_oid" bundle="${resword}"/></th>
    <th><fmt:message key="rule_name" bundle="${resword}"/></th>
    <th><fmt:message key="rule_verify_import_description" bundle="${resword}"/></th>
    <th><fmt:message key="rule_verify_import_warnings" bundle="${resword}"/></th>
</tr>
...
<c:if test="${empty importedData.validRuleDefs }" >
...
<tr valign="top">
    <th><fmt:message key="rule_verify_import_rule_oid" bundle="${resword}"/></td>
    <th><fmt:message key="rule_name" bundle="${resword}"/></td>
    <th><fmt:message key="rule_verify_import_description" bundle="${resword}"/></td>
    <th><fmt:message key="rule_verify_import_warnings" bundle="${resword}"/></td>
</tr>
...
<c:if test="${empty importedData.duplicateRuleDefs }" >
<tr><td colspan="4">&nbsp;</td></tr>
</c:if>
...
<tr valign="top">
    ...
    <th><fmt:message key="rule_name" bundle="${resword}"/></th>
    <th><fmt:message key="rule_verify_import_description" bundle="${resword}"/></th>
    <th><fmt:message key="rule_import_error" bundle="${resword}"/></th>
</tr>
...
<c:if test="${empty importedData.inValidRuleDefs }" >
<tr><td colspan="4">&nbsp;</td></tr>
</c:if>
</table>
...
<c:forEach var="ruleBeanWrapper" items="${importedData.validRuleSetDefs}" >
    <tr valign="top">
        ...
        <td class="table_cell_left">
            <table border="0" cellpadding="0" cellspacing="0"  style="border-style: solid;">
            <tr valign="top">
                <td class="table_header_row"><fmt:message key="rule_verify_import_rule_oid" bundle="${resword}"/></td>
                <!-- <th><fmt:message key="rule_verify_import_action_type" bundle="${resword}"/></td> -->
            ...
            <tr valign="top">
                ...
                <td class="table_cell_left">
                    ...
                    <c:forEach items="${action.propertiesForDisplay}" var="mapEntry" varStatus="status">
                            <tr valign="top">
                                <td class=" "><i><fmt:message key="${mapEntry.key}" bundle="${resword}" /></i></td>
                                <td class=" ">${mapEntry.value}</td>
                            </tr>
                    </c:forEach>
                    </table>
                </td>
...
<c:if test="${empty importedData.validRuleSetDefs }" >
...
<c:forEach var="ruleBeanWrapper" items="${importedData.duplicateRuleSetDefs}" >
    <tr valign="top">
        ...
        <td class="table_cell_left">
            <table border="1" cellpadding="0" cellspacing="0"  style="border-style: solid;">
            <tr valign="top">
                <td class="table_header_row"><fmt:message key="rule_verify_import_rule_oid" bundle="${resword}"/></td>
                <!--<th><fmt:message key="rule_verify_import_action_type" bundle="${resword}"/></td> -->
                <td class="table_header_row"><fmt:message key="rule_verify_import_action_message" bundle="${resword}"/></td>
...
<c:if test="${empty importedData.duplicateRuleSetDefs }" >
<tr><td colspan="2">&nbsp;</td></tr>
</c:if>
</table>
...
<tr valign="top">
    <th><fmt:message key="rule_verify_import_target" bundle="${resword}"/></th>
    <th><fmt:message key="rule_verify_import_rules" bundle="${resword}"/></th>
    <th><fmt:message key="rule_verify_import_errors" bundle="${resword}"/></th>
</tr>
...
<c:if test="${empty importedData.inValidRuleSetDefs }" >
