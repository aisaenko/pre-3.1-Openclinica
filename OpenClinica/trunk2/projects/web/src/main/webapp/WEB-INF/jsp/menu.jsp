...
<c:set  var="homePageURL" value="${pageMenu.navBar[0].homePageURL}" />
...
<h1>     <span class="title_manage" style="line-height:5px;">
...
<span class="table_title_bold" style="line-height:15px;">
...
<c:if test="${homePageURL eq 'ListStudySubjects'}">
...
<c:if test="${homePageURL eq 'StatisticsPage'}">
...
<c:if test="${homePageURL eq 'pages/viewAllSubjectSDVtmp'}">
