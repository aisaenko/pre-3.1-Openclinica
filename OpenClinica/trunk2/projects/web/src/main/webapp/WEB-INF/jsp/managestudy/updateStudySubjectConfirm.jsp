...
<input type="hidden" name="id" value="<c:out value="${studySub.id}"/>">
 <table border="0" cellpadding="0" cellspacing="0"   class="shaded_table table_first_column_w30 cell_borders fcolumn">
...
<br>
<table border="0" cellpadding="0" cellspacing="0"   class="shaded_table table_first_column_w30 cell_borders ">
