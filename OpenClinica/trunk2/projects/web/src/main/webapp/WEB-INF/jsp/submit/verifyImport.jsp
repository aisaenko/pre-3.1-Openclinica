...
<h1><span class="title_manage"><fmt:message key="import_crf_data" bundle="${resworkflow}"/></span></h1>
...
<c:choose>
	...
	<c:otherwise>
		...
		<fmt:message key="valid_data_imported" bundle="${resword}"/>
			...
			<form action="ListStudySubjects"><input type="submit" 				value="<fmt:message key="cancel" bundle="${resword}"/>"				class="button_medium"></form>
