...
<table cellpadding="2" class="shaded_table  "  style="width:900px;">
	...
	<tr>
		...
		<td class="text">
			<input type="text" name="jobName" size="30" value="<c:out value="${jobName}"/>"/><span class="indicates_required_field">&nbsp;*</span>
		</td>		
	</tr>
	<tr>
		...
		<td class="text"><input type="text" name="jobDesc" size="60" value="<c:out value="${jobDesc}"/>"/> <span class="indicates_required_field">&nbsp;*</span>
		</td> 
	</tr>
	<tr>
		<td class="text">
		...
		<td class="text">
						...
						<select name="studyId" id="studyId" class="formfieldL ">
	...
	<tr>
		...
		<select name="minutes">
			...
			>50</option>
		</select> <fmt:message key="minutes" bundle="${resword}"/>.<span class="indicates_required_field">&nbsp;*</span>
		</td>		
	</tr>
...
<table>
	<tr>
		<td align="left">
		  <input type="submit" name="btnSubmit" value="<fmt:message key="save" bundle="${resword}"/>" class="button_medium"/></form>
		</td>
		
		<td><form action='ViewImportJob' method="POST">
		
		  <input type="submit" name="btnSubmit" value="<fmt:message key="cancel" bundle="${resword}"/>" class="button_medium"/>
		</form></td>
	</tr>
</table>
