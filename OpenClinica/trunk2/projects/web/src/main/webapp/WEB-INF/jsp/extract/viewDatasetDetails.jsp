...
<tr>
    <c:choose>
        <c:when test="${!(userRole.monitor || userRole.investigator)}">
             <td>
                ...
                <input type="submit" value="<fmt:message key="edit_dataset" bundle="${resword}"/>" class="button_long"/><br>
                </form>
             </td>
        </c:when>
        <c:otherwise>
  ...
  <td>
   <form action="ExportDataset">
    ...
    <input type="submit" value="<fmt:message key="export_this_dataset" bundle="${resword}"/>" class="button_long"/><br>
   </form>
  </td>
</tr>
</table>
