...
<script type="text/JavaScript" language="JavaScript" src="includes/Tabs.min.js"></script>
<script type="text/JavaScript" language="JavaScript" src="includes/CalendarPopup.min.js"></script>
