...
<table cellpadding="0" border="0" class="shaded_table table_first_column_w30 fcolumn" width="500">
    <tr>
...
<br>
<input type="submit" name="submit" value="<fmt:message key="back" bundle="${resword}"/>" class="button_medium">
