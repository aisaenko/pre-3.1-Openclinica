...
<div style="width: 500px; height: 550px; overflow: scroll; background:#FFFFFF; text-align: left;">
   <h1  class="aka_revised_content" ><fmt:message key="add_new_subject" bundle="${resword}"/></h1>
    
    
    <table border="0" cellpadding="2" cellspacing="0">
    
    <tr valign="top"> <td class="formlabel" width="150">
    ...
    <tr valign="top"><td class="formlabel"><fmt:message key="person_ID" bundle="${resword}"/>:</td>
    <td valign="top"><div >
    <input onfocus="this.select()" type="text" name="uniqueIdentifier" value="<c:out value="${uniqueIdentifier}"/>" size="50" class="formfieldXL required">
    <span class="indicates_required_field">&nbsp;*</span></div><jsp:include page="../showMessage.jsp"><jsp:param name="key" value="uniqueIdentifier"/></jsp:include>
        </td>
    </tr>
    </c:when>
    ...
    <tr valign="top">
       <td class="formlabel">          <fmt:message key="enrollment_date" bundle="${resword}"/>:        </td>
        <td valign="top">            <!--layer-background-color:white;-->
            <div> <input onfocus="this.select()" type="text" name="enrollmentDate"  value="<c:out value="${enrollmentDate}" />" class="formfieldM required" id="enrollmentDateField" />
                   <A HREF="#">
                    ...
                    </a><span class="indicates_required_field">&nbsp;*</span></div>
...
<c:if test="${(!empty studyGroupClasses)}">
    ...
    <tr valign="top">
        ...
        <td valign="top"><div >
<select name="studyEventDefinition" class="formfieldM required">
    <option value="">-<fmt:message key="select" bundle="${resword}"/>-</option>
    <c:forEach var="event" items="${allDefsArray}">
        <option <c:if test="${studyEventDefinition == event.id}">SELECTED</c:if> value="<c:out value="${event.id}"/>"><c:out value="${event.name}" />
                   ...
                   <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="studyEventDefinition"/></jsp:include></td>
    </tr>

    <tr valign="top">
        <td class="formlabel">   <fmt:message key="start_date" bundle="${resword}"/>:   </td>
        <td valign="top"><div><input type="text" name="startDate" size="15" value="<c:out value="${startDate}" />" class="formfieldM required" id="enrollmentDateField2" />                    
         <A HREF="#" >
    ...
    <tr valign="top">
        ...
        <td valign="top"><div>
        <input type="text" name="location"size="50" value="<c:out value="${location}"/>" class="formfieldXL required">
        <span class="indicates_required_field">&nbsp;*</span></div>
        <jsp:include page="../showMessage.jsp"><jsp:param name="key" value="location"/></jsp:include></td>
    </tr>
   </c:when>
    ...
    <tr valign="top">
        <td class="formlabel"><fmt:message key="location" bundle="${resword}"/>:</td>
        <td valign="top"><div >
             <input type="text" name="location"size="50" class="formfieldXL"></div></td>
    ...
    &nbsp;&nbsp;<input type="submit" name="addSubject" value="<fmt:message key="add2" bundle="${resword}"/>" class="button_medium" />
    <input type="button" id="cancel" name="cancel" value="   <fmt:message key="cancel" bundle="${resword}"/>" class="button_medium"/>
