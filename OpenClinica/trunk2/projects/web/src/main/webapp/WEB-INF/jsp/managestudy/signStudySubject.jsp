...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tr><td>
        <h1>  <span class="title_manage"><fmt:message key="sign_subject" bundle="${resword}"/>&nbsp;<c:out value="${studySub.label}"/>
                    </span></h1>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top"><td class="formlabel"><fmt:message key="user_name" bundle="${resword}"/>:</td>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr><td>
                                <input type="text" name="j_user" autocomplete="off" class="formfieldM">
                            </td><td>&nbsp;</td>
                            </tr>
                        </table>
                    </td></tr>
                <tr valign="top"><td class="formlabel"><fmt:message key="password" bundle="${resword}"/></td>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0">
                            <tr><td>
                               <input type="password" name="j_pass"  autocomplete="off" class="formfieldM">
                            </td><td>&nbsp;</td>
                            </tr>
                        </table>
                    </td></tr>
...
<a name="group"><a href="javascript:leftnavExpand('groups');javascript:setImage('ExpandGroup3','images/bt_Collapse.gif');"><img
...
<tr>
    ...
    <td align="right" valign="top" class="table_actions">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="table_tools">
                    <c:if test="${ subject.status.available }">
...
<c:when test="${ module=='manage'}">
 <a href="ListStudySubjects"  class="go_back_to_"><fmt:message key="go_back_to_study_subject_list" bundle="${resword}"/></a>  
</c:when>
<c:otherwise>
