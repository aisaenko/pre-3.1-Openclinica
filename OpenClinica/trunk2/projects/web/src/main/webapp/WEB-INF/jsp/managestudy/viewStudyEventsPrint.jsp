...
<link rel="stylesheet" href="includes/styles_old.css" type="text/css">
</head>
...
<h1><span class="title_manage"><fmt:message key="view_all_events_in" bundle="${resword}"/> <c:out value="${study.name}"/>
</span></h1>
