...
<script type="text/javascript">
  ...
  <%--</c:if>--%>
  <div>
      <input type="submit" name="submitEvent" value="<fmt:message key="save" bundle="${resword}"/>" class="button_medium">
      <input type="button" onclick="confirmCancel('${pageContext.request.contextPath}/MainMenu');" name="cancel" value="<fmt:message key="cancel" bundle="${resword}"/>" class="button_medium">
  </div>
</form>
