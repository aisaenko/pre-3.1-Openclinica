       ...
       <tr>
            ...
            <!-- Login box contents -->
                <div ID="login">
                    ...
                    <h5><fmt:message key="login" bundle="${resword}"/></h5>
                    <b><fmt:message key="user_name" bundle="${resword}"/></b>
                        <div class="formfieldM_BG">
                            <input type="text" id="username" name="j_username" class="formfieldM" style="margin-left:0px;">
                        </div>

                    <b><fmt:message key="password" bundle="${resword}"/></b>
                        <div class="formfieldM_BG">
                            <input type="password" id="j_password" name="j_password"  class="formfieldM"  autocomplete="off" style="margin-left:0px;">
                        </div>
            ...
            <div ID="newsBox">
                <!-- News box contents -->
                <h5><fmt:message key="news" bundle="${resword}"/></h5><fmt:message key="loading" bundle="${resword}"/> ...
