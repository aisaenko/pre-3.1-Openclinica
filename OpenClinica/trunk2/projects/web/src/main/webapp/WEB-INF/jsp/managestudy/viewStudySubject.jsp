...
<a href="javascript:leftnavExpand('studySubjectRecord');"   class="anchor_page_section_oc">
...
<table border="0" cellpadding="0" cellspacing="0"  class="shaded_table  ">
...
</td>		<!-- End Table Tools/Actions cell -->				</tr>
...
<a href="javascript:leftnavExpand('subjectEvents');"   class="anchor_page_section_oc">
    <img id="excl_subjectEvents" src="images/bt_Collapse.gif" border="0"> <fmt:message key="events" bundle="${resword}"/></a>
<div id="subjectEvents">
    <c:import url="../include/showTable.jsp"><c:param name="rowURL" value="showStudyEventRow.jsp" /></c:import>
</div>
<br>

<a href="javascript:leftnavExpand('groups');"   class="anchor_page_section_oc">
            <img id="excl_groups" src="images/bt_Expand.gif" border="0"> <fmt:message key="group" bundle="${resword}"/></a>
...
<a href="javascript:leftnavExpand('globalRecord');"   class="anchor_page_section_oc">
        <img id="excl_globalRecord" src="images/bt_Expand.gif" border="0"> <fmt:message key="global_subject_record" bundle="${resword}"/></a>

<div id="globalRecord" style="display:none">


<table border="0" cellpadding="0" cellspacing="0"  width="400" class="shaded_table  ">
...
<c:choose>
<c:when test="${from =='listSubject' && module=='admin'}">
<p> <a href="ViewSubject?id=<c:out value="${subject.id}"/>"  class="go_back_to_"><fmt:message key="go_back_to_view_subject" bundle="${resword}"/></a>  </p>
</c:when>
<c:otherwise>

<c:choose>
<c:when test="${ module=='manage'}">
<p> <a href="ListStudySubject"  class="go_back_to_"><fmt:message key="go_back_to_study_subject_list" bundle="${resword}"/></a>  </p>
</c:when>
<c:otherwise>
<a href="ListStudySubjects"  class="go_back_to_"><fmt:message key="go_back_to_subject_list" bundle="${resword}"/></a>  
</c:otherwise>
</c:choose>
</c:otherwise>
</c:choose>
