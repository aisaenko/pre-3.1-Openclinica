...
<link rel="stylesheet" href="includes/styles_old.css" type="text/css" media="screen">
...
"${version.crfId}"/>&name=<c:out value="${version.name}"/>" method="post">
 ...
 <input type="submit" name="submit" value="<fmt:message key="continue" bundle="${resword}"/>" class="button_medium_1"></form></b> </td>
 <td><b><form action="ListCRF" method="post">
 <input type="submit" name="submit" value="<fmt:message key="cancel" bundle="${resword}"/>" class="button_medium_1"></form></b> </td>
  </tr>
  </table>
