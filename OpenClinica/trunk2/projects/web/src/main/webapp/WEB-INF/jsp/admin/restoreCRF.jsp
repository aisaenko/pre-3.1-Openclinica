...
<span class="table_title"><fmt:message key="you_choose_to_restore_the_following_CRF" bundle="${restext}"/>:</span>
...
<span class="table_title"><fmt:message key="CRF_versions" bundle="${resword}"/></span>
<table cellpadding="0" border="0" class="shaded_table  hrow cell_borders">
 <tr valign="top">
    <th class="table_header_column_top"><fmt:message key="version_name" bundle="${resword}"/></th>

    <th><fmt:message key="description" bundle="${resword}"/></th>

     <th><fmt:message key="status" bundle="${resword}"/></th>

     <th><fmt:message key="revision_notes" bundle="${resword}"/></th>
    </tr>
...
<br>
<span class="table_title"><fmt:message key="event_CRFs" bundle="${resword}"/>
</span>
