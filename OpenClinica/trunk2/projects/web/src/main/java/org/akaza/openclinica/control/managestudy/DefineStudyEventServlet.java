...
//    private void submitDefinition() throws NullPointerException {
      private void submitDefinition() throws Exception {
        ...
        CodingService codingService = (CodingService)SpringServletAccess.getApplicationContext(getServletContext()).getBean("codingService");
        codingService.createCodingRulesForEventDef(eventDefinitionCRFs, currentStudy, respage, ub);
