...
public class ViewRuleAssignmentTableFactory extends AbstractTableFactory {
    ...
    protected void configureColumns(TableFacade tableFacade, Locale locale) {
        ...
        //@pgawade 09-Nov-2011 issue #11488 
        configureColumn(row.getColumn(columnNames[index++]), resword.getString("view_rule_assignment_rule_type"), new RuleTypeCellEditor(),
                new TypeDroplistFilterEditor());
    ...
    public void configureTableFacade(HttpServletResponse response, TableFacade tableFacade) {
        ...
        //@pgawade 09-Nov-2011 issue #11488 
        tableFacade.addFilterMatcher(new MatcherKey(String.class, "ruleType"), new GenericFilterMatcher());
    ...
    public void setDataAndLimitVariables(TableFacade tableFacade) {
        ...
        //@pgawade 09-Nov-2011 issue #11488
        Boolean ruleTypeFilterNotSelected = true;
        for (ViewRuleAssignmentFilter.Filter filter : viewRuleAssignmentFilter.getFilters()) {
            if (filter.getProperty().equals("ruleType")) {
            	ruleTypeFilterNotSelected = false;
            }
        }
        if (ruleTypeFilterNotSelected) {
            viewRuleAssignmentFilter.addFilter("ruleType", "1");
        }
   ...
   //@pgawade 09-Nov-2011 issue #11488 
    private class RuleTypeCellEditor implements CellEditor {
        public Object getValue(Object item, String property, int rowcount) {
            RuleSetRuleBean ruleSetRule = (RuleSetRuleBean) new BasicCellEditor().getValue(item, "ruleSetRule", rowcount);
            return ruleSetRule.getRuleBean().getRuleType().getDescription();
        }
    }
    ...
    private class TypeDroplistFilterEditor extends DroplistFilterEditor {
        ...
        protected List<Option> getOptions() {
            List<Option> options = new ArrayList<Option>();
            options.add(new Option(String.valueOf(EntityType.USER_CREATED.getCode()), EntityType.USER_CREATED.toString()));
            options.add(new Option(String.valueOf(EntityType.SYSTEM_CREATED_FOR_CODING.getCode()), EntityType.SYSTEM_CREATED_FOR_CODING.toString()));
            return options;
        }
    }
