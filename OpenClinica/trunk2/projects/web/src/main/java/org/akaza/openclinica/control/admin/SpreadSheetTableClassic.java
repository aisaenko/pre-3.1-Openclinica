...
//                        	if (responseTypeId == 8 || responseTypeId == 9) {
                      ...
                      //@pgawade 4-Aug-2011 changes to support medical coding
                        else if(responseTypeId == ResponseType.CALCULATION.getId()){
//                        	CodingService codingService = new CodingService();
                        	...
                        	codingService.validateCodingExpression(false, resValues, errors, htmlErrors, resPageMsg, itemName, j, k, null, locale, allItems);
                        }
