                    ...
                    for (int k = 1; k < numRows; k++) {
                     ...
                     // regexp to make sure it is all word characters, '\w+' in regexp terms
                        ...
                        if (!resNames.contains(responseLabel) && !StringUtil.isBlank(resOptions)) {
                        	//@pgawade 4-Aug-2011 changes to support medical coding                        	
//                        	if (responseTypeId == 8 || responseTypeId == 9) {
                        	if (responseTypeId == 8 || responseTypeId == 9 || responseTypeId == ResponseType.MEDICAL_CODE.getId()) {
                        ...
                        //@pgawade 4-Aug-2011 changes to support medical coding
                        else if(responseTypeId == ResponseType.MEDICAL_CODE.getId()){
                        	//validate the coding function to get coding information
//                        	if (resValues.contains(":")) {
//                                String[] s = resValues.split(":");
//                                if (!"func".equalsIgnoreCase(s[0].trim())) {
//                                    errors.add(resPageMsg.getString("expression_not_start_with_func_at") + " " + k + ", "
...
//                        	CodingService codingService = new CodingService();
                        	...
                        	codingService.setCodingDictionaryDAO(getCodingDictionaryDAO());
                        	codingService.validateCodingExpression(true, resValues, errors, htmlErrors, resPageMsg, itemName, j, k, groupLabel, locale, allItems);
               ...
               // buf.append("<div class=\"box_T\"><div class=\"box_L\"><div class=\"box_R\"><div class=\"box_B\"><div class=\"box_TL\"><div class=\"box_TR\"><div class=\"box_BL\"><div class=\"box_BR\">");
                ...
                buf.append("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"shaded_table cell_borders  hrow\" width=\"98%\"");
                ...
                for (int i = 0; i < numRows; i++) {
                    ...
                    String cell_tag_start="<td class=\"table_cell\">"; String cell_tag_end="</td>";
                    if (isFirstRecord){
                    	cell_tag_start="<th>";   cell_tag_end="</th>";isFirstRecord=!isFirstRecord;
                    }
                    ...
                    for (int y = 0; y < numCells; y++) {
                        ...
                        case HSSFCell.CELL_TYPE_BLANK:
                            buf.append(cell_tag_start + error + cell_tag_end);
                            break;
                        case HSSFCell.CELL_TYPE_NUMERIC:
                            buf.append(cell_tag_start + cell.getNumericCellValue() + " " + error + cell_tag_end);
                            break;
                        case HSSFCell.CELL_TYPE_STRING:
                            buf.append(cell_tag_start + cell.getStringCellValue() + " " + error + cell_tag_end);
                            break;
                        default:
                            buf.append(cell_tag_start + error + cell_tag_end);
                        }
