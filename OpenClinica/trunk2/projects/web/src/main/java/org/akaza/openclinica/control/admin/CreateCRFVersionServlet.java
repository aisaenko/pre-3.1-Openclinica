        ...
        for (File f : theFiles) {
            ...
            if (f == null || f.getName() == null) {
                ...
                try {
                    ...
                    htab.setCodingDictionaryDAO((CodingDictionaryDAO) SpringServletAccess.getApplicationContext(context).getBean(
	                    "codingDictionaryDAO"));
                    ...
                    if (!htab.isRepeating()) {
                        ...
                        sstc.setCodingDictionaryDAO((CodingDictionaryDAO) SpringServletAccess.getApplicationContext(context).getBean(
	                    "codingDictionaryDAO"));
                    }
