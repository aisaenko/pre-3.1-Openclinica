...
public class UpdateStudyEventServlet extends SecureController {
    ...
    public void processRequest() throws Exception {
       ...
       ArrayList<SubjectEventStatus> statuses = new ArrayList<SubjectEventStatus>();
       ArrayList<String> statusesFromReq = (ArrayList<String>)request.getAttribute("eventStatus");
       for(String status:statusesFromReq)
       {
           statuses.add(SubjectEventStatus.getFromMap( SubjectEventStatus.getSubjectEventStatusIdByName(status)));
       }
        
       
       //statuses = (ArrayList)request.getAttribute("eventStatus");
